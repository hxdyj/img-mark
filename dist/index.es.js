...
!function(R, L) {
  !function() {
    var Wi, Hi = "Expected a function", ya = "__lodash_hash_undefined__", wa = "__lodash_placeholder__", ma = 16, Fi = 32, Vi = 64, Ni = 128, xa = 256, Ui = 1 / 0, $i = 9007199254740991, ba = NaN, qi = 4294967295, Ca = [["ary", Ni], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", ma], ["flip", 512], ["partial", Fi], ["partialRight", Vi], ["rearg", xa]], Gi = "[object Arguments]", Ia = "[object Array]", Zi = "[object Boolean]", Ki = "[object Date]", Ba = "[object Error]", Ta = "[object Function]", Da = "[object GeneratorFunction]", Ji = "[object Map]", Qi = "[object Number]", ta = "[object Object]", Sa = "[object Promise]", Ra = "[object RegExp]", ea = "[object Set]", La = "[object String]", Oa = "[object Symbol]", ka = "[object WeakMap]", Ea = "[object ArrayBuffer]", na = "[object DataView]", za = "[object Float32Array]", Aa = "[object Float64Array]", Ya = "[object Int8Array]", ja = "[object Int16Array]", Xa = "[object Int32Array]", Pa = "[object Uint8Array]", Ma = "[object Uint8ClampedArray]", Wa = "[object Uint16Array]", Ha = "[object Uint32Array]", Fa = /\b__p \+= '';/g, Va = /\b(__p \+=) '' \+/g, Na = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Ua = /&(?:amp|lt|gt|quot|#39);/g, $a = /[&<>"']/g, qa = RegExp(Ua.source), Ga = RegExp($a.source), Za = /<%-([\s\S]+?)%>/g, Ka = /<%([\s\S]+?)%>/g, Ja = /<%=([\s\S]+?)%>/g, Qa = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, tu = /^\w*$/, eu = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, nu = /[\\^$.*+?()[\]{}|]/g, ru = RegExp(nu.source), ou = /^\s+/, i = /\s/, iu = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, au = /\{\n\/\* \[wrapped with (.+)\] \*/, uu = /,? & /, cu = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, fu = /[()=,{}\[\]\/\s]/, su = /\\(\\)?/g, lu = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, du = /\w*$/, hu = /^[-+]0x[0-9a-f]+$/i, pu = /^0b[01]+$/i, vu = /^\[object .+?Constructor\]$/, gu = /^0o[0-7]+$/i, _u = /^(?:0|[1-9]\d*)$/, yu = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, wu = /($^)/, mu = /['\n\r\u2028\u2029\\]/g, a = "\\ud800-\\udfff", u = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", c = "\\u2700-\\u27bf", t = "a-z\\xdf-\\xf6\\xf8-\\xff", e = "A-Z\\xc0-\\xd6\\xd8-\\xde", f = "\\ufe0e\\ufe0f", s = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", l = "['\u2019]", n = "[" + a + "]", d = "[" + s + "]", h = "[" + u + "]", p = "[" + c + "]", v = "[" + t + "]", s = "[^" + a + s + "\\d+" + c + t + e + "]", c = "\\ud83c[\\udffb-\\udfff]", t = "[^" + a + "]", g = "(?:\\ud83c[\\udde6-\\uddff]){2}", r = "[\\ud800-\\udbff][\\udc00-\\udfff]", e = "[" + e + "]", _ = "\\u200d", y = "(?:" + v + "|" + s + ")", s = "(?:" + e + "|" + s + ")", w = "(?:['\u2019](?:d|ll|m|re|s|t|ve))?", m = "(?:['\u2019](?:D|LL|M|RE|S|T|VE))?", x = "(?:" + h + "|" + c + ")?", b = "[" + f + "]?", b = b + x + ("(?:" + _ + "(?:" + [t, g, r].join("|") + ")" + b + x + ")*"), x = "(?:" + [p, g, r].join("|") + ")" + b, p = "(?:" + [t + h + "?", h, g, r, n].join("|") + ")", xu = RegExp(l, "g"), bu = RegExp(h, "g"), C = RegExp(c + "(?=" + c + ")|" + p + b, "g"), Cu = RegExp([e + "?" + v + "+" + w + "(?=" + [d, e, "$"].join("|") + ")", s + "+" + m + "(?=" + [d, e + y, "$"].join("|") + ")", e + "?" + y + "+" + w, e + "+" + m, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", "\\d+", x].join("|"), "g"), I = RegExp("[" + _ + a + u + f + "]"), Iu = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, Bu = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], Tu = -1, ra = {}, oa = (ra[za] = ra[Aa] = ra[Ya] = ra[ja] = ra[Xa] = ra[Pa] = ra[Ma] = ra[Wa] = ra[Ha] = true, ra[Gi] = ra[Ia] = ra[Ea] = ra[Zi] = ra[na] = ra[Ki] = ra[Ba] = ra[Ta] = ra[Ji] = ra[Qi] = ra[ta] = ra[Ra] = ra[ea] = ra[La] = ra[ka] = false, {}), B = (oa[Gi] = oa[Ia] = oa[Ea] = oa[na] = oa[Zi] = oa[Ki] = oa[za] = oa[Aa] = oa[Ya] = oa[ja] = oa[Xa] = oa[Ji] = oa[Qi] = oa[ta] = oa[Ra] = oa[ea] = oa[La] = oa[Oa] = oa[Pa] = oa[Ma] = oa[Wa] = oa[Ha] = true, oa[Ba] = oa[Ta] = oa[ka] = false, { "\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029" }), Du = parseFloat, Su = parseInt, t = "object" == typeof commonjsGlobal && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal, g = "object" == typeof self && self && self.Object === Object && self, ia = t || g || Function("return this")(), r = L && !L.nodeType && L, o = r && R && !R.nodeType && R, Ru = o && o.exports === r, T = Ru && t.process, n = function() {
      try {
    ...
    var _a = function o2(t2) {
      var b2 = (t2 = null == t2 ? ia : _a.defaults(ia.Object(), t2, _a.pick(ia, Bu))).Array, i2 = t2.Date, k = t2.Error, E = t2.Function, z = t2.Math, v2 = t2.Object, A = t2.RegExp, H = t2.String, y2 = t2.TypeError, F = b2.prototype, V = E.prototype, N = v2.prototype, U = t2["__core-js_shared__"], $ = V.toString, Y = N.hasOwnProperty, q = 0, G = (V = /[^.]+$/.exec(U && U.keys && U.keys.IE_PROTO || "")) ? "Symbol(src)_1." + V : "", Z = N.toString, K = $.call(v2), J = ia._, Q = A("^" + $.call(Y).replace(nu, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), V = Ru ? t2.Buffer : Wi, e2 = t2.Symbol, tt = t2.Uint8Array, et = V ? V.allocUnsafe : Wi, nt = cc(v2.getPrototypeOf, v2), rt = v2.create, ot = N.propertyIsEnumerable, it = F.splice, at = e2 ? e2.isConcatSpreadable : Wi, ut = e2 ? e2.iterator : Wi, ct = e2 ? e2.toStringTag : Wi, ft = function() {
        try {
          var t3 = Jn(v2, "defineProperty");
          return t3({}, "", {}), t3;
        } catch (t4) {
        }
      }(), st = t2.clearTimeout !== ia.clearTimeout && t2.clearTimeout, lt = i2 && i2.now !== ia.Date.now && i2.now, dt = t2.setTimeout !== ia.setTimeout && t2.setTimeout, ht = z.ceil, pt = z.floor, vt = v2.getOwnPropertySymbols, V = V ? V.isBuffer : Wi, gt = t2.isFinite, _t = F.join, yt = cc(v2.keys, v2), w2 = z.max, C2 = z.min, wt = i2.now, mt = t2.parseInt, xt = z.random, bt = F.reverse, i2 = Jn(t2, "DataView"), Ct = Jn(t2, "Map"), It = Jn(t2, "Promise"), Bt = Jn(t2, "Set"), t2 = Jn(t2, "WeakMap"), Tt = Jn(v2, "create"), Dt = t2 && new t2(), St = {}, Rt = Cr(i2), Lt = Cr(Ct), Ot = Cr(It), kt = Cr(Bt), Et = Cr(t2), e2 = e2 ? e2.prototype : Wi, zt = e2 ? e2.valueOf : Wi, At = e2 ? e2.toString : Wi;
      function p2(t3) {
      ...
      function qt(t3, e3, n3) {
        var r3 = t3[e3];
        Y.call(t3, e3) && P(r3, n3) && (n3 !== Wi || e3 in t3) || Jt(t3, e3, n3);
      }
      function Gt(t3, e3) {
      ...
      function m2(n3, r3, o3, t3, e3, i3) {
        ...
        if (t3) {
          ...
          var l3 = X(n3), d3 = l3 == Ta || l3 == Da;
          if (mo(n3))
            return sn(n3, u3);
          if (l3 == ta || l3 == Gi || d3 && !e3) {
            if (a3 = c3 || d3 ? {} : nr(n3), !u3)
              return c3 ? (h3 = d3 = n3, h3 = (s3 = a3) && gn(h3, L2(h3), s3), gn(d3, tr(d3), h3)) : (d3 = Kt(a3, s3 = n3), gn(s3, Qn(s3), d3));
          } else {
            if (!oa[l3])
              return e3 ? n3 : {};
        ...
        var p3 = t3 ? Wi : (f3 ? c3 ? Un : Nn : c3 ? L2 : R2)(n3);
        return ua(p3 || n3, function(t4, e4) {
          p3 && (t4 = n3[e4 = t4]), qt(a3, e4, m2(t4, r3, o3, e4, n3, i3));
        }), a3;
      }
      ...
      function re(t3, e3, n3, r3) {
        ...
        t:
          for (; ++o3 < u3; ) {
            var s3 = t3[o3], l3 = null == n3 ? s3 : n3(s3), s3 = r3 || 0 !== s3 ? s3 : 0;
            if (a3 && l3 == l3) {
              for (var d3 = f3; d3--; )
                if (e3[d3] === l3)
                  continue t;
      ...
      p2.templateSettings = { escape: Za, evaluate: Ka, interpolate: Ja, variable: "", imports: { _: p2 } }, (p2.prototype = Xt.prototype).constructor = p2, (g2.prototype = Yt(Xt.prototype)).constructor = g2, (_2.prototype = Yt(Xt.prototype)).constructor = _2, Pt.prototype.clear = function() {
      ...
      function we(t3, e3, n3) {
        for (var r3 = n3 ? Mu : Pu, o3 = t3[0].length, i3 = t3.length, a3 = i3, u3 = b2(i3), c3 = 1 / 0, f3 = []; a3--; ) {
          var s3 = t3[a3];
          a3 && e3 && (s3 = fa(s3, da(e3))), c3 = C2(s3.length, c3), u3[a3] = !n3 && (e3 || 120 <= o3 && 120 <= s3.length) ? new Ht(a3 && s3) : Wi;
        }
        var s3 = t3[0], l3 = -1, d3 = u3[0];
        t:
          for (; ++l3 < o3 && f3.length < c3; ) {
            var h3 = s3[l3], p3 = e3 ? e3(h3) : h3, h3 = n3 || 0 !== h3 ? h3 : 0;
      ...
      function be(t3, e3, n3, r3, o3) {
        {
          ...
          if (null == t3 || null == e3 || !W(t3) && !W(e3))
            return t3 != t3 && e3 != e3;
          var i3 = be, a3 = M(t3), u3 = M(e3), c3 = a3 ? Ia : X(t3), u3 = u3 ? Ia : X(e3), f3 = (c3 = c3 == Gi ? ta : c3) == ta, s3 = (u3 = u3 == Gi ? ta : u3) == ta, u3;
          if ((u3 = c3 == u3) && mo(t3)) {
            if (!mo(e3))
              return false;
            f3 = !(a3 = true);
          ...
          if (!(1 & n3)) {
            a3 = f3 && Y.call(t3, "__wrapped__"), c3 = s3 && Y.call(e3, "__wrapped__");
            if (a3 || c3)
              return f3 = a3 ? t3.value() : t3, s3 = c3 ? e3.value() : e3, o3 = o3 || new j(), i3(f3, s3, n3, r3, o3);
          }
          if (u3) {
            o3 = o3 || new j();
            var m3 = t3, x3 = e3, b3 = n3, C3 = r3, I3 = i3, B3 = o3, T3 = 1 & b3, D3 = Nn(m3), S3 = D3.length, a3 = Nn(x3).length;
            if (S3 != a3 && !T3)
              return false;
            for (var R3 = S3; R3--; ) {
              var L3 = D3[R3];
      ...
      function Be(t3) {
        return "function" == typeof t3 ? t3 : null == t3 ? O : "object" == typeof t3 ? M(t3) ? Oe(t3[0], t3[1]) : Le(t3) : Si(t3);
      }
      function Te(t3) {
        if (!cr(t3))
          return yt(t3);
      ...
      function Le(e3) {
        var n3 = Kn(e3);
        return 1 == n3.length && n3[0][2] ? sr(n3[0][0], n3[0][1]) : function(t3) {
      ...
      function ke(v3, g3, _3, y3, w3) {
        v3 !== g3 && fe(g3, function(t3, e3) {
          var n3, r3, o3, i3, a3, u3, c3, f3, s3, l3, d3, h3, p3;
          w3 = w3 || new j(), B2(t3) ? (r3 = g3, i3 = _3, a3 = ke, u3 = y3, c3 = w3, d3 = hr(n3 = v3, o3 = e3), h3 = hr(r3, o3), (p3 = c3.get(h3)) ? $t(n3, o3, p3) : (p3 = u3 ? u3(d3, h3, o3 + "", n3, r3, c3) : Wi, (r3 = p3 === Wi) && (f3 = M(h3), s3 = !f3 && mo(h3), l3 = !f3 && !s3 && Oo(h3), p3 = h3, f3 || s3 || l3 ? p3 = M(d3) ? d3 : x2(d3) ? I2(d3) : s3 ? sn(h3, !(r3 = false)) : l3 ? dn(h3, !(r3 = false)) : [] : Do(h3) || yo(h3) ? yo(p3 = d3) ? p3 = jo(d3) : B2(d3) && !bo(d3) || (p3 = nr(h3)) : r3 = false), r3 && (c3.set(h3, p3), a3(p3, h3, i3, u3, c3), c3.delete(h3)), $t(n3, o3, p3))) : (f3 = y3 ? y3(hr(v3, e3), t3, e3 + "", v3, g3, w3) : Wi, $t(v3, e3, f3 = f3 === Wi ? t3 : f3));
        }, L2);
      }
      function Ee(t3, e3) {
        var n3 = t3.length;
      ...
      function He(t3, e3, n3, r3) {
        ...
        for (var o3 = -1, i3 = (e3 = an(e3, t3)).length, a3 = i3 - 1, u3 = t3; null != u3 && ++o3 < i3; ) {
          ...
          if ("__proto__" === f3 || "constructor" === f3 || "prototype" === f3)
            return t3;
          o3 != a3 && (c3 = u3[f3], (s3 = r3 ? r3(c3, f3, u3) : Wi) === Wi && (s3 = B2(c3) ? c3 : or(e3[o3 + 1]) ? [] : {})), qt(u3, f3, s3), u3 = u3[f3];
        }
        return t3;
      }
      ...
      function $e(t3, e3, n3, r3) {
        ...
        for (var a3 = (e3 = n3(e3)) != e3, u3 = null === e3, c3 = T2(e3), f3 = e3 === Wi; o3 < i3; ) {
          var s3 = pt((o3 + i3) / 2), l3 = n3(t3[s3]), d3 = l3 !== Wi, h3 = null === l3, p3 = l3 == l3, v3 = T2(l3), p3 = a3 ? r3 || p3 : f3 ? p3 && (r3 || d3) : u3 ? p3 && d3 && (r3 || !h3) : c3 ? p3 && d3 && !h3 && (r3 || !v3) : !h3 && !v3 && (r3 ? l3 <= e3 : l3 < e3);
          p3 ? o3 = s3 + 1 : i3 = s3;
        }
      ...
      function qe(t3, e3) {
        for (var n3 = -1, r3 = t3.length, o3 = 0, i3 = []; ++n3 < r3; ) {
          ...
          n3 && P(c3, a3) || (a3 = c3, i3[o3++] = 0 === u3 ? 0 : u3);
        }
        return i3;
      }
      function Ge(t3) {
      ...
      function Ze(t3, e3, n3) {
        ...
        t:
          for (; ++r3 < i3; ) {
            var s3 = t3[r3], l3 = e3 ? e3(s3) : s3, s3 = n3 || 0 !== s3 ? s3 : 0;
            if (a3 && l3 == l3) {
      ...
      function Bn(i3) {
        return function(t3, e3, n3) {
          var r3, o3 = v2(t3), e3 = (s2(t3) || (r3 = l2(e3, 3), t3 = R2(t3), e3 = function(t4) {
      ...
      function Dn(a3, u3, c3, f3, s3, l3, d3, h3, p3, v3) {
        ...
        return function t3() {
          ...
          if (w3 && (o3 = function(t4, e4) {
            for (var n4 = t4.length, r4 = 0; n4--; )
              t4[n4] === e4 && ++r4;
            return r4;
          }(e3, r3 = Gn(t3))), f3 && (e3 = pn(e3, f3, s3, w3)), l3 && (e3 = vn(e3, l3, d3, w3)), i3 -= o3, w3 && i3 < v3)
            return o3 = pa(e3, r3), An(a3, u3, Dn, t3.placeholder, c3, e3, o3, h3, p3, v3 - i3);
      ...
      function En(f3) {
        return function(t3, e3, n3) {
          ...
          for (var r3 = t3, o3 = n3, i3 = f3, a3 = -1, u3 = w2(ht((e3 - r3) / (o3 || 1)), 0), c3 = b2(u3); u3--; )
      ...
      function An(t3, e3, n3, r3, o3, i3, a3, u3, c3, f3) {
        var s3 = 8 & e3, o3 = (4 & (e3 = (e3 | (s3 ? Fi : Vi)) & ~(s3 ? Vi : Fi)) || (e3 &= -4), [t3, e3, o3, s3 ? i3 : Wi, s3 ? a3 : Wi, s3 ? Wi : i3, s3 ? Wi : a3, u3, c3, f3]), i3 = n3.apply(Wi, o3);
      ...
      var jn = Bt && 1 / fc(new Bt([, -0]))[1] == Ui ? function(t3) {
        return new Bt(t3);
      } : Ii;
      function Xn(i3) {
        return function(t3) {
      ...
      function Pn(t3, e3, n3, r3, o3, i3, a3, u3) {
        ...
        if (!c3 && "function" != typeof t3)
          throw new y2(Hi);
        var f3, s3, l3, d3, h3, p3 = r3 ? r3.length : 0, v3 = (p3 || (e3 &= -97, r3 = o3 = Wi), a3 = a3 === Wi ? a3 : w2(D2(a3), 0), u3 = u3 === Wi ? u3 : D2(u3), p3 -= o3 ? o3.length : 0, e3 & Vi && (g3 = r3, f3 = o3, r3 = o3 = Wi), c3 ? Wi : $n(t3)), g3 = [t3, e3, n3, r3, o3, g3, f3, i3, a3, u3];
        return v3 && function(t4, e4) {
          ...
          null == t4[9] && (t4[9] = e4[9]);
          t4[0] = e4[0], t4[1] = o4;
        }(g3, v3), t3 = g3[0], e3 = g3[1], n3 = g3[2], r3 = g3[3], o3 = g3[4], !(u3 = g3[9] = g3[9] === Wi ? c3 ? 0 : t3.length : w2(g3[9] - p3, 0)) && 24 & e3 && (e3 &= -25), f3 = e3 && 1 != e3 ? 8 == e3 || e3 == ma ? In(t3, e3, u3) : e3 != Fi && 33 != e3 || o3.length ? Dn.apply(Wi, g3) : kn(t3, e3, n3, r3) : (l3 = n3, d3 = 1 & e3, h3 = Cn(s3 = t3), function t4() {
          return (this && this !== ia && this instanceof t4 ? h3 : s3).apply(d3 ? l3 : this, arguments);
        }), _r((v3 ? Fe : pr)(f3, g3), t3, e3);
      }
      function Mn(t3, e3, n3, r3) {
        return t3 === Wi || P(t3, N[n3]) && !Y.call(r3, n3) ? e3 : t3;
      }
      ...
      function Fn(t3, e3, n3, r3, o3, i3) {
        ...
        if (c3 && f3)
          return c3 == e3 && f3 == t3;
        var s3 = -1, l3 = true, d3 = 2 & n3 ? new Ht() : Wi;
        for (i3.set(t3, e3), i3.set(e3, t3); ++s3 < u3; ) {
          var h3, p3 = t3[s3], v3 = e3[s3];
          if ((h3 = r3 ? a3 ? r3(v3, p3, s3, e3, t3, i3) : r3(p3, v3, s3, t3, e3, i3) : h3) !== Wi) {
            if (h3)
              continue;
            l3 = false;
            break;
      ...
      function l2() {
        var t3 = (t3 = p2.iteratee || mi) === mi ? Be : t3;
      ...
      function d2(t3, e3, n3) {
        var r3;
        if (B2(n3))
          return r3 = typeof e3, ("number" == r3 ? s2(n3) && or(e3, n3.length) : "string" == r3 && e3 in n3) && P(n3[e3], t3);
      }
      function ir(t3, e3) {
        var n3;
        if (!M(t3))
      ...
      (i2 && X(new i2(new ArrayBuffer(1))) != na || Ct && X(new Ct()) != Ji || It && X(It.resolve()) != Sa || Bt && X(new Bt()) != ea || t2 && X(new t2()) != ka) && (X = function(t3) {
      ...
      function Tr(t3, e3, n3) {
        ...
        if (!r3)
          return -1;
        var o3 = r3 - 1;
        return n3 !== Wi && (o3 = D2(n3), o3 = n3 < 0 ? w2(r3 + o3, 0) : C2(o3, r3 - 1)), Nu(t3, l2(e3, 3), o3, true);
      }
      function Dr(t3) {
      ...
      function oo(t3, e3, n3) {
        return e3 = n3 ? Wi : e3, e3 = t3 && null == e3 ? t3.length : e3, Pn(t3, Ni, Wi, Wi, Wi, Wi, e3);
      }
      function io(t3, e3) {
        var n3;
      ...
      var ao = a2(function(t3, e3, n3) {
        var r3, o3 = 1;
        return n3.length && (r3 = pa(n3, Gn(ao)), o3 |= Fi), Pn(t3, o3, e3, n3, r3);
      }), uo = a2(function(t3, e3, n3) {
        var r3, o3 = 3;
        return n3.length && (r3 = pa(n3, Gn(uo)), o3 |= Fi), Pn(e3, o3, t3, n3, r3);
      });
      function co(r3, n3, t3) {
        ...
        function _3() {
          ...
          if (o3 = arguments, i3 = this, f3 = t4, e4) {
            if (c3 === Wi)
              return s3 = t4 = f3, c3 = vr(v3, n3), l3 ? h3(t4) : u3;
            if (d3)
              return fn(c3), c3 = vr(v3, n3), h3(f3);
          }
          return c3 === Wi && (c3 = vr(v3, n3)), u3;
        }
        return n3 = S2(n3) || 0, B2(t3) && (l3 = !!t3.leading, d3 = "maxWait" in t3, a3 = d3 ? w2(S2(t3.maxWait) || 0, n3) : a3, e3 = "trailing" in t3 ? !!t3.trailing : e3), _3.cancel = function() {
      ...
      var un = un(function(r3, o3) {
        var i3 = (o3 = 1 == o3.length && M(o3[0]) ? fa(o3[0], da(l2())) : fa(c2(o3, 1), da(l2()))).length;
      ...
      function xo(t3) {
        if (!W(t3))
          return false;
        var e3 = n2(t3);
        return e3 == Ba || "[object DOMException]" == e3 || "string" == typeof t3.message && "string" == typeof t3.name && !Do(t3);
      }
      function bo(t3) {
        if (!B2(t3))
          return false;
      ...
      var ko = zn(Se), Eo = zn(function(t3, e3) {
        return t3 <= e3;
      });
      function zo(t3) {
        if (!t3)
      ...
      function Ao(t3) {
        return t3 ? (t3 = S2(t3)) === Ui || t3 === -Ui ? 17976931348623157e292 * (t3 < 0 ? -1 : 1) : t3 == t3 ? t3 : 0 : 0 === t3 ? t3 : 0;
      }
      function D2(t3) {
      ...
      var Fo = a2(function(t3, e3) {
        ...
        for (o3 && d2(e3[0], e3[1], o3) && (r3 = 1); ++n3 < r3; )
          for (var i3 = e3[n3], a3 = L2(i3), u3 = -1, c3 = a3.length; ++u3 < c3; ) {
            ...
            (s3 === Wi || P(s3, N[f3]) && !Y.call(t3, f3)) && (t3[f3] = i3[f3]);
          }
        return t3;
      }), Vo = a2(function(t3) {
      ...
      var Zo = yn(function(t3, e3, n3) {
        ...
        }), gn(e3, Un(e3), n3), r3 && (n3 = m2(n3, 7, Hn)), t3.length); o3--; )
          Ke(n3, t3[o3]);
        return n3;
      });
      ...
      function Ci(r3, e3, t3) {
        var n3 = R2(e3), o3 = he(e3, n3), i3 = (null != t3 || B2(e3) && (o3.length || !n3.length) || (t3 = e3, e3 = r3, r3 = this, o3 = he(e3, R2(e3))), !(B2(t3) && "chain" in t3 && !t3.chain)), a3 = bo(r3);
      ...
      var Bi = Ln(fa), Ti = Ln(Xu), Di = Ln(Fu);
      function Si(t3) {
      ...
      var ji, Xi = Rn(function(t3, e3) {
        return t3 * e3;
      }, 1), Pi = Yn("round"), Mi = Rn(function(t3, e3) {
        return t3 - e3;
      }, 0);
      return p2.after = function(t3, e3) {
      ...
      }, p2.ary = oo, p2.assign = Xo, p2.assignIn = Po, p2.assignInWith = Mo, p2.assignWith = Wo, p2.at = Ho, p2.before = io, p2.bind = ao, p2.bindAll = gi, p2.bindKey = uo, p2.castArray = function() {
        if (!arguments.length)
          return [];
        var t3 = arguments[0];
        return M(t3) ? t3 : [t3];
        ...
        return sa(M(n3) ? I2(n3) : [n3], c2(e3, 1));
      }, p2.cond = function(r3) {
        ...
        return e3.placeholder = t3.placeholder, e3;
      }, p2.debounce = co, p2.defaults = Fo, p2.defaultsDeep = Vo, p2.defer = lt, p2.delay = fo, p2.difference = i2, p2.differenceBy = It, p2.differenceWith = t2, p2.drop = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
        ...
        for ((a3 = D2(a3)) < 0 && (a3 = c3 < -a3 ? 0 : c3 + a3), (u3 = u3 === Wi || c3 < u3 ? c3 : D2(u3)) < 0 && (u3 += c3), u3 = u3 < a3 ? 0 : Yo(u3); a3 < u3; )
          o3[a3++] = i3;
        return o3;
        ...
        return (null == t3 ? 0 : t3.length) ? c2(t3, e3 = e3 === Wi ? 1 : D2(e3)) : [];
      }, p2.flip = function(t3) {
        return Pn(t3, 512);
      ...
      }, p2.intersection = U, p2.intersectionBy = dt, p2.intersectionWith = e2, p2.invert = $o, p2.invertBy = qo, p2.invokeMap = Jr, p2.iteratee = mi, p2.keyBy = Qr, p2.keys = R2, p2.keysIn = L2, p2.map = to, p2.mapKeys = function(t3, r3) {
        var o3 = {};
      ...
      }, p2.memoize = so, p2.merge = Zo, p2.mergeWith = Ko, p2.method = xi, p2.methodOf = bi, p2.mixin = Ci, p2.negate = lo, p2.nthArg = function(e3) {
      ...
      }, p2.over = Bi, p2.overArgs = un, p2.overEvery = Ti, p2.overSome = Di, p2.partial = ho, p2.partialRight = po, p2.partition = eo, p2.pick = Qo, p2.pickBy = ti, p2.property = Si, p2.propertyOf = function(e3) {
        return function(t3) {
          return null == e3 ? Wi : pe(e3, t3);
        };
      }, p2.pull = st, p2.pullAll = Rr, p2.pullAllBy = function(t3, e3, n3) {
        return t3 && t3.length && e3 && e3.length ? Ye(t3, e3, l2(n3, 2)) : t3;
      }, p2.pullAllWith = function(t3, e3, n3) {
        return t3 && t3.length && e3 && e3.length ? Ye(t3, e3, Wi, n3) : t3;
      }, p2.pullAt = Lr, p2.range = Ri, p2.rangeRight = Li, p2.rearg = vo, p2.reject = function(t3, e3) {
        ...
        var r3 = null == t3 ? 0 : t3.length;
        return r3 ? (n3 = n3 && "number" != typeof n3 && d2(t3, e3, n3) ? (e3 = 0, r3) : (e3 = null == e3 ? 0 : D2(e3), n3 === Wi ? r3 : D2(n3)), u2(t3, e3, n3)) : [];
        ...
        return n3 && "number" != typeof n3 && d2(t3, e3, n3) && (e3 = n3 = Wi), (n3 = n3 === Wi ? qi : n3 >>> 0) ? (t3 = h2(t3)) && ("string" == typeof e3 || null != e3 && !So(e3)) && !(e3 = f2(e3)) && ha(t3) ? cn(ga(t3), 0, n3) : t3.split(e3, n3) : [];
      ...
      }, p2.toPlainObject = jo, p2.transform = function(t3, r3, o3) {
        var e3, n3 = M(t3), i3 = n3 || mo(t3) || Oo(t3);
        return r3 = l2(r3, 4), null == o3 && (e3 = t3 && t3.constructor, o3 = i3 ? n3 ? new e3() : [] : B2(t3) && bo(e3) ? Yt(nt(t3)) : {}), (i3 ? ua : le)(t3, function(t4, e4, n4) {
      ...
      }, p2.without = jr, p2.words = pi, p2.wrap = function(t3, e3) {
        return ho(on(e3), t3);
      }, p2.xor = Xr, p2.xorBy = Pr, p2.xorWith = Mr, p2.zip = Wr, p2.zipObject = function(t3, e3) {
        return nn(t3 || [], e3 || [], qt);
      }, p2.zipObjectDeep = function(t3, e3) {
        return nn(t3 || [], e3 || [], He);
      }, p2.zipWith = Hr, p2.entries = ei, p2.entriesIn = ni, p2.extend = Po, p2.extendWith = Mo, Ci(p2, p2), p2.add = Ei, p2.attempt = vi, p2.camelCase = oi, p2.capitalize = ii, p2.ceil = zi, p2.clamp = function(t3, e3, n3) {
      ...
      }, p2.eq = P, p2.escape = function(t3) {
        return (t3 = h2(t3)) && Ga.test(t3) ? t3.replace($a, ic) : t3;
      }, p2.escapeRegExp = function(t3) {
        return (t3 = h2(t3)) && ru.test(t3) ? t3.replace(nu, "\\$&") : t3;
      }, p2.every = function(t3, e3, n3) {
        return (M(t3) ? Xu : ae)(t3, l2(e3 = n3 && d2(t3, e3, n3) ? Wi : e3, 3));
      ...
      }, p2.floor = Yi, p2.forEach = Gr, p2.forEachRight = Zr, p2.forIn = function(t3, e3) {
        return null == t3 ? t3 : fe(t3, l2(e3, 3), L2);
      }, p2.forInRight = function(t3, e3) {
        return null == t3 ? t3 : se(t3, l2(e3, 3), L2);
      ...
      }, p2.hasIn = Uo, p2.head = Sr, p2.identity = O, p2.includes = function(t3, e3, n3, r3) {
        ...
        var r3 = null == t3 ? 0 : t3.length;
        return r3 ? (n3 = null == n3 ? 0 : D2(n3), la(t3, e3, n3 = n3 < 0 ? w2(r3 + n3, 0) : n3)) : -1;
      }, p2.inRange = function(t3, e3, n3) {
        return e3 = Ao(e3), n3 === Wi ? (n3 = e3, e3 = 0) : n3 = Ao(n3), (t3 = t3 = S2(t3)) >= C2(e3 = e3, n3 = n3) && t3 < w2(e3, n3);
      }, p2.invoke = Go, p2.isArguments = yo, p2.isArray = M, p2.isArrayBuffer = wo, p2.isArrayLike = s2, p2.isArrayLikeObject = x2, p2.isBoolean = function(t3) {
        return true === t3 || false === t3 || W(t3) && n2(t3) == Zi;
      }, p2.isBuffer = mo, p2.isDate = V, p2.isElement = function(t3) {
        return W(t3) && 1 === t3.nodeType && !Do(t3);
      }, p2.isEmpty = function(t3) {
        if (null == t3)
          return true;
        if (s2(t3) && (M(t3) || "string" == typeof t3 || "function" == typeof t3.splice || mo(t3) || Oo(t3) || yo(t3)))
          return !t3.length;
        var e3, n3 = X(t3);
        if (n3 == Ji || n3 == ea)
          return !t3.size;
      ...
      }, p2.isFunction = bo, p2.isInteger = Co, p2.isLength = Io, p2.isMap = Bo, p2.isMatch = function(t3, e3) {
        ...
        return null === t3;
      }, p2.isNumber = To, p2.isObject = B2, p2.isObjectLike = W, p2.isPlainObject = Do, p2.isRegExp = So, p2.isSafeInteger = function(t3) {
        return Co(t3) && -$i <= t3 && t3 <= $i;
      }, p2.isSet = Ro, p2.isString = Lo, p2.isSymbol = T2, p2.isTypedArray = Oo, p2.isUndefined = function(t3) {
        return t3 === Wi;
        ...
        for (var i3 = t3, a3 = e3, u3 = o3 + 1; u3--; )
          if (i3[u3] === a3)
            return u3;
        return u3;
      }, p2.lowerCase = ci, p2.lowerFirst = fi, p2.lt = ko, p2.lte = Eo, p2.max = function(t3) {
        ...
        return t3 && t3.length ? ue(t3, l2(e3, 2), Se) : Wi;
        ...
        return true;
      }, p2.multiply = Xi, p2.nth = function(t3, e3) {
        ...
        var r3;
        return n3 && "boolean" != typeof n3 && d2(t3, e3, n3) && (e3 = n3 = Wi), n3 === Wi && ("boolean" == typeof e3 ? (n3 = e3, e3 = Wi) : "boolean" == typeof t3 && (n3 = t3, t3 = Wi)), t3 === Wi && e3 === Wi ? (t3 = 0, e3 = 1) : (t3 = Ao(t3), e3 === Wi ? (e3 = t3, t3 = 0) : e3 = Ao(e3)), e3 < t3 && (r3 = t3, t3 = e3, e3 = r3), n3 || t3 % 1 || e3 % 1 ? (r3 = xt(), C2(t3 + r3 * (e3 - t3 + Du("1e-" + ((r3 + "").length - 1))), e3)) : Xe(t3, e3);
        ...
        var r3 = M(t3) ? Hu : Zu, o3 = arguments.length < 3;
        return r3(t3, l2(e3, 4), n3, o3, ie);
      }, p2.repeat = function(t3, e3, n3) {
        return e3 = (n3 ? d2(t3, e3, n3) : e3 === Wi) ? 1 : D2(e3), Pe(h2(t3), e3);
      }, p2.replace = function() {
        ...
        return t3;
      }, p2.round = Pi, p2.runInContext = o2, p2.sample = function(t3) {
      ...
      }, p2.snakeCase = si, p2.some = function(t3, e3, n3) {
        return (M(t3) ? Fu : Ne)(t3, l2(e3 = n3 && d2(t3, e3, n3) ? Wi : e3, 3));
        ...
        var r3 = R2(e3 = Mo({}, t3.imports, n3.imports, Mn)), o3 = tc(e3, r3), f3 = 0, n3 = t3.interpolate || wu, s3 = "__p += '", e3 = A((t3.escape || wu).source + "|" + n3.source + "|" + (n3 === Ja ? lu : wu).source + "|" + (t3.evaluate || wu).source + "|$", "g"), i3 = "//# sourceURL=" + (Y.call(t3, "sourceURL") ? (t3.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Tu + "]") + "\n";
        if (a3.replace(e3, function(t4, e4, n4, r4, o4, i4) {
          ...
          s3 = "with (obj) {\n" + s3 + "\n}\n";
        if (s3 = (c3 ? s3.replace(Fa, "") : s3).replace(Va, "$1").replace(Na, "$1;"), s3 = "function(" + (n3 || "obj") + ") {\n" + (n3 ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (u3 ? ", __e = _.escape" : "") + (c3 ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + s3 + "return __p\n}", (e3 = vi(function() {
        ...
        for (var n3 = qi, r3 = C2(t3, qi), r3 = (e3 = l2(e3), t3 -= qi, Ju(r3, e3)); ++n3 < t3; )
          e3(n3);
        return r3;
      }, p2.toFinite = Ao, p2.toInteger = D2, p2.toLength = Yo, p2.toLower = function(t3) {
        return h2(t3).toLowerCase();
      }, p2.toNumber = S2, p2.toSafeInteger = function(t3) {
        return t3 ? te(D2(t3), -$i, $i) : 0 === t3 ? t3 : 0;
      }, p2.toString = h2, p2.toUpper = function(t3) {
        return h2(t3).toUpperCase();
      }, p2.trim = function(t3, e3, n3) {
        return (t3 = h2(t3)) && (n3 || e3 === Wi) ? Qu(t3) : t3 && (e3 = f2(e3)) ? (n3 = ga(t3), t3 = ga(e3), cn(n3, nc(n3, t3), rc(n3, t3) + 1).join("")) : t3;
      }, p2.trimEnd = function(t3, e3, n3) {
        return (t3 = h2(t3)) && (n3 || e3 === Wi) ? t3.slice(0, sc(t3) + 1) : t3 && (e3 = f2(e3)) ? cn(n3 = ga(t3), 0, rc(n3, ga(e3)) + 1).join("") : t3;
      }, p2.trimStart = function(t3, e3, n3) {
        return (t3 = h2(t3)) && (n3 || e3 === Wi) ? t3.replace(ou, "") : t3 && (e3 = f2(e3)) ? cn(n3 = ga(t3), nc(n3, ga(e3))).join("") : t3;
      }, p2.truncate = function(t3, e3) {
        var n3, r3 = 30, o3 = "...", e3 = (B2(e3) && (n3 = "separator" in e3 ? e3.separator : n3, r3 = "length" in e3 ? D2(e3.length) : r3, o3 = "omission" in e3 ? f2(e3.omission) : o3), (t3 = h2(t3)).length);
        ...
        return (t3 = h2(t3)) && qa.test(t3) ? t3.replace(Ua, lc) : t3;
      }, p2.uniqueId = function(t3) {
        var e3 = ++q;
        return h2(t3) + e3;
      }, p2.upperCase = di, p2.upperFirst = hi, p2.each = Gr, p2.eachRight = Zr, p2.first = Sr, Ci(p2, (ji = {}, le(p2, function(t3, e3) {
        Y.call(p2.prototype, e3) || (ji[e3] = t3);
      }), ji), { chain: false }), p2.VERSION = "4.17.21", ua(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function(t3) {
        ...
        var s3 = /^(?:filter|find|map|reject)|While$/.test(t3), l3 = /^(?:head|last)$/.test(t3), d3 = p2[l3 ? "take" + ("last" == t3 ? "Right" : "") : t3], h3 = l3 || /^find/.test(t3);
        d3 && (p2.prototype[t3] = function() {
          function t4(t5) {
            return t5 = d3.apply(p2, sa([t5], r3)), l3 && u3 ? t5[0] : t5;
          }
          var e3, n3 = this.__wrapped__, r3 = l3 ? [1] : arguments, o3 = n3 instanceof _2, i3 = r3[0], a3 = o3 || M(n3), u3 = (a3 && s3 && "function" == typeof i3 && 1 != i3.length && (o3 = a3 = false), this.__chain__), i3 = !!this.__actions__.length, c3 = h3 && !u3, o3 = o3 && !i3;
          return !h3 && a3 ? (n3 = o3 ? n3 : new _2(this), (e3 = f3.apply(n3, r3)).__actions__.push({ func: Vr, args: [t4], thisArg: Wi }), new g2(e3, u3)) : c3 && o3 ? f3.apply(this, r3) : (e3 = this.thru(t4), c3 ? l3 ? e3.value()[0] : e3.value() : e3);
        });
        ...
        t:
          for (; u3-- && l3 < d3; ) {
            for (var p3 = -1, v3 = t3[c3 += e3]; ++p3 < s3; ) {
...
function drawTagRect(t, e, n, r, o, i, a, u, c, f, s, l) {
  i = lodash.exports.cloneDeep(i.tagConfig);
  if (l && Object.assign(i, l), t.font = i.fontSize + "px sans-serif", u || c) {
    !c || u && "move" === u.type || (t.fillStyle = i.fillStyle, t.fillRect(e, n, r, o), a && i.showText && (l = parseFloat(t.font.split(" ")[0]), t.fillStyle = i.textFillStyle, t.fillText(s || a + "", e + 4, n + o / 2 + l / 2))), f && (t.strokeStyle = i.highlightStrokeStyle, t.lineWidth = i.highlightLineWidth, t.setLineDash(i.highlightLineDash), t.strokeRect(e, n, r, o));
...
function drawTagList(r, t, o, i, a = { offsetX: 0, offsetY: 0 }, u) {
  ...
  return t.forEach((t2) => {
    ...
    var n = drawTagRect(r, ...e, i, (t2.__index || 0) + 1, u, t2.isShow, t2.showOutLine, t2.labelText, t2.tagConfig);
...
function moveResizeBox(t, e, n, r, o, i, a, u, c, f, s) {
  if (e && void 0 !== e.x && n && void 0 !== n.x) {
    var e = getTwoPointsOffsetInfo(e, n, i);
    if (e.isStartMove)
      return { offsetX: n, offsetY: i } = e.offsetInfo, e = transfromBoxToRect(getResizeBoundingBoxInfo(r, { offsetX: n / o, offsetY: i / o }, c), o, a), drawCropList(t, f, a, s), "crop" == s.mode && drawCropRect(t, ...e, s, true), drawTagList(t, u, a, s), "tag" == s.mode && drawTagRect(t, ...e, s, (r.__index || 0) + 1, void 0, r.isShow, r.showOutLine, r.labelText, r.tagConfig), e;
  }
}
...
const _withScopeId = (t) => (pushScopeId("data-v-165e90e4"), t = t(), popScopeId(), t), _hoisted_1 = ["onTouchmove", "onTouchstart", "onTouchend"], _hoisted_2 = { key: 0, class: "mode-panel" }, _hoisted_3 = { class: "status" }, _hoisted_4 = { class: "text" }, _hoisted_5 = { class: "tip" }, _hoisted_6 = _withScopeId(() => createElementVNode("kbd", null, "Ctrl", -1)), _hoisted_7 = createTextVNode(" + "), _hoisted_8 = _withScopeId(() => createElementVNode("kbd", null, "B", -1)), _hoisted_9 = _withScopeId(() => createElementVNode("span", { style: { "font-size": "14px", "margin-left": "10px" } }, "\u5207\u6362\u6A21\u5F0F", -1)), _sfc_main = defineComponent({ props: { cropConfig: { default: () => DEFAULT_CONFIG.cropConfig }, layerConfig: { default: () => DEFAULT_CONFIG.layerConfig }, tagConfig: { default: () => DEFAULT_CONFIG.tagConfig }, drawingText: null, isShowTip: { type: Boolean, default: false }, enableScale: { type: Boolean, default: true }, enableMove: { type: Boolean, default: true }, enableDrawCrop: { type: Boolean, default: true }, enableDrawTag: { type: Boolean, default: true }, initScale: { type: Boolean, default: true }, enableInteractiveTagChangeStatus: { type: Boolean, default: true }, enableCropCross: { type: Boolean, default: false }, handleResizeCropCross: { default: "reset" }, enableInteractiveCropDelete: { type: Boolean, default: true }, enableCropResize: { type: Boolean, default: true }, enableTagResize: { type: Boolean, default: false }, enableDrawCropOutOfImg: { type: Boolean, default: true }, enableDrawTagOutOfCrop: { type: Boolean, default: true }, enableDrawTagOutOfImg: { type: Boolean, default: true }, isImgCrop: { type: Boolean, default: false }, isCropSingle: { type: Boolean, default: false }, cropList: { default: () => Array() }, tagList: { default: () => Array() }, mode: { default: "crop" }, mobileOperation: { default: "move" }, src: null, precision: { default: 0 }, splitClickAndDoubleClickEvent: { type: Boolean, default: false }, disableDefaultShortcuts: { default: () => Array() }, customDrawTopCtx: null }, emits: ["update:cropList", "cropListChange", "update:tagList", "tagListChange", "update:mode", "update:mobileOperation", "resizeStart", "resizeEnd", "delCrop", "drawCropStart", "drawTagStart", "mouseOverInfo", "onLoadImage"], setup(j, { expose: t, emit: a }) {
  ...
  const O = { dragCreatRectInterrupt() {
    ...
    var _a, _b;
    if (d && ("drawCrop" == t2 && (u.isCropSingle && !L.isDrawRecting && (D = []), L.isDrawRecting || a("drawCropStart"), L.isDrawRecting = true, B = moveDrawCropRect(d, g, _, I, w, D, y, S.value), drawTagList(d, T, y, S.value), (_a = u.customDrawTopCtx) == null ? void 0 : _a.call(u, d, E)), "drawTag" == t2 && (L.isDrawRecting || a("drawTagStart"), L.isDrawRecting = true, drawCropList(d, D, y, S.value), B = moveDrawTagRect(d, g, _, I, w, T, y, S.value), (_b = u.customDrawTopCtx) == null ? void 0 : _b.call(u, d, E)), "resize" == t2)) {
      let t3 = { crop() {
        var _a2;
        u.enableCropResize && L.resizeHovering && d ? (c = D[L.resizeHovering.index || 0], L.resizeHovering && c && (L.isDrawRecting = true, B = moveResizeBox(d, g, _, c, c.__scale || 1, I, y, T, L.resizeHovering, D.filter((t4, e2) => {
          var _a3;
          return e2 !== ((_a3 = L.resizeHovering) == null ? void 0 : _a3.index);
        }), S.value), (_a2 = u.customDrawTopCtx) == null ? void 0 : _a2.call(u, d, E))) : O.move();
      }, tag() {
        var _a2;
        u.enableTagResize && L.resizeHovering && d ? (c = T[L.resizeHovering.index || 0], L.resizeHovering && c && (L.isDrawRecting = true, B = moveResizeBox(d, g, _, c, c.__scale || 1, I, y, T.filter((t4, e2) => {
          var _a3;
          return e2 !== ((_a3 = L.resizeHovering) == null ? void 0 : _a3.index);
        }), L.resizeHovering, D, S.value), (_a2 = u.customDrawTopCtx) == null ? void 0 : _a2.call(u, d, E))) : O.move();
      } };
      t3[u.mode]();
    }
  }, changeMode() {
    ...
    L.isScaleing = true, l.translate(w.x, w.y), d.translate(w.x, w.y), w = { x: w.x - (e2.x / (I * t2) - e2.x / I), y: w.y - (e2.y / (I * t2) - e2.y / I) }, l.scale(t2, t2), d.scale(t2, t2), l.translate(-w.x, -w.y), d.translate(-w.x, -w.y), I *= t2, clearCanvas(l), clearCanvas(d), drawImage(l, h, y.x, y.y, v.width * m, v.height * m), z(), M = false, L.isScaleing = false;
  }, move() {
    var _a;
    if (u.enableMove && l && d && h && !L.isScaleing) {
      L.isMoving = true;
      let e2 = moveCanvas(l, d, h, v, m, y, g, _, D, I, T, S.value);
      (_a = u.customDrawTopCtx) == null ? void 0 : _a.call(u, d, (t2) => E(t2).map((t3) => (t3[0] += e2.offsetX, t3[1] += e2.offsetY, t3))), e2 && (b = lodash.exports.cloneDeep(y)) && (b.x += e2.offsetX, b.y += e2.offsetY);
    }
  }, hoverRect(t2) {
    ...
    if ("crop" === u.mode && u.enableInteractiveCropDelete && pt(pointIsInBoxList(e2, D, m, y).boxList), "tag" === u.mode) {
    ...
    if ("tag" === u.mode && d) {
      ...
      }), u.enableInteractiveTagChangeStatus && (drawCropList(d, D, y, S.value), { isReDraw: e2, redrawList: n2 } = drawTagList(d, T, y, S.value, void 0, e2), e2 && (z(), rt("statusChange", A(n2))));
    }
  }, onWheel(t2, e2, n2) {
    ...
    !async function() {
      if (W(), s = false, l = null, d = null, h = void 0, p = lodash.exports.cloneDeep(defaultWH), v = lodash.exports.cloneDeep(defaultWH), g = lodash.exports.cloneDeep(defaultPoint), _ = lodash.exports.cloneDeep(defaultPoint), y = { x: 0, y: 0 }, w = { x: 0, y: 0 }, m = 1, x = void 0, b = void 0, V = 1, C = void 0, I = 1, B = void 0, T = [], D = [], await nextTick(), 1 < u.cropList.length) {
      ...
      return 1 == u.cropList.length && (x = u.cropList[0]), T = lodash.exports.cloneDeep(u.tagList), D = lodash.exports.cloneDeep(u.cropList), G(), device.mobile() || (window.addEventListener("keydown", $), window.addEventListener("keyup", q)), K(), l = N.value.getContext("2d"), d = U.value.getContext("2d"), l && d ? (p = amendDpi(getElementWH(l.canvas))) ? (initCanvasWH(l, p), initCanvasWH(d, p), a("onLoadImage", { status: "loading" }), loadImage(u.src).then((t2) => {
        return a("onLoadImage", { status: "success" }), p && l && d ? (h = t2, v = { width: h.width, height: h.height }, u.initScale && (t2 = initScale(p, h), m = V = t2.scale, x ? (e2 = transfromBoxToRect(x, V, y), n2 = (p.width - 0.05 * p.width) / e2[2], r2 = (p.height - 0.05 * p.height) / e2[3], r2 = p.width / p.height > e2[2] / e2[3] ? r2 : n2, o2 = e2[0] + e2[2], i2 = e2[1] + e2[3], (r2 = r2) == n2 ? (y.x = (p.width - o2 * r2 - 0.05 * p.width / 2) / r2, y.y = ((p.height - e2[3] * r2) / 2 - e2[1] * r2) / r2) : (y.x = ((p.width - e2[2] * r2) / 2 - e2[0] * r2) / r2, y.y = (p.height - i2 * r2 - 0.05 * p.height / 2) / r2), Q({ deltaY: 1, clientX: 0, clientY: 0, preventDefault() {
        }, stopPropagation() {
        }, __zoom: r2 }, true)) : ("width" === t2.fit ? y.x = (p.width - v.width * m) / 2 : y.y = (p.height - v.height * m) / 2, x = { startX: 0, startY: 0, endX: 0 + v.width, endY: 0 + v.height }, u.isImgCrop && nt("add", D = [x]))), drawImage(l, h, y.x, y.y, h.width * m, h.height * m), D = initBoundingArrScale(D, m, u.precision), T = initBoundingArrScale(T, m, u.precision), z(), true) : Promise.reject("canvasWH or canvas var not has valid values.");
        var e2, n2, r2, o2, i2;
      }).catch((t2) => {
    ...
    requestAnimationFrame(() => {
      !async function() {
        if (Z(), await nextTick(), G(), l && d && h) {
          if (!(p = amendDpi(getElementWH(l.canvas))))
            return Promise.reject("Error: can't get canvas height and width.");
          initCanvasWH(l, p), initCanvasWH(d, p), l.scale(I, I), d.scale(I, I), l.translate(-w.x, -w.y), d.translate(-w.x, -w.y), drawImage(l, h, y.x, y.y, h.width * m, h.height * m), D = initBoundingArrScale(D, m, u.precision), T = initBoundingArrScale(T, m, u.precision), z(), s = true;
        }
      }();
    });
  } };
  ...
  function Z() {
    c = null, s = false, p = lodash.exports.cloneDeep(defaultWH), g = lodash.exports.cloneDeep(defaultPoint), _ = lodash.exports.cloneDeep(defaultPoint), C = void 0;
  }
  function E(t2) {
  ...
  function z() {
    var _a;
    d && (drawCropList(d, D, y, S.value), drawTagList(d, T, y, S.value), (_a = u.customDrawTopCtx) == null ? void 0 : _a.call(u, d, E));
  }
  function K() {
  ...
  function Q(t2, e2) {
    ...
    !s && !t2.__zoom || L.isDrawRecting || L.isMoving || (r2 = t2.onTouchMove ? 1 : DPI, n2 = e2 ? 0 : (t2.clientX - C.left) * r2, r2 = e2 ? 0 : (t2.clientY - C.top) * r2, o2 = t2.deltaY < 0 ? 1 : -1, t2 = e2 ? t2.__zoom : Math.exp(o2 * P), I * t2 < 0.2 || k.onWheel(t2, { x: n2, y: r2 }, e2));
  }
  function tt(e2) {
    if (L.resizeHovering) {
      var n2;
      let t2 = { crop: { boxList: D, trigger: nt, getBoxFunc: Y }, tag: { boxList: T, trigger: rt, getBoxFunc: A } }[u.mode];
      ...
      if (L.isMoving = false, b && (y = lodash.exports.cloneDeep(b)), b = void 0, L.isMouseUpDownPoints())
        if ("crop" === u.mode) {
          if (B) {
            ...
            })) ? ("reset" === u.handleResizeCropCross && z(), "delete" === u.handleResizeCropCross && pt([D[L.resizeHovering.index]])) : tt(t3) : (t3 = initBoundingArrScale([t3], m, u.precision)[0], !u.enableCropCross && getBoxIsIntersectWithBoxList(t3, D) ? z() : (D.push(t3), nt("add", Y([t3])))), B = void 0;
          }
        } else
          B && (t2 = { ...c, ...transfromRect2Box(B, y, m) }, c = null, L.resizeHovering ? tt(t2) : (t2 = getVertexPositionByTwoPoints(g, _), e2 = initBoundingArrScale([e2 = transfromRect2Box(B, y, m)], m, u.precision)[0], Object.assign(e2, { isShow: true, __oprateType: "add", __vertexPosition: t2 }), T.push(e2), rt("add", A([e2]))), B = void 0);
  ...
  onBeforeUnmount(() => {
    ...
    s && (T = initBoundingArrScale(t2, m, u.precision), z());
  }, { deep: true }), watch(() => u.cropList, (t2) => {
    s && (D = initBoundingArrScale(t2, m, u.precision), z());
  });
  ...
  function at(t2) {
    s && (t2 = amendDpi(t2 = { layerX: Reflect.get(t2, "layerX"), layerY: Reflect.get(t2, "layerY") }, ["layerX", "layerY"]), o = new Date().getTime(), k.onMouseOverMove(t2), it(t2));
  }
  function ut() {
    var t2;
    s && (t2 = new Date().getTime(), f.prev.up ? f.last.up = t2 : f.prev.up = t2, et());
  }
  function ct() {
    s && (R.value.style.cursor = "auto", et(), it());
  }
  function ft() {
  ...
  function st(e2) {
    if (G(), s) {
      ...
      var e2 = o && r ? o - r : 0;
      r = void 0, o = void 0, 100 < e2 || (u.splitClickAndDoubleClickEvent ? (ft(), i = setTimeout(() => {
        k.onCick(t2), i = null;
      }, 230)) : k.onCick(t2), e2 = u.splitClickAndDoubleClickEvent ? 320 : 360, f.prev.up && f.prev.down && f.last.up && f.last.down && (f.last.up - f.prev.down < e2 ? (u.splitClickAndDoubleClickEvent && ft(), k.onDoubleClick(t2), f.prev.down = void 0, f.prev.up = void 0) : (f.prev.down = f.last.down, f.prev.up = f.last.up), f.last.down = void 0, f.last.up = void 0));
    }
  }
  function lt(t2) {
    G(), r = new Date().getTime();
    var e2 = t2.touches;
  ...
  function dt(t2) {
    o = new Date().getTime();
    var e2 = t2.touches;
    if (1 === t2.touches.length && at({ layerX: e2[0].clientX, layerY: e2[0].clientY }), 2 == t2.touches.length) {
      if (!C)
        throw new Error("can't find  containerInfo.");
      var { width: e2, height: t2 } = getTwoFingerTouchListDistence(amendMobileTouchEventDpi(t2)), e2 = getHypotenuseValue(e2, t2), t2 = -(e2 - F);
      F = e2, Q({ onTouchMove: true, deltaY: t2, preventDefault() {
      }, stopPropagation() {
  ...
  function pt(r2) {
    if (0 !== r2.length) {
      ...
      }), D = initBoundingArrScale(t2, m, u.precision), a("delCrop", n2), z(), nt("delete", Y(n2));
    }
  }
  return t({ render: z, removeTagItems: function(n2) {
    ...
    T = initBoundingArrScale(r2, m, u.precision), z(), rt("delete", o2);
