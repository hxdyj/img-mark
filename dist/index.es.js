...
!function(L, R) {
  !function() {
    var Wo, Fo = "Expected a function", ya = "__lodash_hash_undefined__", wa = "__lodash_placeholder__", ma = 16, Ho = 32, Vo = 64, No = 128, xa = 256, Uo = 1 / 0, $o = 9007199254740991, ba = NaN, Go = 4294967295, Ca = [["ary", No], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", ma], ["flip", 512], ["partial", Ho], ["partialRight", Vo], ["rearg", xa]], qo = "[object Arguments]", Ia = "[object Array]", Zo = "[object Boolean]", Ko = "[object Date]", Da = "[object Error]", Sa = "[object Function]", Ba = "[object GeneratorFunction]", Jo = "[object Map]", Qo = "[object Number]", ta = "[object Object]", Ta = "[object Promise]", La = "[object RegExp]", ea = "[object Set]", Ra = "[object String]", Oa = "[object Symbol]", ka = "[object WeakMap]", Ea = "[object ArrayBuffer]", na = "[object DataView]", za = "[object Float32Array]", Aa = "[object Float64Array]", Pa = "[object Int8Array]", Ya = "[object Int16Array]", ja = "[object Int32Array]", Xa = "[object Uint8Array]", Ma = "[object Uint8ClampedArray]", Wa = "[object Uint16Array]", Fa = "[object Uint32Array]", Ha = /\b__p \+= '';/g, Va = /\b(__p \+=) '' \+/g, Na = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Ua = /&(?:amp|lt|gt|quot|#39);/g, $a = /[&<>"']/g, Ga = RegExp(Ua.source), qa = RegExp($a.source), Za = /<%-([\s\S]+?)%>/g, Ka = /<%([\s\S]+?)%>/g, Ja = /<%=([\s\S]+?)%>/g, Qa = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, tu = /^\w*$/, eu = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, nu = /[\\^$.*+?()[\]{}|]/g, ru = RegExp(nu.source), iu = /^\s+/, o = /\s/, ou = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, au = /\{\n\/\* \[wrapped with (.+)\] \*/, uu = /,? & /, cu = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, fu = /[()=,{}\[\]\/\s]/, lu = /\\(\\)?/g, su = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, du = /\w*$/, hu = /^[-+]0x[0-9a-f]+$/i, pu = /^0b[01]+$/i, vu = /^\[object .+?Constructor\]$/, gu = /^0o[0-7]+$/i, _u = /^(?:0|[1-9]\d*)$/, yu = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, wu = /($^)/, mu = /['\n\r\u2028\u2029\\]/g, a = "\\ud800-\\udfff", u = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", c = "\\u2700-\\u27bf", t = "a-z\\xdf-\\xf6\\xf8-\\xff", e = "A-Z\\xc0-\\xd6\\xd8-\\xde", f = "\\ufe0e\\ufe0f", l = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", s = "['\u2019]", n = "[" + a + "]", d = "[" + l + "]", h = "[" + u + "]", p = "[" + c + "]", v = "[" + t + "]", l = "[^" + a + l + "\\d+" + c + t + e + "]", c = "\\ud83c[\\udffb-\\udfff]", t = "[^" + a + "]", g = "(?:\\ud83c[\\udde6-\\uddff]){2}", r = "[\\ud800-\\udbff][\\udc00-\\udfff]", e = "[" + e + "]", _ = "\\u200d", y = "(?:" + v + "|" + l + ")", l = "(?:" + e + "|" + l + ")", w = "(?:['\u2019](?:d|ll|m|re|s|t|ve))?", m = "(?:['\u2019](?:D|LL|M|RE|S|T|VE))?", x = "(?:" + h + "|" + c + ")?", b = "[" + f + "]?", b = b + x + ("(?:" + _ + "(?:" + [t, g, r].join("|") + ")" + b + x + ")*"), x = "(?:" + [p, g, r].join("|") + ")" + b, p = "(?:" + [t + h + "?", h, g, r, n].join("|") + ")", xu = RegExp(s, "g"), bu = RegExp(h, "g"), C = RegExp(c + "(?=" + c + ")|" + p + b, "g"), Cu = RegExp([e + "?" + v + "+" + w + "(?=" + [d, e, "$"].join("|") + ")", l + "+" + m + "(?=" + [d, e + y, "$"].join("|") + ")", e + "?" + y + "+" + w, e + "+" + m, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", "\\d+", x].join("|"), "g"), I = RegExp("[" + _ + a + u + f + "]"), Iu = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, Du = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], Su = -1, ra = {}, ia = (ra[za] = ra[Aa] = ra[Pa] = ra[Ya] = ra[ja] = ra[Xa] = ra[Ma] = ra[Wa] = ra[Fa] = true, ra[qo] = ra[Ia] = ra[Ea] = ra[Zo] = ra[na] = ra[Ko] = ra[Da] = ra[Sa] = ra[Jo] = ra[Qo] = ra[ta] = ra[La] = ra[ea] = ra[Ra] = ra[ka] = false, {}), D = (ia[qo] = ia[Ia] = ia[Ea] = ia[na] = ia[Zo] = ia[Ko] = ia[za] = ia[Aa] = ia[Pa] = ia[Ya] = ia[ja] = ia[Jo] = ia[Qo] = ia[ta] = ia[La] = ia[ea] = ia[Ra] = ia[Oa] = ia[Xa] = ia[Ma] = ia[Wa] = ia[Fa] = true, ia[Da] = ia[Sa] = ia[ka] = false, { "\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029" }), Bu = parseFloat, Tu = parseInt, t = "object" == typeof commonjsGlobal && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal, g = "object" == typeof self && self && self.Object === Object && self, oa = t || g || Function("return this")(), r = R && !R.nodeType && R, i = r && L && !L.nodeType && L, Lu = i && i.exports === r, S = Lu && t.process, n = function() {
      try {
    ...
    var ic = T({ "\xC0": "A", "\xC1": "A", "\xC2": "A", "\xC3": "A", "\xC4": "A", "\xC5": "A", "\xE0": "a", "\xE1": "a", "\xE2": "a", "\xE3": "a", "\xE4": "a", "\xE5": "a", "\xC7": "C", "\xE7": "c", "\xD0": "D", "\xF0": "d", "\xC8": "E", "\xC9": "E", "\xCA": "E", "\xCB": "E", "\xE8": "e", "\xE9": "e", "\xEA": "e", "\xEB": "e", "\xCC": "I", "\xCD": "I", "\xCE": "I", "\xCF": "I", "\xEC": "i", "\xED": "i", "\xEE": "i", "\xEF": "i", "\xD1": "N", "\xF1": "n", "\xD2": "O", "\xD3": "O", "\xD4": "O", "\xD5": "O", "\xD6": "O", "\xD8": "O", "\xF2": "o", "\xF3": "o", "\xF4": "o", "\xF5": "o", "\xF6": "o", "\xF8": "o", "\xD9": "U", "\xDA": "U", "\xDB": "U", "\xDC": "U", "\xF9": "u", "\xFA": "u", "\xFB": "u", "\xFC": "u", "\xDD": "Y", "\xFD": "y", "\xFF": "y", "\xC6": "Ae", "\xE6": "ae", "\xDE": "Th", "\xFE": "th", "\xDF": "ss", "\u0100": "A", "\u0102": "A", "\u0104": "A", "\u0101": "a", "\u0103": "a", "\u0105": "a", "\u0106": "C", "\u0108": "C", "\u010A": "C", "\u010C": "C", "\u0107": "c", "\u0109": "c", "\u010B": "c", "\u010D": "c", "\u010E": "D", "\u0110": "D", "\u010F": "d", "\u0111": "d", "\u0112": "E", "\u0114": "E", "\u0116": "E", "\u0118": "E", "\u011A": "E", "\u0113": "e", "\u0115": "e", "\u0117": "e", "\u0119": "e", "\u011B": "e", "\u011C": "G", "\u011E": "G", "\u0120": "G", "\u0122": "G", "\u011D": "g", "\u011F": "g", "\u0121": "g", "\u0123": "g", "\u0124": "H", "\u0126": "H", "\u0125": "h", "\u0127": "h", "\u0128": "I", "\u012A": "I", "\u012C": "I", "\u012E": "I", "\u0130": "I", "\u0129": "i", "\u012B": "i", "\u012D": "i", "\u012F": "i", "\u0131": "i", "\u0134": "J", "\u0135": "j", "\u0136": "K", "\u0137": "k", "\u0138": "k", "\u0139": "L", "\u013B": "L", "\u013D": "L", "\u013F": "L", "\u0141": "L", "\u013A": "l", "\u013C": "l", "\u013E": "l", "\u0140": "l", "\u0142": "l", "\u0143": "N", "\u0145": "N", "\u0147": "N", "\u014A": "N", "\u0144": "n", "\u0146": "n", "\u0148": "n", "\u014B": "n", "\u014C": "O", "\u014E": "O", "\u0150": "O", "\u014D": "o", "\u014F": "o", "\u0151": "o", "\u0154": "R", "\u0156": "R", "\u0158": "R", "\u0155": "r", "\u0157": "r", "\u0159": "r", "\u015A": "S", "\u015C": "S", "\u015E": "S", "\u0160": "S", "\u015B": "s", "\u015D": "s", "\u015F": "s", "\u0161": "s", "\u0162": "T", "\u0164": "T", "\u0166": "T", "\u0163": "t", "\u0165": "t", "\u0167": "t", "\u0168": "U", "\u016A": "U", "\u016C": "U", "\u016E": "U", "\u0170": "U", "\u0172": "U", "\u0169": "u", "\u016B": "u", "\u016D": "u", "\u016F": "u", "\u0171": "u", "\u0173": "u", "\u0174": "W", "\u0175": "w", "\u0176": "Y", "\u0177": "y", "\u0178": "Y", "\u0179": "Z", "\u017B": "Z", "\u017D": "Z", "\u017A": "z", "\u017C": "z", "\u017E": "z", "\u0132": "IJ", "\u0133": "ij", "\u0152": "Oe", "\u0153": "oe", "\u0149": "'n", "\u017F": "s" }), oc = T({ "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" });
    function ac(t2) {
      return "\\" + D[t2];
    }
    function ha(t2) {
    ...
    var _a = function i2(t2) {
      var b2 = (t2 = null == t2 ? oa : _a.defaults(oa.Object(), t2, _a.pick(oa, Du))).Array, o2 = t2.Date, k = t2.Error, E = t2.Function, z = t2.Math, v2 = t2.Object, A = t2.RegExp, F = t2.String, y2 = t2.TypeError, H = b2.prototype, V = E.prototype, N = v2.prototype, U = t2["__core-js_shared__"], $ = V.toString, P = N.hasOwnProperty, G = 0, q = (V = /[^.]+$/.exec(U && U.keys && U.keys.IE_PROTO || "")) ? "Symbol(src)_1." + V : "", Z = N.toString, K = $.call(v2), J = oa._, Q = A("^" + $.call(P).replace(nu, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), V = Lu ? t2.Buffer : Wo, e2 = t2.Symbol, tt = t2.Uint8Array, et = V ? V.allocUnsafe : Wo, nt = cc(v2.getPrototypeOf, v2), rt = v2.create, it = N.propertyIsEnumerable, ot = H.splice, at = e2 ? e2.isConcatSpreadable : Wo, ut = e2 ? e2.iterator : Wo, ct = e2 ? e2.toStringTag : Wo, ft = function() {
        try {
          var t3 = Jn(v2, "defineProperty");
          return t3({}, "", {}), t3;
        } catch (t4) {
        }
      }(), lt = t2.clearTimeout !== oa.clearTimeout && t2.clearTimeout, st = o2 && o2.now !== oa.Date.now && o2.now, dt = t2.setTimeout !== oa.setTimeout && t2.setTimeout, ht = z.ceil, pt = z.floor, vt = v2.getOwnPropertySymbols, V = V ? V.isBuffer : Wo, gt = t2.isFinite, _t = H.join, yt = cc(v2.keys, v2), w2 = z.max, C2 = z.min, wt = o2.now, mt = t2.parseInt, xt = z.random, bt = H.reverse, o2 = Jn(t2, "DataView"), Ct = Jn(t2, "Map"), It = Jn(t2, "Promise"), Dt = Jn(t2, "Set"), t2 = Jn(t2, "WeakMap"), St = Jn(v2, "create"), Bt = t2 && new t2(), Tt = {}, Lt = Cr(o2), Rt = Cr(Ct), Ot = Cr(It), kt = Cr(Dt), Et = Cr(t2), e2 = e2 ? e2.prototype : Wo, zt = e2 ? e2.valueOf : Wo, At = e2 ? e2.toString : Wo;
      function p2(t3) {
      ...
      function _2(t3) {
        this.__wrapped__ = t3, this.__actions__ = [], this.__dir__ = 1, this.__filtered__ = false, this.__iteratees__ = [], this.__takeCount__ = Go, this.__views__ = [];
      }
      function Xt(t3) {
      ...
      function Ht(t3, e3) {
        var n3, r3 = M(t3), i3 = !r3 && _i(t3), o3 = !r3 && !i3 && wi(t3), a3 = !r3 && !i3 && !o3 && Ri(t3), u3 = r3 || i3 || o3 || a3, c3 = u3 ? Ju(t3.length, F) : [], f3 = c3.length;
        for (n3 in t3)
          !e3 && !P.call(t3, n3) || u3 && ("length" == n3 || o3 && ("offset" == n3 || "parent" == n3) || a3 && ("buffer" == n3 || "byteLength" == n3 || "byteOffset" == n3) || ir(n3, f3)) || c3.push(n3);
        return c3;
      }
      function Vt(t3) {
        var e3 = t3.length;
        return e3 ? t3[je(0, e3 - 1)] : Wo;
      }
      function Nt(t3, e3) {
      ...
      function Gt(t3, e3, n3) {
        var r3 = t3[e3];
        P.call(t3, e3) && X(r3, n3) && (n3 !== Wo || e3 in t3) || Jt(t3, e3, n3);
      }
      function qt(t3, e3) {
      ...
      function m2(n3, r3, i3, t3, e3, o3) {
        ...
        if (t3) {
          ...
          var s3 = j(n3), d3 = s3 == Sa || s3 == Ba;
          if (wi(n3))
            return ln(n3, u3);
          if (s3 == ta || s3 == qo || d3 && !e3) {
            if (a3 = c3 || d3 ? {} : nr(n3), !u3)
              return c3 ? (h3 = d3 = n3, h3 = (l3 = a3) && gn(h3, R2(h3), l3), gn(d3, tr(d3), h3)) : (d3 = Kt(a3, l3 = n3), gn(l3, Qn(l3), d3));
          } else {
            if (!ia[s3])
              return e3 ? n3 : {};
        ...
        var h3 = (o3 = o3 || new Y()).get(n3);
        if (h3)
          return h3;
        o3.set(n3, a3), Ti(n3) ? n3.forEach(function(t4) {
          a3.add(m2(t4, r3, i3, t4, n3, o3));
        }) : Ii(n3) && n3.forEach(function(t4, e4) {
          a3.set(e4, m2(t4, r3, i3, e4, n3, o3));
        });
        var p3 = t3 ? Wo : (f3 ? c3 ? Un : Nn : c3 ? R2 : L2)(n3);
        return ua(p3 || n3, function(t4, e4) {
          p3 && (t4 = n3[e4 = t4]), Gt(a3, e4, m2(t4, r3, i3, e4, n3, o3));
        }), a3;
      }
      ...
      function re(t3, e3, n3, r3) {
        ...
        if (!u3)
          return c3;
        n3 && (e3 = fa(e3, da(n3))), r3 ? (o3 = Mu, a3 = false) : 200 <= e3.length && (o3 = ec, a3 = false, e3 = new Ft(e3));
        t:
          for (; ++i3 < u3; ) {
      ...
      p2.templateSettings = { escape: Za, evaluate: Ka, interpolate: Ja, variable: "", imports: { _: p2 } }, (p2.prototype = jt.prototype).constructor = p2, (g2.prototype = Pt(jt.prototype)).constructor = g2, (_2.prototype = Pt(jt.prototype)).constructor = _2, Xt.prototype.clear = function() {
        ...
        return St ? (e3 = n3[t3]) === ya ? Wo : e3 : P.call(n3, t3) ? n3[t3] : Wo;
      }, Xt.prototype.has = function(t3) {
        var e3 = this.__data__;
        return St ? e3[t3] !== Wo : P.call(e3, t3);
      }, Xt.prototype.set = function(t3, e3) {
        var n3 = this.__data__;
        return this.size += this.has(t3) ? 0 : 1, n3[t3] = St && e3 === Wo ? ya : e3, this;
      }, Mt.prototype.clear = function() {
        this.__data__ = [], this.size = 0;
      }, Mt.prototype.delete = function(t3) {
        var e3 = this.__data__;
        return !((t3 = qt(e3, t3)) < 0) && (t3 == e3.length - 1 ? e3.pop() : ot.call(e3, t3, 1), --this.size, true);
      }, Mt.prototype.get = function(t3) {
        var e3 = this.__data__;
        return (t3 = qt(e3, t3)) < 0 ? Wo : e3[t3][1];
      ...
      function ue(t3, e3, n3) {
        for (var r3 = -1, i3 = t3.length; ++r3 < i3; ) {
          ...
          null != c3 && (o3 === Wo ? c3 == c3 && !S2(c3) : n3(c3, o3)) && (o3 = c3, a3 = u3);
        }
        return a3;
      }
      function ce(t3, r3) {
      ...
      function we(t3, e3, n3) {
        for (var r3 = n3 ? Mu : Xu, i3 = t3[0].length, o3 = t3.length, a3 = o3, u3 = b2(o3), c3 = 1 / 0, f3 = []; a3--; ) {
          var l3 = t3[a3];
          a3 && e3 && (l3 = fa(l3, da(e3))), c3 = C2(l3.length, c3), u3[a3] = !n3 && (e3 || 120 <= i3 && 120 <= l3.length) ? new Ft(a3 && l3) : Wo;
        }
      ...
      function be(t3, e3, n3, r3, i3) {
        {
          ...
          if (null == t3 || null == e3 || !W(t3) && !W(e3))
            return t3 != t3 && e3 != e3;
          var o3 = be, a3 = M(t3), u3 = M(e3), c3 = a3 ? Ia : j(t3), u3 = u3 ? Ia : j(e3), f3 = (c3 = c3 == qo ? ta : c3) == ta, l3 = (u3 = u3 == qo ? ta : u3) == ta, u3;
          if ((u3 = c3 == u3) && wi(t3)) {
            if (!wi(e3))
              return false;
            f3 = !(a3 = true);
          ...
          if (!(1 & n3)) {
            a3 = f3 && P.call(t3, "__wrapped__"), c3 = l3 && P.call(e3, "__wrapped__");
            if (a3 || c3)
              return f3 = a3 ? t3.value() : t3, l3 = c3 ? e3.value() : e3, i3 = i3 || new Y(), o3(f3, l3, n3, r3, i3);
          }
          if (u3) {
            i3 = i3 || new Y();
            var m3 = t3, x3 = e3, b3 = n3, C3 = r3, I3 = o3, D3 = i3, S3 = 1 & b3, B3 = Nn(m3), T3 = B3.length, a3 = Nn(x3).length;
            if (T3 != a3 && !S3)
              return false;
            for (var L3 = T3; L3--; ) {
              var R3 = B3[L3];
              if (!(S3 ? R3 in x3 : P.call(x3, R3)))
                return false;
            }
            a3 = D3.get(m3), c3 = D3.get(x3);
            if (a3 && c3)
              return a3 == x3 && c3 == m3;
            for (var O2 = true, k2 = (D3.set(m3, x3), D3.set(x3, m3), S3); ++L3 < T3; ) {
              R3 = B3[L3];
              var E2, z2 = m3[R3], A2 = x3[R3];
              if (!((E2 = C3 ? S3 ? C3(A2, z2, R3, x3, m3, D3) : C3(z2, A2, R3, m3, x3, D3) : E2) === Wo ? z2 === A2 || I3(z2, A2, b3, C3, D3) : E2)) {
                O2 = false;
                break;
              }
      ...
      function Ie(t3) {
        return !(!D2(t3) || (e3 = t3, q && q in e3)) && (xi(t3) ? Q : vu).test(Cr(t3));
        var e3;
      }
      function De(t3) {
        return "function" == typeof t3 ? t3 : null == t3 ? O : "object" == typeof t3 ? M(t3) ? Oe(t3[0], t3[1]) : Re(t3) : To(t3);
      }
      function Se(t3) {
        if (!cr(t3))
          return yt(t3);
      ...
      function Be(t3) {
        ...
        var i3, o3 = cr(t3), a3 = [];
        for (i3 in t3)
          ("constructor" != i3 || !o3 && P.call(t3, i3)) && a3.push(i3);
        return a3;
      }
      function Te(t3, e3) {
        return t3 < e3;
      ...
      function ke(v3, g3, _3, y3, w3) {
        v3 !== g3 && fe(g3, function(t3, e3) {
          ...
          w3 = w3 || new Y(), D2(t3) ? (r3 = g3, o3 = _3, a3 = ke, u3 = y3, c3 = w3, d3 = hr(n3 = v3, i3 = e3), h3 = hr(r3, i3), (p3 = c3.get(h3)) ? $t(n3, i3, p3) : (p3 = u3 ? u3(d3, h3, i3 + "", n3, r3, c3) : Wo, (r3 = p3 === Wo) && (f3 = M(h3), l3 = !f3 && wi(h3), s3 = !f3 && !l3 && Ri(h3), p3 = h3, f3 || l3 || s3 ? p3 = M(d3) ? d3 : x2(d3) ? I2(d3) : l3 ? ln(h3, !(r3 = false)) : s3 ? dn(h3, !(r3 = false)) : [] : Si(h3) || _i(h3) ? _i(p3 = d3) ? p3 = Pi(d3) : D2(d3) && !xi(d3) || (p3 = nr(h3)) : r3 = false), r3 && (c3.set(h3, p3), a3(p3, h3, o3, u3, c3), c3.delete(h3)), $t(n3, i3, p3))) : (f3 = y3 ? y3(hr(v3, e3), t3, e3 + "", v3, g3, w3) : Wo, $t(v3, e3, f3 = f3 === Wo ? t3 : f3));
        }, R2);
      }
      function Ee(t3, e3) {
        var n3 = t3.length;
      ...
      function Fe(t3, e3, n3, r3) {
        ...
        for (var i3 = -1, o3 = (e3 = an(e3, t3)).length, a3 = o3 - 1, u3 = t3; null != u3 && ++i3 < o3; ) {
          ...
          if ("__proto__" === f3 || "constructor" === f3 || "prototype" === f3)
            return t3;
          i3 != a3 && (c3 = u3[f3], (l3 = r3 ? r3(c3, f3, u3) : Wo) === Wo && (l3 = D2(c3) ? c3 : ir(e3[i3 + 1]) ? [] : {})), Gt(u3, f3, l3), u3 = u3[f3];
        }
        return t3;
      }
      ...
      function Ue(t3, e3, n3) {
        ...
        if ("number" == typeof e3 && e3 == e3 && i3 <= 2147483647) {
          for (; r3 < i3; ) {
            ...
            null !== a3 && !S2(a3) && (n3 ? a3 <= e3 : a3 < e3) ? r3 = 1 + o3 : i3 = o3;
          }
          return i3;
        }
        return $e(t3, e3, O, n3);
      ...
      function $e(t3, e3, n3, r3) {
        ...
        if (0 === o3)
          return 0;
        for (var a3 = (e3 = n3(e3)) != e3, u3 = null === e3, c3 = S2(e3), f3 = e3 === Wo; i3 < o3; ) {
          var l3 = pt((i3 + o3) / 2), s3 = n3(t3[l3]), d3 = s3 !== Wo, h3 = null === s3, p3 = s3 == s3, v3 = S2(s3), p3 = a3 ? r3 || p3 : f3 ? p3 && (r3 || d3) : u3 ? p3 && d3 && (r3 || !h3) : c3 ? p3 && d3 && !h3 && (r3 || !v3) : !h3 && !v3 && (r3 ? s3 <= e3 : s3 < e3);
          p3 ? i3 = l3 + 1 : o3 = l3;
        }
      ...
      function Ze(t3, e3, n3) {
        ...
        if (n3)
          ...
          var f3 = e3 ? null : Yn(t3);
          if (f3)
            return fc(f3);
          a3 = false, i3 = ec, c3 = new Ft();
        } else
          c3 = e3 ? [] : u3;
        t:
          for (; ++r3 < o3; ) {
      ...
      function hn(t3, e3) {
        if (t3 !== e3) {
          var n3 = t3 !== Wo, r3 = null === t3, i3 = t3 == t3, o3 = S2(t3), a3 = e3 !== Wo, u3 = null === e3, c3 = e3 == e3, f3 = S2(e3);
      ...
      function gn(t3, e3, n3, r3) {
        for (var i3 = !n3, o3 = (n3 = n3 || {}, -1), a3 = e3.length; ++o3 < a3; ) {
          ...
          (i3 ? Jt : Gt)(n3, u3, c3 = c3 === Wo ? t3[u3] : c3);
        }
        return n3;
      }
      function _n(i3, o3) {
        return function(t3, e3) {
          var n3 = M(t3) ? Pu : Zt, r3 = o3 ? o3() : {};
      ...
      function In(o3, a3, u3) {
        var c3 = Cn(o3);
        return function t3() {
          for (var e3 = arguments.length, n3 = b2(e3), r3 = e3, i3 = qn(t3); r3--; )
            n3[r3] = arguments[r3];
          i3 = e3 < 3 && n3[0] !== i3 && n3[e3 - 1] !== i3 ? [] : pa(n3, i3);
          return (e3 -= i3.length) < u3 ? An(o3, a3, Bn, t3.placeholder, Wo, n3, i3, Wo, Wo, u3 - e3) : aa(this && this !== oa && this instanceof t3 ? c3 : o3, this, n3);
        };
      }
      function Dn(o3) {
        return function(t3, e3, n3) {
          var r3, i3 = v2(t3), e3 = (l2(t3) || (r3 = s2(e3, 3), t3 = L2(t3), e3 = function(t4) {
      ...
      function Sn(c3) {
        return Vn(function(i3) {
          ...
          for (t3 = u3 ? t3 : o3; ++t3 < o3; )
            var r3 = Gn(n3 = i3[t3]), a3 = "wrapper" == r3 ? $n(n3) : Wo, u3 = a3 && ar(a3[0]) && 424 == a3[1] && !a3[4].length && 1 == a3[9] ? u3[Gn(a3[0])].apply(u3, a3[3]) : 1 == n3.length && ar(n3) ? u3[r3]() : u3.thru(n3);
          return function() {
      ...
      function Bn(a3, u3, c3, f3, l3, s3, d3, h3, p3, v3) {
        ...
        return function t3() {
          ...
          if (w3 && (i3 = function(t4, e4) {
            for (var n4 = t4.length, r4 = 0; n4--; )
              t4[n4] === e4 && ++r4;
            return r4;
          }(e3, r3 = qn(t3))), f3 && (e3 = pn(e3, f3, l3, w3)), s3 && (e3 = vn(e3, s3, d3, w3)), o3 -= i3, w3 && o3 < v3)
            return i3 = pa(e3, r3), An(a3, u3, Bn, t3.placeholder, c3, e3, i3, h3, p3, v3 - o3);
      ...
      function Ln(r3, i3) {
        return function(t3, e3) {
          ...
          if (t3 !== Wo && (n3 = t3), e3 !== Wo) {
            if (n3 === Wo)
              return e3;
            e3 = "string" == typeof t3 || "string" == typeof e3 ? (t3 = f2(t3), f2(e3)) : (t3 = qe(t3), qe(e3)), n3 = r3(t3, e3);
          }
          return n3;
        };
      }
      ...
      function An(t3, e3, n3, r3, i3, o3, a3, u3, c3, f3) {
        var l3 = 8 & e3, i3 = (4 & (e3 = (e3 | (l3 ? Ho : Vo)) & ~(l3 ? Vo : Ho)) || (e3 &= -4), [t3, e3, i3, l3 ? o3 : Wo, l3 ? a3 : Wo, l3 ? Wo : o3, l3 ? Wo : a3, u3, c3, f3]), o3 = n3.apply(Wo, i3);
      ...
      var Yn = Dt && 1 / fc(new Dt([, -0]))[1] == Uo ? function(t3) {
        return new Dt(t3);
      } : Io;
      function jn(o3) {
        return function(t3) {
          var e3, n3, r3, i3 = j(t3);
      ...
      function Xn(t3, e3, n3, r3, i3, o3, a3, u3) {
        ...
        if (!c3 && "function" != typeof t3)
          throw new y2(Fo);
        var f3, l3, s3, d3, h3, p3 = r3 ? r3.length : 0, v3 = (p3 || (e3 &= -97, r3 = i3 = Wo), a3 = a3 === Wo ? a3 : w2(B2(a3), 0), u3 = u3 === Wo ? u3 : B2(u3), p3 -= i3 ? i3.length : 0, e3 & Vo && (g3 = r3, f3 = i3, r3 = i3 = Wo), c3 ? Wo : $n(t3)), g3 = [t3, e3, n3, r3, i3, g3, f3, o3, a3, u3];
        return v3 && function(t4, e4) {
          ...
          null == t4[9] && (t4[9] = e4[9]);
          t4[0] = e4[0], t4[1] = i4;
        }(g3, v3), t3 = g3[0], e3 = g3[1], n3 = g3[2], r3 = g3[3], i3 = g3[4], !(u3 = g3[9] = g3[9] === Wo ? c3 ? 0 : t3.length : w2(g3[9] - p3, 0)) && 24 & e3 && (e3 &= -25), f3 = e3 && 1 != e3 ? 8 == e3 || e3 == ma ? In(t3, e3, u3) : e3 != Ho && 33 != e3 || i3.length ? Bn.apply(Wo, g3) : kn(t3, e3, n3, r3) : (s3 = n3, d3 = 1 & e3, h3 = Cn(l3 = t3), function t4() {
          return (this && this !== oa && this instanceof t4 ? h3 : l3).apply(d3 ? s3 : this, arguments);
        }), _r((v3 ? He : pr)(f3, g3), t3, e3);
      }
      function Mn(t3, e3, n3, r3) {
        return t3 === Wo || X(t3, N[n3]) && !P.call(r3, n3) ? e3 : t3;
      }
      function Wn(t3, e3, n3, r3, i3, o3) {
        return D2(t3) && D2(e3) && (o3.set(e3, t3), ke(t3, e3, Wo, Wn, o3), o3.delete(e3)), t3;
      }
      function Fn(t3) {
        return Si(t3) ? Wo : t3;
      }
      function Hn(t3, e3, n3, r3, i3, o3) {
        ...
        if (c3 && f3)
          return c3 == e3 && f3 == t3;
        var l3 = -1, s3 = true, d3 = 2 & n3 ? new Ft() : Wo;
      ...
      function s2() {
        var t3 = (t3 = p2.iteratee || mo) === mo ? De : t3;
      ...
      (o2 && j(new o2(new ArrayBuffer(1))) != na || Ct && j(new Ct()) != Jo || It && j(It.resolve()) != Ta || Dt && j(new Dt()) != ea || t2 && j(new t2()) != ka) && (j = function(t3) {
      ...
      function Sr(t3, e3, n3) {
        ...
        if (!r3)
          return -1;
        var i3 = r3 - 1;
        return n3 !== Wo && (i3 = B2(n3), i3 = n3 < 0 ? w2(r3 + i3, 0) : C2(i3, r3 - 1)), Nu(t3, s2(e3, 3), i3, true);
      }
      function Br(t3) {
      ...
      var Rr = Vn(function(t3, e3) {
        ...
        return Ye(t3, fa(e3, function(t4) {
      ...
      var $r = Dn(Dr), Gr = Dn(Sr);
      function qr(t3, e3) {
        return (M(t3) ? ua : ie)(t3, s2(e3, 3));
      }
      function Zr(t3, e3) {
        return (M(t3) ? Yu : oe)(t3, s2(e3, 3));
      }
      ...
      var ai = a2(function(t3, e3, n3) {
        var r3, i3 = 1;
        return n3.length && (r3 = pa(n3, qn(ai)), i3 |= Ho), Xn(t3, i3, e3, n3, r3);
      }), ui = a2(function(t3, e3, n3) {
        var r3, i3 = 3;
        return n3.length && (r3 = pa(n3, qn(ui)), i3 |= Ho), Xn(e3, i3, t3, n3, r3);
      });
      function ci(r3, n3, t3) {
        ...
        return n3 = T2(n3) || 0, D2(t3) && (s3 = !!t3.leading, d3 = "maxWait" in t3, a3 = d3 ? w2(T2(t3.maxWait) || 0, n3) : a3, e3 = "trailing" in t3 ? !!t3.trailing : e3), _3.cancel = function() {
      ...
      var vi = zn(ge), gi = zn(function(t3, e3) {
        ...
        return W(t3) && P.call(t3, "callee") && !it.call(t3, "callee");
      }, M = b2.isArray, yi = Ru ? da(Ru) : function(t3) {
      ...
      function mi(t3) {
        if (!W(t3))
          return false;
        var e3 = n2(t3);
        return e3 == Da || "[object DOMException]" == e3 || "string" == typeof t3.message && "string" == typeof t3.name && !Si(t3);
      }
      function xi(t3) {
        if (!D2(t3))
          return false;
      ...
      var Bi = Eu ? da(Eu) : function(t3) {
        return W(t3) && n2(t3) == La;
      };
      var Ti = zu ? da(zu) : function(t3) {
        return W(t3) && j(t3) == ea;
      };
      function Li(t3) {
      ...
      var Ri = Au ? da(Au) : function(t3) {
        return W(t3) && Ci(t3.length) && !!ra[n2(t3)];
      };
      var Oi = zn(Te), ki = zn(function(t3, e3) {
        return t3 <= e3;
      });
      function Ei(t3) {
        if (!t3)
      ...
      function zi(t3) {
        return t3 ? (t3 = T2(t3)) === Uo || t3 === -Uo ? 17976931348623157e292 * (t3 < 0 ? -1 : 1) : t3 == t3 ? t3 : 0 : 0 === t3 ? t3 : 0;
      }
      function B2(t3) {
      ...
      var Yi = yn(function(t3, e3) {
        if (cr(e3) || l2(e3))
          gn(e3, L2(e3), t3);
        else
          for (var n3 in e3)
            P.call(e3, n3) && Gt(t3, n3, e3[n3]);
      }), ji = yn(function(t3, e3) {
        gn(e3, R2(e3), t3);
      ...
      var Fi = a2(function(t3, e3) {
        t3 = v2(t3);
        var n3 = -1, r3 = e3.length, i3 = 2 < r3 ? e3[2] : Wo;
        for (i3 && d2(e3[0], e3[1], i3) && (r3 = 1); ++n3 < r3; )
          for (var o3 = e3[n3], a3 = R2(o3), u3 = -1, c3 = a3.length; ++u3 < c3; ) {
            var f3 = a3[u3], l3 = t3[f3];
            (l3 === Wo || X(l3, N[f3]) && !P.call(t3, f3)) && (t3[f3] = o3[f3]);
          }
        return t3;
      }), Hi = a2(function(t3) {
      ...
      var qi = yn(function(t3, e3, n3) {
        ...
        }), gn(e3, Un(e3), n3), r3 && (n3 = m2(n3, 7, Fn)), t3.length); i3--; )
          Ke(n3, t3[i3]);
        return n3;
      });
      ...
      function Co(r3, e3, t3) {
        var n3 = L2(e3), i3 = he(e3, n3), o3 = (null != t3 || D2(e3) && (i3.length || !n3.length) || (t3 = e3, e3 = r3, r3 = this, i3 = he(e3, L2(e3))), !(D2(t3) && "chain" in t3 && !t3.chain)), a3 = xi(r3);
      ...
      var Do = Rn(fa), So = Rn(ju), Bo = Rn(Hu);
      function To(t3) {
        return or(t3) ? qu(br(t3)) : (e3 = t3, function(t4) {
          return pe(t4, e3);
        });
        var e3;
      }
      var Lo = En(), Ro = En(true);
      function Oo() {
        return [];
      }
      function ko() {
      ...
      var Eo = Ln(function(t3, e3) {
        return t3 + e3;
      }, 0), zo = Pn("ceil"), Ao = Ln(function(t3, e3) {
        return t3 / e3;
      }, 1), Po = Pn("floor");
      var Yo, jo = Ln(function(t3, e3) {
        return t3 * e3;
      }, 1), Xo = Pn("round"), Mo = Ln(function(t3, e3) {
        return t3 - e3;
      }, 0);
      return p2.after = function(t3, e3) {
      ...
      }, p2.ary = ii, p2.assign = Yi, p2.assignIn = ji, p2.assignInWith = Xi, p2.assignWith = Mi, p2.at = Wi, p2.before = oi, p2.bind = ai, p2.bindAll = go, p2.bindKey = ui, p2.castArray = function() {
        if (!arguments.length)
          return [];
        var t3 = arguments[0];
        return M(t3) ? t3 : [t3];
      }, p2.chain = Hr, p2.chunk = function(t3, e3, n3) {
        e3 = (n3 ? d2(t3, e3, n3) : e3 === Wo) ? 1 : w2(B2(e3), 0);
        var r3 = null == t3 ? 0 : t3.length;
        if (!r3 || e3 < 1)
          return [];
        ...
        return e3.placeholder = t3.placeholder, e3;
      }, p2.debounce = ci, p2.defaults = Fi, p2.defaultsDeep = Hi, p2.defer = st, p2.delay = fi, p2.difference = o2, p2.differenceBy = It, p2.differenceWith = t2, p2.drop = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
        return r3 ? u2(t3, (e3 = n3 || e3 === Wo ? 1 : B2(e3)) < 0 ? 0 : e3, r3) : [];
      }, p2.dropRight = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
        return r3 ? u2(t3, 0, (e3 = r3 - (e3 = n3 || e3 === Wo ? 1 : B2(e3))) < 0 ? 0 : e3) : [];
        ...
        for ((a3 = B2(a3)) < 0 && (a3 = c3 < -a3 ? 0 : c3 + a3), (u3 = u3 === Wo || c3 < u3 ? c3 : B2(u3)) < 0 && (u3 += c3), u3 = u3 < a3 ? 0 : Ai(u3); a3 < u3; )
          i3[a3++] = o3;
        return i3;
      ...
      }, p2.intersection = U, p2.intersectionBy = dt, p2.intersectionWith = e2, p2.invert = Ui, p2.invertBy = $i, p2.invokeMap = Jr, p2.iteratee = mo, p2.keyBy = Qr, p2.keys = L2, p2.keysIn = R2, p2.map = ti, p2.mapKeys = function(t3, r3) {
        var i3 = {};
      ...
      }, p2.memoize = li, p2.merge = qi, p2.mergeWith = Zi, p2.method = xo, p2.methodOf = bo, p2.mixin = Co, p2.negate = si, p2.nthArg = function(e3) {
      ...
      }, p2.over = Do, p2.overArgs = un, p2.overEvery = So, p2.overSome = Bo, p2.partial = di, p2.partialRight = hi, p2.partition = ei, p2.pick = Ji, p2.pickBy = Qi, p2.property = To, p2.propertyOf = function(e3) {
        return function(t3) {
          return null == e3 ? Wo : pe(e3, t3);
        };
      }, p2.pull = lt, p2.pullAll = Lr, p2.pullAllBy = function(t3, e3, n3) {
        return t3 && t3.length && e3 && e3.length ? Pe(t3, e3, s2(n3, 2)) : t3;
      }, p2.pullAllWith = function(t3, e3, n3) {
        return t3 && t3.length && e3 && e3.length ? Pe(t3, e3, Wo, n3) : t3;
      }, p2.pullAt = Rr, p2.range = Lo, p2.rangeRight = Ro, p2.rearg = pi, p2.reject = function(t3, e3) {
        ...
        if ("function" != typeof t3)
          throw new y2(Fo);
        return a2(t3, e3 = e3 === Wo ? e3 : B2(e3));
      }, p2.reverse = Or, p2.sampleSize = function(t3, e3, n3) {
        return e3 = (n3 ? d2(t3, e3, n3) : e3 === Wo) ? 1 : B2(e3), (M(t3) ? Nt : We)(t3, e3);
      }, p2.set = function(t3, e3, n3) {
        return null == t3 ? t3 : Fe(t3, e3, n3);
      }, p2.setWith = function(t3, e3, n3, r3) {
        return r3 = "function" == typeof r3 ? r3 : Wo, null == t3 ? t3 : Fe(t3, e3, n3, r3);
      }, p2.shuffle = function(t3) {
        return (M(t3) ? Ut : Ve)(t3);
      }, p2.slice = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
        return r3 ? (n3 = n3 && "number" != typeof n3 && d2(t3, e3, n3) ? (e3 = 0, r3) : (e3 = null == e3 ? 0 : B2(e3), n3 === Wo ? r3 : B2(n3)), u2(t3, e3, n3)) : [];
      }, p2.sortBy = ni, p2.sortedUniq = function(t3) {
        return t3 && t3.length ? Ge(t3) : [];
      }, p2.sortedUniqBy = function(t3, e3) {
        return t3 && t3.length ? Ge(t3, s2(e3, 2)) : [];
      }, p2.split = function(t3, e3, n3) {
        return n3 && "number" != typeof n3 && d2(t3, e3, n3) && (e3 = n3 = Wo), (n3 = n3 === Wo ? Go : n3 >>> 0) ? (t3 = h2(t3)) && ("string" == typeof e3 || null != e3 && !Bi(e3)) && !(e3 = f2(e3)) && ha(t3) ? cn(ga(t3), 0, n3) : t3.split(e3, n3) : [];
        ...
        return t3 && t3.length ? u2(t3, 0, (e3 = n3 || e3 === Wo ? 1 : B2(e3)) < 0 ? 0 : e3) : [];
      }, p2.takeRight = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
        return r3 ? u2(t3, (e3 = r3 - (e3 = n3 || e3 === Wo ? 1 : B2(e3))) < 0 ? 0 : e3, r3) : [];
        ...
        if ("function" != typeof t3)
          throw new y2(Fo);
        return D2(n3) && (r3 = "leading" in n3 ? !!n3.leading : r3, i3 = "trailing" in n3 ? !!n3.trailing : i3), ci(t3, e3, { leading: r3, maxWait: e3, trailing: i3 });
      }, p2.thru = Vr, p2.toArray = Ei, p2.toPairs = to, p2.toPairsIn = eo, p2.toPath = function(t3) {
        return M(t3) ? fa(t3, br) : S2(t3) ? [t3] : I2(xr(h2(t3)));
      }, p2.toPlainObject = Pi, p2.transform = function(t3, r3, i3) {
        var e3, n3 = M(t3), o3 = n3 || wi(t3) || Ri(t3);
        return r3 = s2(r3, 4), null == i3 && (e3 = t3 && t3.constructor, i3 = o3 ? n3 ? new e3() : [] : D2(t3) && xi(e3) ? Pt(nt(t3)) : {}), (o3 ? ua : se)(t3, function(t4, e4, n4) {
      ...
      }, p2.without = Yr, p2.words = po, p2.wrap = function(t3, e3) {
        return di(on(e3), t3);
      }, p2.xor = jr, p2.xorBy = Xr, p2.xorWith = Mr, p2.zip = Wr, p2.zipObject = function(t3, e3) {
        return nn(t3 || [], e3 || [], Gt);
      }, p2.zipObjectDeep = function(t3, e3) {
        return nn(t3 || [], e3 || [], Fe);
      }, p2.zipWith = Fr, p2.entries = to, p2.entriesIn = eo, p2.extend = ji, p2.extendWith = Xi, Co(p2, p2), p2.add = Eo, p2.attempt = vo, p2.camelCase = ro, p2.capitalize = io, p2.ceil = zo, p2.clamp = function(t3, e3, n3) {
        return n3 === Wo && (n3 = e3, e3 = Wo), n3 !== Wo && (n3 = (n3 = T2(n3)) == n3 ? n3 : 0), e3 !== Wo && (e3 = (e3 = T2(e3)) == e3 ? e3 : 0), te(T2(t3), e3, n3);
      ...
      }, p2.floor = Po, p2.forEach = qr, p2.forEachRight = Zr, p2.forIn = function(t3, e3) {
        return null == t3 ? t3 : fe(t3, s2(e3, 3), R2);
      }, p2.forInRight = function(t3, e3) {
        return null == t3 ? t3 : le(t3, s2(e3, 3), R2);
      ...
      }, p2.hasIn = Ni, p2.head = Tr, p2.identity = O, p2.includes = function(t3, e3, n3, r3) {
        return t3 = l2(t3) ? t3 : no(t3), n3 = n3 && !r3 ? B2(n3) : 0, r3 = t3.length, n3 < 0 && (n3 = w2(r3 + n3, 0)), Li(t3) ? n3 <= r3 && -1 < t3.indexOf(e3, n3) : !!r3 && -1 < sa(t3, e3, n3);
      }, p2.indexOf = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
        return r3 ? (n3 = null == n3 ? 0 : B2(n3), sa(t3, e3, n3 = n3 < 0 ? w2(r3 + n3, 0) : n3)) : -1;
      }, p2.inRange = function(t3, e3, n3) {
        return e3 = zi(e3), n3 === Wo ? (n3 = e3, e3 = 0) : n3 = zi(n3), (t3 = t3 = T2(t3)) >= C2(e3 = e3, n3 = n3) && t3 < w2(e3, n3);
      }, p2.invoke = Gi, p2.isArguments = _i, p2.isArray = M, p2.isArrayBuffer = yi, p2.isArrayLike = l2, p2.isArrayLikeObject = x2, p2.isBoolean = function(t3) {
        return true === t3 || false === t3 || W(t3) && n2(t3) == Zo;
      }, p2.isBuffer = wi, p2.isDate = V, p2.isElement = function(t3) {
        return W(t3) && 1 === t3.nodeType && !Si(t3);
      }, p2.isEmpty = function(t3) {
        if (null == t3)
          return true;
        if (l2(t3) && (M(t3) || "string" == typeof t3 || "function" == typeof t3.splice || wi(t3) || Ri(t3) || _i(t3)))
          return !t3.length;
        var e3, n3 = j(t3);
        if (n3 == Jo || n3 == ea)
          return !t3.size;
        ...
        return null === t3;
      }, p2.isNumber = Di, p2.isObject = D2, p2.isObjectLike = W, p2.isPlainObject = Si, p2.isRegExp = Bi, p2.isSafeInteger = function(t3) {
        return bi(t3) && -$o <= t3 && t3 <= $o;
      }, p2.isSet = Ti, p2.isString = Li, p2.isSymbol = S2, p2.isTypedArray = Ri, p2.isUndefined = function(t3) {
        return t3 === Wo;
        ...
        if (!r3)
          return -1;
        var i3 = r3;
        if (n3 !== Wo && (i3 = (i3 = B2(n3)) < 0 ? w2(r3 + i3, 0) : C2(i3, r3 - 1)), e3 != e3)
        ...
        return Gu(t3, s2(e3, 2));
      }, p2.min = function(t3) {
        return t3 && t3.length ? ue(t3, O, Te) : Wo;
      }, p2.minBy = function(t3, e3) {
        return t3 && t3.length ? ue(t3, s2(e3, 2), Te) : Wo;
        ...
        return true;
      }, p2.multiply = jo, p2.nth = function(t3, e3) {
        return t3 && t3.length ? Ee(t3, B2(e3)) : Wo;
        ...
        var r3;
        return n3 && "boolean" != typeof n3 && d2(t3, e3, n3) && (e3 = n3 = Wo), n3 === Wo && ("boolean" == typeof e3 ? (n3 = e3, e3 = Wo) : "boolean" == typeof t3 && (n3 = t3, t3 = Wo)), t3 === Wo && e3 === Wo ? (t3 = 0, e3 = 1) : (t3 = zi(t3), e3 === Wo ? (e3 = t3, t3 = 0) : e3 = zi(e3)), e3 < t3 && (r3 = t3, t3 = e3, e3 = r3), n3 || t3 % 1 || e3 % 1 ? (r3 = xt(), C2(t3 + r3 * (e3 - t3 + Bu("1e-" + ((r3 + "").length - 1))), e3)) : je(t3, e3);
        ...
        var r3 = M(t3) ? Fu : Zu, i3 = arguments.length < 3;
        return r3(t3, s2(e3, 4), n3, i3, oe);
      }, p2.repeat = function(t3, e3, n3) {
        return e3 = (n3 ? d2(t3, e3, n3) : e3 === Wo) ? 1 : B2(e3), Xe(h2(t3), e3);
      }, p2.replace = function() {
        ...
        if (null == t3)
          return 0;
        if (l2(t3))
          return Li(t3) ? va(t3) : t3.length;
        var e3 = j(t3);
        return e3 == Jo || e3 == ea ? t3.size : Se(t3).length;
      }, p2.snakeCase = fo, p2.some = function(t3, e3, n3) {
        return (M(t3) ? Hu : Ne)(t3, s2(e3 = n3 && d2(t3, e3, n3) ? Wo : e3, 3));
        ...
        return t3 = h2(t3), n3 = null == n3 ? 0 : te(B2(n3), 0, t3.length), e3 = f2(e3), t3.slice(n3, n3 + e3.length) == e3;
        ...
        var r3 = L2(e3 = Xi({}, t3.imports, n3.imports, Mn)), i3 = tc(e3, r3), f3 = 0, n3 = t3.interpolate || wu, l3 = "__p += '", e3 = A((t3.escape || wu).source + "|" + n3.source + "|" + (n3 === Ja ? su : wu).source + "|" + (t3.evaluate || wu).source + "|$", "g"), o3 = "//# sourceURL=" + (P.call(t3, "sourceURL") ? (t3.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Su + "]") + "\n";
        ...
        if ((t3 = B2(t3)) < 1 || $o < t3)
          return [];
        for (var n3 = Go, r3 = C2(t3, Go), r3 = (e3 = s2(e3), t3 -= Go, Ju(r3, e3)); ++n3 < t3; )
          e3(n3);
        return r3;
      }, p2.toFinite = zi, p2.toInteger = B2, p2.toLength = Ai, p2.toLower = function(t3) {
        return h2(t3).toLowerCase();
      }, p2.toNumber = T2, p2.toSafeInteger = function(t3) {
        return t3 ? te(B2(t3), -$o, $o) : 0 === t3 ? t3 : 0;
        ...
        var n3, r3 = 30, i3 = "...", e3 = (D2(e3) && (n3 = "separator" in e3 ? e3.separator : n3, r3 = "length" in e3 ? B2(e3.length) : r3, i3 = "omission" in e3 ? f2(e3.omission) : i3), (t3 = h2(t3)).length);
        ...
        return (t3 = h2(t3)) && Ga.test(t3) ? t3.replace(Ua, sc) : t3;
      }, p2.uniqueId = function(t3) {
        var e3 = ++G;
        return h2(t3) + e3;
      }, p2.upperCase = so, p2.upperFirst = ho, p2.each = qr, p2.eachRight = Zr, p2.first = Tr, Co(p2, (Yo = {}, se(p2, function(t3, e3) {
        P.call(p2.prototype, e3) || (Yo[e3] = t3);
      }), Yo), { chain: false }), p2.VERSION = "4.17.21", ua(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function(t3) {
        p2[t3].placeholder = p2;
      }), ua(["drop", "take"], function(n3, r3) {
        _2.prototype[n3] = function(t3) {
          t3 = t3 === Wo ? 1 : w2(B2(t3), 0);
          var e3 = this.__filtered__ && !r3 ? new _2(this) : this.clone();
          return e3.__filtered__ ? e3.__takeCount__ = C2(t3, e3.__takeCount__) : e3.__views__.push({ size: C2(t3, Go), type: n3 + (e3.__dir__ < 0 ? "Right" : "") }), e3;
        ...
        t3 = B2(t3);
        var n3 = this;
        return n3.__filtered__ && (0 < t3 || e3 < 0) ? new _2(n3) : (t3 < 0 ? n3 = n3.takeRight(-t3) : t3 && (n3 = n3.drop(t3)), e3 !== Wo ? (e3 = B2(e3)) < 0 ? n3.dropRight(-e3) : n3.take(e3 - t3) : n3);
        ...
        var n3 = H[t3], r3 = /^(?:push|sort|unshift)$/.test(t3) ? "tap" : "thru", i3 = /^(?:pop|shift)$/.test(t3);
      ...
      }), Tt[Bn(Wo, 2).name] = [{ name: "wrapper", func: Wo }], _2.prototype.clone = function() {
...
} }, layerConfig: { fillStyle: "rgba(0, 0, 0, 0.6)" }, cropConfig: { lineDash: [], strokeStyle: "rgba(255, 255, 255, 1)", lineWidth: 2 } }, defaultWH = { width: 0, height: 0 }, defaultPoint = { x: void 0, y: void 0 };
...
function drawDuabPointList(n, r, t, i) {
  let o, a;
  r.forEach((t2, e) => {
    n && (o = r[e - 1] || t2, a = t2, n.beginPath(), n.lineJoin = "round", n.lineCap = "round", n.lineWidth = t2.lineWidth || i.daubConfig.lineWidth, n.strokeStyle = t2.strokeStyle || i.daubConfig.strokeStyle, n.moveTo(o._x || o.x, o._y || o.y), n.lineTo(a._x || a.x, a._y || a.y), n.stroke());
  });
}
...
function drawTagRect(t, e, n, r, i, o, a, u, c, f, l, s, d) {
  let h = lodash.exports.cloneDeep(o.tagConfig);
  if (s && Object.assign(h, s), t.font = h.fontSize + "px sans-serif", u || c) {
    !c || u && "move" === u.type || (t.fillStyle = h.fillStyle, t.fillRect(e, n, r, i), a && h.showText && (o = parseFloat(t.font.split(" ")[0]), t.fillStyle = h.textFillStyle, t.fillText(l || a + "", e + 4, n + i / 2 + o / 2))), f && (t.strokeStyle = h.highlightStrokeStyle, t.lineWidth = h.highlightLineWidth, t.setLineDash(h.highlightLineDash), t.strokeRect(e, n, r, i));
    if (u && pointIsInRect(u, [e, n, r, i])) {
      if ("click" === u.type)
        return { isShow: c = !c, isCrash: true };
      "move" !== u.type || c || (t.strokeStyle = h.hoverStrokeStyle, t.lineWidth = h.hoverLineWidth, t.setLineDash(h.hoverLineDash), t.strokeRect(e, n, r, i));
    }
    h.customDraw(t, { target: d, positions: [e, n, r, i] });
  }
}
function drawTagList(r, t, i, o, a = { offsetX: 0, offsetY: 0 }, u) {
  ...
  return t.forEach((t2) => {
    ...
    var n = drawTagRect(r, ...e, o, (t2.__index || 0) + 1, u, t2.isShow, t2.showOutLine, t2.labelText, t2.tagConfig, t2);
...
function moveResizeBox(t, e, n, r, i, o, a, u, c, f, l) {
  if (e && void 0 !== e.x && n && void 0 !== n.x) {
    ...
    if (e.isStartMove)
      return { offsetX: n, offsetY: o } = e.offsetInfo, e = transfromBoxToRect(getResizeBoundingBoxInfo(r, { offsetX: n / i, offsetY: o / i }, c), i, a), drawCropList(t, f, a, l), "crop" == l.mode && drawCropRect(t, ...e, l, true), drawTagList(t, u, a, l), "tag" == l.mode && drawTagRect(t, ...e, l, (r.__index || 0) + 1, void 0, r.isShow, r.showOutLine, r.labelText, r.tagConfig, void 0), e;
  }
}
...
const _withScopeId = (t) => (pushScopeId("data-v-6b3495a2"), t = t(), popScopeId(), t), _hoisted_1 = ["onTouchmove", "onTouchstart", "onTouchend"], _hoisted_2 = { key: 0, class: "mode-panel" }, _hoisted_3 = { class: "status" }, _hoisted_4 = { class: "text" }, _hoisted_5 = { class: "tip" }, _hoisted_6 = _withScopeId(() => createElementVNode("kbd", null, "Ctrl", -1)), _hoisted_7 = createTextVNode(" + "), _hoisted_8 = _withScopeId(() => createElementVNode("kbd", null, "B", -1)), _hoisted_9 = _withScopeId(() => createElementVNode("span", { style: { "font-size": "14px", "margin-left": "10px" } }, "\u5207\u6362\u6A21\u5F0F", -1)), _sfc_main = defineComponent({ props: { cropConfig: { default: () => DEFAULT_CONFIG.cropConfig }, daubConfig: { default: () => DEFAULT_CONFIG.daubConfig }, layerConfig: { default: () => DEFAULT_CONFIG.layerConfig }, tagConfig: { default: () => DEFAULT_CONFIG.tagConfig }, drawingText: null, isShowTip: { type: Boolean, default: false }, enableScale: { type: Boolean, default: true }, enableMove: { type: Boolean, default: true }, enableDrawCrop: { type: Boolean, default: true }, enableDrawTag: { type: Boolean, default: true }, initScale: { type: Boolean, default: true }, enableInteractiveTagChangeStatus: { type: Boolean, default: true }, enableCropCross: { type: Boolean, default: false }, handleResizeCropCross: { default: "reset" }, enableInteractiveCropDelete: { type: Boolean, default: true }, enableCropResize: { type: Boolean, default: true }, enableTagResize: { type: Boolean, default: false }, enableDrawCropOutOfImg: { type: Boolean, default: true }, enableDrawTagOutOfCrop: { type: Boolean, default: true }, enableDrawTagOutOfImg: { type: Boolean, default: true }, isImgCrop: { type: Boolean, default: false }, isCropSingle: { type: Boolean, default: false }, cropList: { default: () => Array() }, tagList: { default: () => Array() }, daubStack: { default: () => Array() }, mode: { default: "crop" }, mobileOperation: { default: "move" }, src: null, precision: { default: 0 }, splitClickAndDoubleClickEvent: { type: Boolean, default: false }, disableDefaultShortcuts: { default: () => Array() }, customDrawTopCtx: null }, emits: ["update:cropList", "update:daubStack", "cropListChange", "update:tagList", "tagListChange", "update:mode", "update:mobileOperation", "resizeStart", "resizeEnd", "delCrop", "drawCropStart", "drawTagStart", "mouseOverInfo", "onLoadImage"], setup(P, { expose: Y, emit: a }) {
  ...
  const O = { dragCreatRectInterrupt() {
    ...
    var _a, _b;
    if (s && ("drawCrop" == t2 && (u.isCropSingle && !R.isDrawRecting && (S = []), R.isDrawRecting || a("drawCropStart"), R.isDrawRecting = true, I = moveDrawCropRect(s, v, g, C, w, S, y, T.value), drawTagList(s, D, y, T.value), (_a = u.customDrawTopCtx) == null ? void 0 : _a.call(u, s, k)), "drawTag" == t2 && (R.isDrawRecting || a("drawTagStart"), R.isDrawRecting = true, drawCropList(s, S, y, T.value), I = moveDrawTagRect(s, v, g, C, w, D, y, T.value), (_b = u.customDrawTopCtx) == null ? void 0 : _b.call(u, s, k)), "resize" == t2)) {
      let t3 = { crop() {
        var _a2;
        u.enableCropResize && R.resizeHovering && s ? (o = S[R.resizeHovering.index || 0], R.resizeHovering && o && (R.isDrawRecting = true, I = moveResizeBox(s, v, g, o, o.__scale || 1, C, y, D, R.resizeHovering, S.filter((t4, e2) => {
          var _a3;
          return e2 !== ((_a3 = R.resizeHovering) == null ? void 0 : _a3.index);
        }), T.value), (_a2 = u.customDrawTopCtx) == null ? void 0 : _a2.call(u, s, k))) : O.move();
      }, tag() {
        var _a2;
        u.enableTagResize && R.resizeHovering && s ? (o = D[R.resizeHovering.index || 0], R.resizeHovering && o && (R.isDrawRecting = true, I = moveResizeBox(s, v, g, o, o.__scale || 1, C, y, D.filter((t4, e2) => {
          var _a3;
          return e2 !== ((_a3 = R.resizeHovering) == null ? void 0 : _a3.index);
        }), R.resizeHovering, S, T.value), (_a2 = u.customDrawTopCtx) == null ? void 0 : _a2.call(u, s, k))) : O.move();
      }, daub() {
      } };
      t3[u.mode]();
    }
    ...
    R.isScaleing = true, l.translate(w.x, w.y), s.translate(w.x, w.y), w = { x: w.x - (e2.x / (C * t2) - e2.x / C), y: w.y - (e2.y / (C * t2) - e2.y / C) }, l.scale(t2, t2), s.scale(t2, t2), l.translate(-w.x, -w.y), s.translate(-w.x, -w.y), C *= t2, clearCanvas(l), clearCanvas(s), drawImage(l, d, y.x, y.y, p.width * m, p.height * m), E(), W = false, R.isScaleing = false;
  }, move() {
    var _a;
    if (u.enableMove && l && s && d && !R.isScaleing) {
      R.isMoving = true;
      let e2 = moveCanvas(l, s, d, p, m, y, v, g, S, C, D, T.value);
      (_a = u.customDrawTopCtx) == null ? void 0 : _a.call(u, s, (t2) => k(t2).map((t3) => (e2 && (t3[0] += e2.offsetX, t3[1] += e2.offsetY), t3))), e2 && (t = lodash.exports.cloneDeep(y)) && (t.x += e2.offsetX, t.y += e2.offsetY);
    }
  }, hoverRect(t2) {
    s && (W = moveDrawUnshowTagDashRect(s, u.mode, D, C, y, w, t2, S, R.isScaleing, W, T.value), r || (u.enableCropResize && "crop" === u.mode && moveDetectBoxBorderSetCursor(L.value, t2, S, C, y, w, R.isScaleing), u.enableTagResize && "tag" === u.mode && moveDetectBoxBorderSetCursor(L.value, t2, D, C, y, w, R.isScaleing)));
    ...
    var e2, n2;
    g = { x: t2.layerX, y: t2.layerY }, r ? this.onDrawSwitchOnStartDraw() : "daub" === u.mode ? R.isScaleing || (t2 = fixPoint(_, C, w), n2 = { x: (e2 = fixPoint(g, C, w)).x, y: e2.y, lineWidth: u.daubConfig.lineWidth, strokeStyle: u.daubConfig.strokeStyle }, s && (drawDuabPointList(s, [t2, e2], y, T.value), _ = lodash.exports.cloneDeep(g), B[B.length - 1].push(n2))) : R.resizeHovering ? O.dragCreatOrResizeRect("resize") : O.move();
  }, onDoubleClick(e2) {
    if ("crop" === u.mode && u.enableInteractiveCropDelete && gt(pointIsInBoxList(e2, S, m, y).boxList), "tag" === u.mode) {
    ...
    if ("tag" === u.mode && s) {
      ...
      }), u.enableInteractiveTagChangeStatus && (drawCropList(s, S, y, T.value), { isReDraw: e2, redrawList: n2 } = drawTagList(s, D, y, T.value, void 0, e2), e2 && (E(), ot("statusChange", z(n2))));
    }
  }, onWheel(t2, e2, n2) {
    ...
    !async function() {
      if (F(), f = false, l = null, s = null, d = void 0, h = lodash.exports.cloneDeep(defaultWH), p = lodash.exports.cloneDeep(defaultWH), v = lodash.exports.cloneDeep(defaultPoint), g = lodash.exports.cloneDeep(defaultPoint), _ = lodash.exports.cloneDeep(defaultPoint), y = { x: 0, y: 0 }, w = { x: 0, y: 0 }, m = 1, x = void 0, t = void 0, N = 1, b = void 0, C = 1, I = void 0, D = [], S = [], await nextTick(), 1 < u.cropList.length) {
      ...
      return 1 == u.cropList.length && (x = u.cropList[0]), D = lodash.exports.cloneDeep(u.tagList), S = lodash.exports.cloneDeep(u.cropList), B = lodash.exports.cloneDeep(u.daubStack), K(), device.mobile() || (window.addEventListener("keydown", q), window.addEventListener("keyup", Z)), Q(), l = U.value.getContext("2d"), s = $.value.getContext("2d"), l && s ? (h = amendDpi(getElementWH(l.canvas))) ? (initCanvasWH(l, h), initCanvasWH(s, h), a("onLoadImage", { status: "loading" }), loadImage(u.src).then((t2) => {
        if (a("onLoadImage", { status: "success" }), !h || !l || !s)
          return Promise.reject("canvasWH or canvas var not has valid values.");
        if (d = t2, p = { width: d.width, height: d.height }, u.initScale) {
          var e2, n2, r2, i2, o2, t2 = initScale(h, d);
          if (m = N = t2.scale, x)
            return e2 = transfromBoxToRect(x, N, y), n2 = (h.width - 0.05 * h.width) / e2[2], r2 = (h.height - 0.05 * h.height) / e2[3], r2 = h.width / h.height > e2[2] / e2[3] ? r2 : n2, i2 = e2[0] + e2[2], o2 = e2[1] + e2[3], (r2 = r2) == n2 ? (y.x = (h.width - i2 * r2 - 0.05 * h.width / 2) / r2, y.y = ((h.height - e2[3] * r2) / 2 - e2[1] * r2) / r2) : (y.x = ((h.width - e2[2] * r2) / 2 - e2[0] * r2) / r2, y.y = (h.height - o2 * r2 - 0.05 * h.height / 2) / r2), S = initBoundingArrScale(S, m, u.precision), D = initBoundingArrScale(D, m, u.precision), B = initDaubStackList(B, y, m), et({ deltaY: 1, clientX: 0, clientY: 0, preventDefault() {
            }, stopPropagation() {
            }, __zoom: r2 }, true), true;
          "width" === t2.fit ? y.x = (h.width - p.width * m) / 2 : y.y = (h.height - p.height * m) / 2, x = { startX: 0, startY: 0, endX: 0 + p.width, endY: 0 + p.height }, u.isImgCrop && it("add", S = [x]);
        }
        return S = initBoundingArrScale(S, m, u.precision), D = initBoundingArrScale(D, m, u.precision), B = initDaubStackList(B, y, m), drawImage(l, d, y.x, y.y, d.width * m, d.height * m), E(), true;
      }).catch((t2) => {
    ...
    requestAnimationFrame(() => {
      !async function() {
        if (J(), await nextTick(), K(), l && s && d) {
          if (!(h = amendDpi(getElementWH(l.canvas))))
            return Promise.reject("Error: can't get canvas height and width.");
          initCanvasWH(l, h), initCanvasWH(s, h), l.scale(C, C), s.scale(C, C), l.translate(-w.x, -w.y), s.translate(-w.x, -w.y), drawImage(l, d, y.x, y.y, d.width * m, d.height * m), S = initBoundingArrScale(S, m, u.precision), D = initBoundingArrScale(D, m, u.precision), E(), f = true;
        }
      }();
    });
  } };
  ...
  function J() {
    o = null, f = false, h = lodash.exports.cloneDeep(defaultWH), v = lodash.exports.cloneDeep(defaultPoint), g = lodash.exports.cloneDeep(defaultPoint), _ = lodash.exports.cloneDeep(defaultPoint), b = void 0;
  }
  function k(t2) {
  ...
  function E() {
    var _a;
    s && (drawCropList(s, S, y, T.value), drawTagList(s, D, y, T.value), B.forEach((t2) => {
      s && drawDuabPointList(s, t2, y, T.value);
  ...
  function et(t2, e2) {
    ...
    !f && !t2.__zoom || R.isDrawRecting || R.isMoving || (n2 = e2 ? 0 : (t2.clientX - b.left) * DPI, r2 = e2 ? 0 : (t2.clientY - b.top) * DPI, i2 = t2.deltaY < 0 ? 1 : -1, t2 = e2 ? t2.__zoom : Math.exp(i2 * M), C * t2 < 0.2 || G.onWheel(t2, { x: n2, y: r2 }, e2));
  }
  function nt(e2) {
    if (R.resizeHovering) {
      var n2;
      let t2 = { crop: { boxList: S, trigger: it, getBoxFunc: A }, tag: { boxList: D, trigger: ot, getBoxFunc: z }, daub: { boxList: [], trigger: () => {
      }, getBoxFunc: () => [] } }[u.mode];
  ...
  function rt() {
    if (f) {
      if (R.isMoving = false, t && (y = lodash.exports.cloneDeep(t)), t = void 0, R.isMouseUpDownPoints()) {
        let t2 = { crop() {
          if (I) {
            let t3 = { ...o, ...transfromRect2Box(I, y, m) };
            o = null, R.resizeHovering ? !u.enableCropCross && getBoxIsIntersectWithBoxList(t3, S.filter((t4, e2) => {
              var _a;
              return e2 !== ((_a = R.resizeHovering) == null ? void 0 : _a.index);
            })) ? ("reset" === u.handleResizeCropCross && E(), "delete" === u.handleResizeCropCross && gt([S[R.resizeHovering.index]])) : nt(t3) : (t3 = initBoundingArrScale([t3], m, u.precision)[0], !u.enableCropCross && getBoxIsIntersectWithBoxList(t3, S) ? E() : (S.push(t3), it("add", A([t3])))), I = void 0;
          }
        }, tag() {
          var t3, e2;
          I && (t3 = { ...o, ...transfromRect2Box(I, y, m) }, o = null, R.resizeHovering ? nt(t3) : (t3 = getVertexPositionByTwoPoints(v, g), e2 = initBoundingArrScale([e2 = transfromRect2Box(I, y, m)], m, u.precision)[0], Object.assign(e2, { isShow: true, __oprateType: "add", __vertexPosition: t3 }), D.push(e2), ot("add", z([e2]))), I = void 0);
        }, daub() {
          I = I && void 0;
  ...
  function at(t2) {
    var e2;
    f && l && s && (e2 = new Date().getTime(), n = e2, c.prev.down ? c.last.down = e2 : c.prev.down = e2, e2 = amendDpi(e2 = { layerX: Reflect.get(t2, "layerX"), layerY: Reflect.get(t2, "layerY") }, ["layerX", "layerY"]), v = { x: e2.layerX, y: e2.layerY }, _ = lodash.exports.cloneDeep(v), "daub" == u.mode && B.push([]), "crop" === u.mode && !r && u.enableCropResize && (t2 = detectEventIsTriggerOnBoxBorderOrVertex(e2, S, C, y, w)).hasIn && (R.resizeHovering = findOneBorderOrVertex(t2.list), a("resizeStart", { index: R.resizeHovering.index, box: S[R.resizeHovering.index] })), "tag" === u.mode && !r && u.enableTagResize && (t2 = detectEventIsTriggerOnBoxBorderOrVertex(e2, D, C, y, w)).hasIn && (R.resizeHovering = findOneBorderOrVertex(t2.list), a("resizeStart", { index: R.resizeHovering.index, box: D[R.resizeHovering.index] })));
  }
  onBeforeUnmount(() => {
    ...
    f && (D = initBoundingArrScale(t2, m, u.precision), E());
  }, { deep: true }), watch(() => u.daubStack, (t2) => {
    f && (B = initDaubStackList(lodash.exports.cloneDeep(u.daubStack), y, m), E());
  }, { deep: true }), watch(() => u.cropList, (t2) => {
    f && (S = initBoundingArrScale(t2, m, u.precision), E());
  });
  ...
  function ct(t2) {
    f && (t2 = amendDpi(t2 = { layerX: Reflect.get(t2, "layerX"), layerY: Reflect.get(t2, "layerY") }, ["layerX", "layerY"]), i = new Date().getTime(), G.onMouseOverMove(t2), ut(t2));
  }
  function ft() {
    var t2;
    f && (t2 = new Date().getTime(), c.prev.up ? c.last.up = t2 : c.prev.up = t2, rt());
  }
  function lt() {
    f && (L.value.style.cursor = "auto", rt(), ut());
  }
  function st() {
  ...
  function dt(e2) {
    if (K(), f) {
      ...
      var e2 = i && n ? i - n : 0;
      n = void 0, i = void 0, 100 < e2 || (u.splitClickAndDoubleClickEvent ? (st(), j = setTimeout(() => {
        G.onCick(t2), j = null;
      }, 230)) : G.onCick(t2), e2 = u.splitClickAndDoubleClickEvent ? 320 : 360, c.prev.up && c.prev.down && c.last.up && c.last.down && (c.last.up - c.prev.down < e2 ? (u.splitClickAndDoubleClickEvent && st(), G.onDoubleClick(t2), c.prev.down = void 0, c.prev.up = void 0) : (c.prev.down = c.last.down, c.prev.up = c.last.up), c.last.down = void 0, c.last.up = void 0));
    }
  }
  function ht(t2) {
  ...
  function gt(r2) {
    if (0 !== r2.length) {
      ...
      }), S = initBoundingArrScale(t2, m, u.precision), a("delCrop", n2), E(), it("delete", A(n2));
    }
  }
  return Y({ render: E, removeTagItems: function(n2) {
    ...
    D = initBoundingArrScale(r2, m, u.precision), E(), ot("delete", i2);
