...
!function(R, L) {
  !function() {
    ...
    function Qu(t2) {
      return t2 && t2.slice(0, sc(t2) + 1).replace(iu, "");
    }
    function da(e2) {
      return function(t2) {
        return e2(t2);
    ...
    var _a = function i2(t2) {
      ...
      function m2(n3, r3, i3, t3, e3, o3) {
        ...
        if (t3) {
          ...
          var l3 = P(n3), d3 = l3 == Ta || l3 == Da;
          if (wi(n3))
            return sn(n3, u3);
          if (l3 == ta || l3 == Go || d3 && !e3) {
      ...
      function re(t3, e3, n3, r3) {
        ...
        t:
          for (; ++i3 < u3; ) {
            var s3 = t3[i3], l3 = null == n3 ? s3 : n3(s3), s3 = r3 || 0 !== s3 ? s3 : 0;
            if (a3 && l3 == l3) {
              for (var d3 = f3; d3--; )
                if (e3[d3] === l3)
                  continue t;
      ...
      function c2(t3, e3, n3, r3, i3) {
        ...
        for (n3 = n3 || rr, i3 = i3 || []; ++o3 < a3; ) {
          var u3 = t3[o3];
          0 < e3 && n3(u3) ? 1 < e3 ? c2(u3, e3 - 1, n3, r3, i3) : sa(i3, u3) : r3 || (i3[i3.length] = u3);
        }
        return i3;
      }
      ...
      function we(t3, e3, n3) {
        for (var r3 = n3 ? Mu : Xu, i3 = t3[0].length, o3 = t3.length, a3 = o3, u3 = b2(o3), c3 = 1 / 0, f3 = []; a3--; ) {
          var s3 = t3[a3];
          a3 && e3 && (s3 = fa(s3, da(e3))), c3 = C2(s3.length, c3), u3[a3] = !n3 && (e3 || 120 <= i3 && 120 <= s3.length) ? new Ht(a3 && s3) : Wo;
        }
        var s3 = t3[0], l3 = -1, d3 = u3[0];
        t:
          for (; ++l3 < i3 && f3.length < c3; ) {
      ...
      function be(t3, e3, n3, r3, i3) {
        {
          ...
          if (null == t3 || null == e3 || !W(t3) && !W(e3))
            return t3 != t3 && e3 != e3;
          var o3 = be, a3 = M(t3), u3 = M(e3), c3 = a3 ? Ia : P(t3), u3 = u3 ? Ia : P(e3), f3 = (c3 = c3 == Go ? ta : c3) == ta, s3 = (u3 = u3 == Go ? ta : u3) == ta, u3;
          if ((u3 = c3 == u3) && wi(t3)) {
            if (!wi(e3))
              return false;
            f3 = !(a3 = true);
          ...
          if (!(1 & n3)) {
            ...
            if (a3 || c3)
              return f3 = a3 ? t3.value() : t3, s3 = c3 ? e3.value() : e3, i3 = i3 || new j(), o3(f3, s3, n3, r3, i3);
          }
          if (u3) {
            i3 = i3 || new j();
      ...
      function Ce(t3, e3, n3, r3) {
        ...
        for (; ++i3 < o3; ) {
          var c3 = (u3 = n3[i3])[0], f3 = t3[c3], s3 = u3[1];
          if (a3 && u3[2]) {
            if (f3 === Wo && !(c3 in t3))
              return false;
          } else {
            var l3, d3 = new j();
            if (!((l3 = r3 ? r3(f3, s3, c3, t3, e3, d3) : l3) === Wo ? be(s3, f3, 3, r3, d3) : l3))
              return false;
          }
        }
        return true;
      ...
      function Re(t3, r3) {
        var i3 = -1, o3 = s2(t3) ? b2(t3.length) : [];
        return ie(t3, function(t4, e3, n3) {
          o3[++i3] = r3(t4, e3, n3);
        }), o3;
      }
      ...
      function Oe(n3, r3) {
        return or(n3) && fr(r3) ? sr(br(n3), r3) : function(t3) {
          var e3 = Vi(t3, n3);
      ...
      function ze(t3, r3, s3) {
        ...
        var e3 = Re(t3, function(e4, t4, n4) {
          ...
          for (var n4 = s3, r4 = -1, i4 = t4.criteria, o3 = e4.criteria, a3 = i4.length, u3 = n4.length; ++r4 < a3; ) {
      ...
      function Ye(t3, e3, n3, r3) {
        var i3 = r3 ? Uu : la, o3 = -1, a3 = e3.length, u3 = t3;
        for (t3 === e3 && (e3 = I2(e3)), n3 && (u3 = fa(t3, da(n3))); ++o3 < a3; )
          for (var c3 = 0, f3 = e3[o3], s3 = n3 ? n3(f3) : f3; -1 < (c3 = i3(u3, s3, c3, r3)); )
      ...
      function He(t3, e3, n3, r3) {
        ...
        for (var i3 = -1, o3 = (e3 = an(e3, t3)).length, a3 = o3 - 1, u3 = t3; null != u3 && ++i3 < o3; ) {
          var c3, f3 = br(e3[i3]), s3 = n3;
          if ("__proto__" === f3 || "constructor" === f3 || "prototype" === f3)
            return t3;
          i3 != a3 && (c3 = u3[f3], (s3 = r3 ? r3(c3, f3, u3) : Wo) === Wo && (s3 = B2(c3) ? c3 : ir(e3[i3 + 1]) ? [] : {})), qt(u3, f3, s3), u3 = u3[f3];
        }
        return t3;
      }
      ...
      function $e(t3, e3, n3, r3) {
        ...
        for (var a3 = (e3 = n3(e3)) != e3, u3 = null === e3, c3 = T2(e3), f3 = e3 === Wo; i3 < o3; ) {
          var s3 = pt((i3 + o3) / 2), l3 = n3(t3[s3]), d3 = l3 !== Wo, h3 = null === l3, p3 = l3 == l3, v3 = T2(l3), p3 = a3 ? r3 || p3 : f3 ? p3 && (r3 || d3) : u3 ? p3 && d3 && (r3 || !h3) : c3 ? p3 && d3 && !h3 && (r3 || !v3) : !h3 && !v3 && (r3 ? l3 <= e3 : l3 < e3);
          p3 ? i3 = s3 + 1 : o3 = s3;
        }
        ...
        t:
          for (; ++r3 < o3; ) {
            ...
            if (a3 && l3 == l3) {
              ...
              i3(c3, l3, n3) || (c3 !== u3 && c3.push(l3), u3.push(s3));
          }
        return u3;
      }
      function Ke(t3, e3) {
      ...
      function pn(t3, e3, n3, r3) {
        for (var i3 = -1, o3 = t3.length, a3 = n3.length, u3 = -1, c3 = e3.length, f3 = w2(o3 - a3, 0), s3 = b2(c3 + f3), l3 = !r3; ++u3 < c3; )
          s3[u3] = e3[u3];
        for (; ++i3 < a3; )
          (l3 || i3 < o3) && (s3[n3[i3]] = t3[i3]);
        for (; f3--; )
          s3[u3++] = t3[i3++];
        return s3;
      }
      function vn(t3, e3, n3, r3) {
        for (var i3 = -1, o3 = t3.length, a3 = -1, u3 = n3.length, c3 = -1, f3 = e3.length, s3 = w2(o3 - u3, 0), l3 = b2(s3 + f3), d3 = !r3; ++i3 < s3; )
          l3[i3] = t3[i3];
        for (var h3 = i3; ++c3 < f3; )
          l3[h3 + c3] = e3[c3];
        for (; ++a3 < u3; )
          (d3 || i3 < o3) && (l3[h3 + n3[a3]] = t3[i3++]);
        return l3;
      }
      function I2(t3, e3) {
      ...
      function Bn(o3) {
        return function(t3, e3, n3) {
          var r3, i3 = v2(t3), e3 = (s2(t3) || (r3 = l2(e3, 3), t3 = R2(t3), e3 = function(t4) {
        ...
        return function t3() {
          ...
          if (w3 && (i3 = function(t4, e4) {
            for (var n4 = t4.length, r4 = 0; n4--; )
              t4[n4] === e4 && ++r4;
            return r4;
          }(e3, r3 = Gn(t3))), f3 && (e3 = pn(e3, f3, s3, w3)), l3 && (e3 = vn(e3, l3, d3, w3)), o3 -= i3, w3 && o3 < v3)
      ...
      function Sn(n3, a3) {
        return function(t3, e3) {
          return t3 = t3, r3 = n3, i3 = a3(e3), o3 = {}, le(t3, function(t4, e4, n4) {
            r3(o3, i3(t4), e4, n4);
          }), o3;
          var r3, i3, o3;
        };
      ...
      function kn(u3, t3, c3, f3) {
        ...
        return function t4() {
          for (var e3 = -1, n3 = arguments.length, r3 = -1, i3 = f3.length, o3 = b2(i3 + n3), a3 = this && this !== oa && this instanceof t4 ? l3 : u3; ++r3 < i3; )
            o3[r3] = f3[r3];
          for (; n3--; )
            o3[r3++] = arguments[++e3];
          return aa(a3, s3 ? c3 : this, o3);
        };
      }
      function En(f3) {
        return function(t3, e3, n3) {
      ...
      function An(t3, e3, n3, r3, i3, o3, a3, u3, c3, f3) {
        var s3 = 8 & e3, i3 = (4 & (e3 = (e3 | (s3 ? Fo : Vo)) & ~(s3 ? Vo : Fo)) || (e3 &= -4), [t3, e3, i3, s3 ? o3 : Wo, s3 ? a3 : Wo, s3 ? Wo : o3, s3 ? Wo : a3, u3, c3, f3]), o3 = n3.apply(Wo, i3);
      ...
      function Xn(t3, e3, n3, r3, i3, o3, a3, u3) {
        ...
        if (!c3 && "function" != typeof t3)
          throw new y2(Ho);
        var f3, s3, l3, d3, h3, p3 = r3 ? r3.length : 0, v3 = (p3 || (e3 &= -97, r3 = i3 = Wo), a3 = a3 === Wo ? a3 : w2(D2(a3), 0), u3 = u3 === Wo ? u3 : D2(u3), p3 -= i3 ? i3.length : 0, e3 & Vo && (g3 = r3, f3 = i3, r3 = i3 = Wo), c3 ? Wo : $n(t3)), g3 = [t3, e3, n3, r3, i3, g3, f3, o3, a3, u3];
        return v3 && function(t4, e4) {
          ...
          null == t4[9] && (t4[9] = e4[9]);
          t4[0] = e4[0], t4[1] = i4;
        }(g3, v3), t3 = g3[0], e3 = g3[1], n3 = g3[2], r3 = g3[3], i3 = g3[4], !(u3 = g3[9] = g3[9] === Wo ? c3 ? 0 : t3.length : w2(g3[9] - p3, 0)) && 24 & e3 && (e3 &= -25), f3 = e3 && 1 != e3 ? 8 == e3 || e3 == ma ? In(t3, e3, u3) : e3 != Fo && 33 != e3 || i3.length ? Dn.apply(Wo, g3) : kn(t3, e3, n3, r3) : (l3 = n3, d3 = 1 & e3, h3 = Cn(s3 = t3), function t4() {
          return (this && this !== oa && this instanceof t4 ? h3 : s3).apply(d3 ? l3 : this, arguments);
      ...
      function Fn(t3, e3, n3, r3, i3, o3) {
        ...
        if (c3 && f3)
          return c3 == e3 && f3 == t3;
        var s3 = -1, l3 = true, d3 = 2 & n3 ? new Ht() : Wo;
        for (o3.set(t3, e3), o3.set(e3, t3); ++s3 < u3; ) {
          var h3, p3 = t3[s3], v3 = e3[s3];
          if ((h3 = r3 ? a3 ? r3(v3, p3, s3, e3, t3, o3) : r3(p3, v3, s3, t3, e3, o3) : h3) !== Wo) {
            if (h3)
              continue;
            l3 = false;
            break;
        ...
        return o3.delete(t3), o3.delete(e3), l3;
      }
      function Vn(t3) {
        return gr(lr(t3, Wo, Dr), t3 + "");
      }
      function Nn(t3) {
        return ve(t3, R2, Qn);
      }
      ...
      function d2(t3, e3, n3) {
        var r3;
        if (B2(n3))
          return r3 = typeof e3, ("number" == r3 ? s2(n3) && ir(e3, n3.length) : "string" == r3 && e3 in n3) && X(n3[e3], t3);
      }
      function or(t3, e3) {
        var n3;
        if (!M(t3))
      ...
      o2 = a2(function(t3, e3) {
        ...
        var n3 = r2(e3);
        return x2(n3) && (n3 = Wo), x2(t3) ? re(t3, c2(e3, 1, x2, true), l2(n3, 2)) : [];
      ...
      function Tr(t3, e3, n3) {
        ...
        if (!r3)
          return -1;
        var i3 = r3 - 1;
        return n3 !== Wo && (i3 = D2(n3), i3 = n3 < 0 ? w2(r3 + i3, 0) : C2(i3, r3 - 1)), Nu(t3, l2(e3, 3), i3, true);
      }
      function Dr(t3) {
      ...
      U = a2(function(t3) {
        ...
        return e3 === r2(n3) ? e3 = Wo : n3.pop(), n3.length && n3[0] === t3[0] ? we(n3, l2(e3, 2)) : [];
      }), e2 = a2(function(t3) {
        var e3 = r2(t3), n3 = fa(t3, rn);
      ...
      var kr = a2(function(t3) {
        ...
        var e3 = r2(t3);
        return x2(e3) && (e3 = Wo), Ze(c2(t3, 1, x2, true), l2(e3, 2));
      }), zr = a2(function(t3) {
      ...
      var jr = a2(function(t3, e3) {
        ...
        var e3 = r2(t3);
        return x2(e3) && (e3 = Wo), en(ca(t3, x2), l2(e3, 2));
      }), Mr = a2(function(t3) {
        var e3 = "function" == typeof (e3 = r2(t3)) ? e3 : Wo;
      ...
      function Gr(t3, e3) {
        return (M(t3) ? ua : ie)(t3, l2(e3, 3));
      }
      function Zr(t3, e3) {
        return (M(t3) ? ju : oe)(t3, l2(e3, 3));
      }
      var Kr = _n(function(t3, e3, n3) {
        Y.call(t3, n3) ? t3[n3].push(e3) : Jt(t3, n3, [e3]);
      });
      var Jr = a2(function(t3, e3, n3) {
        var r3 = -1, i3 = "function" == typeof e3, o3 = s2(t3) ? b2(t3.length) : [];
      ...
      function ci(r3, n3, t3) {
        var i3, o3, a3, u3, c3, f3, s3 = 0, l3 = false, d3 = false, e3 = true;
        if ("function" != typeof r3)
          throw new y2(Ho);
        function h3(t4) {
          var e4 = i3, n4 = o3;
          return i3 = o3 = Wo, s3 = t4, u3 = r3.apply(n4, e4);
        }
        function p3(t4) {
          var e4 = t4 - f3;
          return f3 === Wo || n3 <= e4 || e4 < 0 || d3 && a3 <= t4 - s3;
        }
        function v3() {
          var t4, e4 = ri();
          if (p3(e4))
        ...
        return n3 = S2(n3) || 0, B2(t3) && (l3 = !!t3.leading, d3 = "maxWait" in t3, a3 = d3 ? w2(S2(t3.maxWait) || 0, n3) : a3, e3 = "trailing" in t3 ? !!t3.trailing : e3), _3.cancel = function() {
          c3 !== Wo && fn(c3), s3 = 0, i3 = f3 = o3 = c3 = Wo;
        }, _3.flush = function() {
      ...
      function si(r3, i3) {
        ...
        return o3.cache = new (si.Cache || Wt)(), o3;
      }
      function li(e3) {
        if ("function" != typeof e3)
          throw new y2(Ho);
      ...
      var un = un(function(r3, i3) {
        var o3 = (i3 = 1 == i3.length && M(i3[0]) ? fa(i3[0], da(l2())) : fa(c2(i3, 1), da(l2()))).length;
      ...
      var Hi = a2(function(t3, e3) {
        ...
        for (i3 && d2(e3[0], e3[1], i3) && (r3 = 1); ++n3 < r3; )
          for (var o3 = e3[n3], a3 = L2(o3), u3 = -1, c3 = a3.length; ++u3 < c3; ) {
            ...
            (s3 === Wo || X(s3, N[f3]) && !Y.call(t3, f3)) && (t3[f3] = o3[f3]);
          }
        return t3;
      }), Fi = a2(function(t3) {
      ...
      function Co(r3, e3, t3) {
        ...
        return ua(i3, function(t4) {
          ...
          r3[t4] = n4, a3 && (r3.prototype[t4] = function() {
            ...
            return o3 || e4 ? (((t5 = r3(this.__wrapped__)).__actions__ = I2(this.__actions__)).push({ func: n4, args: arguments, thisArg: r3 }), t5.__chain__ = e4, t5) : n4.apply(r3, sa([this.value()], arguments));
          });
        }), r3;
      }
      function Io() {
      ...
      return p2.after = function(t3, e3) {
        ...
        var i3 = null == r3 ? 0 : r3.length, e3 = l2();
        ...
        return e3.placeholder = t3.placeholder, e3;
      }, p2.debounce = ci, p2.defaults = Hi, p2.defaultsDeep = Fi, p2.defer = lt, p2.delay = fi, p2.difference = o2, p2.differenceBy = It, p2.differenceWith = t2, p2.drop = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
      ...
      }, p2.memoize = si, p2.merge = Gi, p2.mergeWith = Zi, p2.method = xo, p2.methodOf = bo, p2.mixin = Co, p2.negate = li, p2.nthArg = function(e3) {
        return e3 = D2(e3), a2(function(t3) {
          return Ee(t3, e3);
        });
      }, p2.omit = Ki, p2.omitBy = function(t3, e3) {
        return Qi(t3, li(l2(e3)));
      }, p2.once = function(t3) {
        return oi(2, t3);
        ...
        return (M(t3) ? ca : ce)(t3, li(l2(e3, 3)));
      }, p2.remove = function(t3, e3) {
        var n3 = [];
        if (!t3 || !t3.length)
          return n3;
        var r3 = -1, i3 = [], o3 = t3.length;
        for (e3 = l2(e3, 3); ++r3 < o3; ) {
          var a3 = t3[r3];
        ...
        return r3 = l2(r3, 4), null == i3 && (e3 = t3 && t3.constructor, i3 = o3 ? n3 ? new e3() : [] : B2(t3) && xi(e3) ? Yt(nt(t3)) : {}), (o3 ? ua : le)(t3, function(t4, e4, n4) {
        ...
        return (M(t3) ? Pu : ae)(t3, l2(e3 = n3 && d2(t3, e3, n3) ? Wo : e3, 3));
        ...
        return t3 = s2(t3) ? t3 : no(t3), n3 = n3 && !r3 ? D2(n3) : 0, r3 = t3.length, n3 < 0 && (n3 = w2(r3 + n3, 0)), Ri(t3) ? n3 <= r3 && -1 < t3.indexOf(e3, n3) : !!r3 && -1 < la(t3, e3, n3);
      ...
      }, p2.invoke = qi, p2.isArguments = _i, p2.isArray = M, p2.isArrayBuffer = yi, p2.isArrayLike = s2, p2.isArrayLikeObject = x2, p2.isBoolean = function(t3) {
        ...
        if (null == t3)
          return true;
        if (s2(t3) && (M(t3) || "string" == typeof t3 || "function" == typeof t3.splice || wi(t3) || Li(t3) || _i(t3)))
          return !t3.length;
        var e3, n3 = P(t3);
        if (n3 == Jo || n3 == ea)
          return !t3.size;
        ...
        return t3 && t3.length ? ue(t3, l2(e3, 2), ge) : Wo;
      }, p2.mean = function(t3) {
        return qu(t3, O);
        ...
        return t3 && t3.length ? ue(t3, l2(e3, 2), Se) : Wo;
        ...
        return (M(t3) ? Fu : Ne)(t3, l2(e3 = n3 && d2(t3, e3, n3) ? Wo : e3, 3));
        ...
        return -1;
      }, p2.startCase = so, p2.startsWith = function(t3, e3, n3) {
        ...
        var r3 = R2(e3 = Xi({}, t3.imports, n3.imports, Mn)), i3 = tc(e3, r3), f3 = 0, n3 = t3.interpolate || wu, s3 = "__p += '", e3 = A((t3.escape || wu).source + "|" + n3.source + "|" + (n3 === Ja ? lu : wu).source + "|" + (t3.evaluate || wu).source + "|$", "g"), o3 = "//# sourceURL=" + (Y.call(t3, "sourceURL") ? (t3.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Tu + "]") + "\n";
        if (a3.replace(e3, function(t4, e4, n4, r4, i4, o4) {
          return n4 = n4 || r4, s3 += a3.slice(f3, o4).replace(mu, ac), e4 && (u3 = true, s3 += "' +\n__e(" + e4 + ") +\n'"), i4 && (c3 = true, s3 += "';\n" + i4 + ";\n__p += '"), n4 && (s3 += "' +\n((__t = (" + n4 + ")) == null ? '' : __t) +\n'"), f3 = o4 + t4.length, t4;
        ...
        if (s3 = (c3 ? s3.replace(Fa, "") : s3).replace(Va, "$1").replace(Na, "$1;"), s3 = "function(" + (n3 || "obj") + ") {\n" + (n3 ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (u3 ? ", __e = _.escape" : "") + (c3 ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + s3 + "return __p\n}", (e3 = vo(function() {
          return E(r3, o3 + "return " + s3).apply(Wo, i3);
        })).source = s3, mi(e3))
          throw e3;
        return e3;
        ...
        if ((t3 = D2(t3)) < 1 || $o < t3)
          return [];
        for (var n3 = qo, r3 = C2(t3, qo), r3 = (e3 = l2(e3), t3 -= qo, Ju(r3, e3)); ++n3 < t3; )
          e3(n3);
        return r3;
        ...
        return (t3 = h2(t3)) && (n3 || e3 === Wo) ? t3.slice(0, sc(t3) + 1) : t3 && (e3 = f2(e3)) ? cn(n3 = ga(t3), 0, rc(n3, ga(e3)) + 1).join("") : t3;
        ...
        var e3 = ++q;
        return h2(t3) + e3;
      }, p2.upperCase = lo, p2.upperFirst = ho, p2.each = Gr, p2.eachRight = Zr, p2.first = Sr, Co(p2, (jo = {}, le(p2, function(t3, e3) {
        ...
        d3 && (p2.prototype[t3] = function() {
          ...
          var e3, n3 = this.__wrapped__, r3 = l3 ? [1] : arguments, i3 = n3 instanceof _2, o3 = r3[0], a3 = i3 || M(n3), u3 = (a3 && s3 && "function" == typeof o3 && 1 != o3.length && (i3 = a3 = false), this.__chain__), o3 = !!this.__actions__.length, c3 = h3 && !u3, i3 = i3 && !o3;
          return !h3 && a3 ? (n3 = i3 ? n3 : new _2(this), (e3 = f3.apply(n3, r3)).__actions__.push({ func: Vr, args: [t4], thisArg: Wo }), new g2(e3, u3)) : c3 && i3 ? f3.apply(this, r3) : (e3 = this.thru(t4), c3 ? l3 ? e3.value()[0] : e3.value() : e3);
        });
        ...
        }(0, i3, this.__views__), a3 = o3.start, u3 = (o3 = o3.end) - a3, c3 = r3 ? o3 : a3 - 1, f3 = this.__iteratees__, s3 = f3.length, l3 = 0, d3 = C2(u3, this.__takeCount__);
...
function drawTagRect(t, e, n, r, i, o, a, u, c, f, s, l, d) {
  let h = lodash.exports.cloneDeep(o.tagConfig);
  if (l && Object.assign(h, l), t.font = h.fontSize + "px sans-serif", u || c) {
    !c || u && "move" === u.type || (t.fillStyle = h.fillStyle, t.fillRect(e, n, r, i), a && h.showText && (o = parseFloat(t.font.split(" ")[0]), t.fillStyle = h.textFillStyle, t.fillText(s || a + "", e + 4, n + i / 2 + o / 2))), f && (t.strokeStyle = h.highlightStrokeStyle, t.lineWidth = h.highlightLineWidth, t.setLineDash(h.highlightLineDash), t.strokeRect(e, n, r, i));
...
function moveCanvas(t, e, n, r, i, o, a, u, c, f, s, l) {
  if (void 0 !== a.x && void 0 !== u.x) {
    a = getTwoPointsOffsetInfo(a, u, f);
    if (a.isStartMove)
      return { offsetX: u, offsetY: f } = a.offsetInfo, clearCanvas(t), drawImage(t, n, (t = { x: o.x + u, y: o.y + f }).x, t.y, r.width * i, r.height * i), drawCropList(e, c, o, l, a.offsetInfo), drawTagList(e, s, o, l, { offsetX: u, offsetY: f }), { offsetX: u, offsetY: f };
  }
}
...
function moveDrawUnshowTagDashRect(e, t, o, a, u, c, f, s, n, l, d) {
  if ("tag" === t && !n) {
    ...
    }), n2 ? (l = true, drawTagList(e, i, u, d, void 0, r)) : l && (drawCropList(e, s, u, d), drawTagList(e, o, u, d), l = false);
  }
  return l;
}
...
function moveResizeBox(t, e, n, r, i, o, a, u, c, f, s) {
  if (e && void 0 !== e.x && n && void 0 !== n.x) {
    var e = getTwoPointsOffsetInfo(e, n, o);
    if (e.isStartMove)
      return { offsetX: n, offsetY: o } = e.offsetInfo, e = transfromBoxToRect(getResizeBoundingBoxInfo(r, { offsetX: n / i, offsetY: o / i }, c), i, a), drawCropList(t, f, a, s), "crop" == s.mode && drawCropRect(t, ...e, s, true), drawTagList(t, u, a, s), "tag" == s.mode && drawTagRect(t, ...e, s, (r.__index || 0) + 1, void 0, r.isShow, r.showOutLine, r.labelText, r.tagConfig, void 0), e;
  }
}
...
const _withScopeId = (t) => (pushScopeId("data-v-25723eab"), t = t(), popScopeId(), t), _hoisted_1 = ["onTouchmove", "onTouchstart", "onTouchend"], _hoisted_2 = { key: 0, class: "mode-panel" }, _hoisted_3 = { class: "status" }, _hoisted_4 = { class: "text" }, _hoisted_5 = { class: "tip" }, _hoisted_6 = _withScopeId(() => createElementVNode("kbd", null, "Ctrl", -1)), _hoisted_7 = createTextVNode(" + "), _hoisted_8 = _withScopeId(() => createElementVNode("kbd", null, "B", -1)), _hoisted_9 = _withScopeId(() => createElementVNode("span", { style: { "font-size": "14px", "margin-left": "10px" } }, "\u5207\u6362\u6A21\u5F0F", -1)), _sfc_main = defineComponent({ props: { cropConfig: { default: () => DEFAULT_CONFIG.cropConfig }, layerConfig: { default: () => DEFAULT_CONFIG.layerConfig }, tagConfig: { default: () => DEFAULT_CONFIG.tagConfig }, drawingText: null, isShowTip: { type: Boolean, default: false }, enableScale: { type: Boolean, default: true }, enableMove: { type: Boolean, default: true }, enableDrawCrop: { type: Boolean, default: true }, enableDrawTag: { type: Boolean, default: true }, initScale: { type: Boolean, default: true }, enableInteractiveTagChangeStatus: { type: Boolean, default: true }, enableCropCross: { type: Boolean, default: false }, handleResizeCropCross: { default: "reset" }, enableInteractiveCropDelete: { type: Boolean, default: true }, enableCropResize: { type: Boolean, default: true }, enableTagResize: { type: Boolean, default: false }, enableDrawCropOutOfImg: { type: Boolean, default: true }, enableDrawTagOutOfCrop: { type: Boolean, default: true }, enableDrawTagOutOfImg: { type: Boolean, default: true }, isImgCrop: { type: Boolean, default: false }, isCropSingle: { type: Boolean, default: false }, cropList: { default: () => Array() }, tagList: { default: () => Array() }, mode: { default: "crop" }, mobileOperation: { default: "move" }, src: null, precision: { default: 0 }, splitClickAndDoubleClickEvent: { type: Boolean, default: false }, disableDefaultShortcuts: { default: () => Array() }, customDrawTopCtx: null }, emits: ["update:cropList", "cropListChange", "update:tagList", "tagListChange", "update:mode", "update:mobileOperation", "resizeStart", "resizeEnd", "delCrop", "drawCropStart", "drawTagStart", "mouseOverInfo", "onLoadImage"], setup(j, { expose: t, emit: a }) {
  ...
  const O = { dragCreatRectInterrupt() {
    ...
    if (u.enableMove && l && d && h && !L.isScaleing) {
      ...
      (_a = u.customDrawTopCtx) == null ? void 0 : _a.call(u, d, (t2) => E(t2).map((t3) => (e2 && (t3[0] += e2.offsetX, t3[1] += e2.offsetY), t3))), e2 && (b = lodash.exports.cloneDeep(y)) && (b.x += e2.offsetX, b.y += e2.offsetY);
    }
  }, hoverRect(t2) {
    ...
    !async function() {
      ...
      return 1 == u.cropList.length && (x = u.cropList[0]), T = lodash.exports.cloneDeep(u.tagList), D = lodash.exports.cloneDeep(u.cropList), G(), device.mobile() || (window.addEventListener("keydown", $), window.addEventListener("keyup", q)), K(), l = N.value.getContext("2d"), d = U.value.getContext("2d"), l && d ? (p = amendDpi(getElementWH(l.canvas))) ? (initCanvasWH(l, p), initCanvasWH(d, p), a("onLoadImage", { status: "loading" }), loadImage(u.src).then((t2) => {
        if (a("onLoadImage", { status: "success" }), !p || !l || !d)
          return Promise.reject("canvasWH or canvas var not has valid values.");
        if (h = t2, v = { width: h.width, height: h.height }, u.initScale) {
          var e2, n2, r2, i2, o2, t2 = initScale(p, h);
          if (m = V = t2.scale, x)
            return e2 = transfromBoxToRect(x, V, y), n2 = (p.width - 0.05 * p.width) / e2[2], r2 = (p.height - 0.05 * p.height) / e2[3], r2 = p.width / p.height > e2[2] / e2[3] ? r2 : n2, i2 = e2[0] + e2[2], o2 = e2[1] + e2[3], (r2 = r2) == n2 ? (y.x = (p.width - i2 * r2 - 0.05 * p.width / 2) / r2, y.y = ((p.height - e2[3] * r2) / 2 - e2[1] * r2) / r2) : (y.x = ((p.width - e2[2] * r2) / 2 - e2[0] * r2) / r2, y.y = (p.height - o2 * r2 - 0.05 * p.height / 2) / r2), D = initBoundingArrScale(D, m, u.precision), T = initBoundingArrScale(T, m, u.precision), Q({ deltaY: 1, clientX: 0, clientY: 0, preventDefault() {
            }, stopPropagation() {
            }, __zoom: r2 }, true), true;
          "width" === t2.fit ? y.x = (p.width - v.width * m) / 2 : y.y = (p.height - v.height * m) / 2, x = { startX: 0, startY: 0, endX: 0 + v.width, endY: 0 + v.height }, u.isImgCrop && nt("add", D = [x]);
        }
        return D = initBoundingArrScale(D, m, u.precision), T = initBoundingArrScale(T, m, u.precision), drawImage(l, h, y.x, y.y, h.width * m, h.height * m), z(), true;
      }).catch((t2) => {
  ...
  function Q(t2, e2) {
    ...
    !s && !t2.__zoom || L.isDrawRecting || L.isMoving || (n2 = e2 ? 0 : (t2.clientX - C.left) * DPI, r2 = e2 ? 0 : (t2.clientY - C.top) * DPI, i2 = t2.deltaY < 0 ? 1 : -1, t2 = e2 ? t2.__zoom : Math.exp(i2 * X), I * t2 < 0.2 || k.onWheel(t2, { x: n2, y: r2 }, e2));
  }
  function tt(e2) {
    if (L.resizeHovering) {
      var n2;
  ...
  function at(t2) {
    s && (t2 = amendDpi(t2 = { layerX: Reflect.get(t2, "layerX"), layerY: Reflect.get(t2, "layerY") }, ["layerX", "layerY"]), i = new Date().getTime(), k.onMouseOverMove(t2), ot(t2));
  }
  function ut() {
    var t2;
  ...
  function ct() {
    s && (R.value.style.cursor = "auto", et(), ot());
  }
  function ft() {
  ...
  function st(e2) {
    if (G(), s) {
      ...
      var e2 = i && r ? i - r : 0;
      r = void 0, i = void 0, 100 < e2 || (u.splitClickAndDoubleClickEvent ? (ft(), o = setTimeout(() => {
        k.onCick(t2), o = null;
  ...
  function lt(t2) {
    ...
    var e2 = t2.touches;
    if (1 === t2.touches.length && it({ layerX: e2[0].clientX, layerY: e2[0].clientY }), 2 == t2.touches.length) {
      if (!C)
        throw new Error("can't find  containerInfo.");
  ...
  return t({ render: z, removeTagItems: function(n2) {
    ...
    T = initBoundingArrScale(r2, m, u.precision), z(), rt("delete", i2);
