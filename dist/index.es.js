...
!function(R, L) {
  !function() {
    var Wi, Hi = "Expected a function", ya = "__lodash_hash_undefined__", wa = "__lodash_placeholder__", ma = 16, Fi = 32, Ui = 64, Vi = 128, xa = 256, Ni = 1 / 0, $i = 9007199254740991, ba = NaN, qi = 4294967295, Ca = [["ary", Vi], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", ma], ["flip", 512], ["partial", Fi], ["partialRight", Ui], ["rearg", xa]], Gi = "[object Arguments]", Ia = "[object Array]", Ki = "[object Boolean]", Zi = "[object Date]", Ba = "[object Error]", Ta = "[object Function]", Sa = "[object GeneratorFunction]", Ji = "[object Map]", Qi = "[object Number]", ta = "[object Object]", Da = "[object Promise]", Ra = "[object RegExp]", ea = "[object Set]", La = "[object String]", Oa = "[object Symbol]", ka = "[object WeakMap]", Ea = "[object ArrayBuffer]", na = "[object DataView]", za = "[object Float32Array]", Aa = "[object Float64Array]", Ya = "[object Int8Array]", ja = "[object Int16Array]", Pa = "[object Int32Array]", Xa = "[object Uint8Array]", Ma = "[object Uint8ClampedArray]", Wa = "[object Uint16Array]", Ha = "[object Uint32Array]", Fa = /\b__p \+= '';/g, Ua = /\b(__p \+=) '' \+/g, Va = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Na = /&(?:amp|lt|gt|quot|#39);/g, $a = /[&<>"']/g, qa = RegExp(Na.source), Ga = RegExp($a.source), Ka = /<%-([\s\S]+?)%>/g, Za = /<%([\s\S]+?)%>/g, Ja = /<%=([\s\S]+?)%>/g, Qa = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, tu = /^\w*$/, eu = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, nu = /[\\^$.*+?()[\]{}|]/g, ru = RegExp(nu.source), ou = /^\s+/, i = /\s/, iu = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, au = /\{\n\/\* \[wrapped with (.+)\] \*/, uu = /,? & /, cu = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, fu = /[()=,{}\[\]\/\s]/, lu = /\\(\\)?/g, su = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, du = /\w*$/, pu = /^[-+]0x[0-9a-f]+$/i, hu = /^0b[01]+$/i, vu = /^\[object .+?Constructor\]$/, gu = /^0o[0-7]+$/i, _u = /^(?:0|[1-9]\d*)$/, yu = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, wu = /($^)/, mu = /['\n\r\u2028\u2029\\]/g, a = "\\ud800-\\udfff", u = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", c = "\\u2700-\\u27bf", t = "a-z\\xdf-\\xf6\\xf8-\\xff", e = "A-Z\\xc0-\\xd6\\xd8-\\xde", f = "\\ufe0e\\ufe0f", l = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", s = "['\u2019]", n = "[" + a + "]", d = "[" + l + "]", p = "[" + u + "]", h = "[" + c + "]", v = "[" + t + "]", l = "[^" + a + l + "\\d+" + c + t + e + "]", c = "\\ud83c[\\udffb-\\udfff]", t = "[^" + a + "]", g = "(?:\\ud83c[\\udde6-\\uddff]){2}", r = "[\\ud800-\\udbff][\\udc00-\\udfff]", e = "[" + e + "]", _ = "\\u200d", y = "(?:" + v + "|" + l + ")", l = "(?:" + e + "|" + l + ")", w = "(?:['\u2019](?:d|ll|m|re|s|t|ve))?", m = "(?:['\u2019](?:D|LL|M|RE|S|T|VE))?", x = "(?:" + p + "|" + c + ")?", b = "[" + f + "]?", b = b + x + ("(?:" + _ + "(?:" + [t, g, r].join("|") + ")" + b + x + ")*"), x = "(?:" + [h, g, r].join("|") + ")" + b, h = "(?:" + [t + p + "?", p, g, r, n].join("|") + ")", xu = RegExp(s, "g"), bu = RegExp(p, "g"), C = RegExp(c + "(?=" + c + ")|" + h + b, "g"), Cu = RegExp([e + "?" + v + "+" + w + "(?=" + [d, e, "$"].join("|") + ")", l + "+" + m + "(?=" + [d, e + y, "$"].join("|") + ")", e + "?" + y + "+" + w, e + "+" + m, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", "\\d+", x].join("|"), "g"), I = RegExp("[" + _ + a + u + f + "]"), Iu = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, Bu = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], Tu = -1, ra = {}, oa = (ra[za] = ra[Aa] = ra[Ya] = ra[ja] = ra[Pa] = ra[Xa] = ra[Ma] = ra[Wa] = ra[Ha] = true, ra[Gi] = ra[Ia] = ra[Ea] = ra[Ki] = ra[na] = ra[Zi] = ra[Ba] = ra[Ta] = ra[Ji] = ra[Qi] = ra[ta] = ra[Ra] = ra[ea] = ra[La] = ra[ka] = false, {}), B = (oa[Gi] = oa[Ia] = oa[Ea] = oa[na] = oa[Ki] = oa[Zi] = oa[za] = oa[Aa] = oa[Ya] = oa[ja] = oa[Pa] = oa[Ji] = oa[Qi] = oa[ta] = oa[Ra] = oa[ea] = oa[La] = oa[Oa] = oa[Xa] = oa[Ma] = oa[Wa] = oa[Ha] = true, oa[Ba] = oa[Ta] = oa[ka] = false, { "\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029" }), Su = parseFloat, Du = parseInt, t = "object" == typeof commonjsGlobal && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal, g = "object" == typeof self && self && self.Object === Object && self, ia = t || g || Function("return this")(), r = L && !L.nodeType && L, o = r && R && !R.nodeType && R, Ru = o && o.exports === r, T = Ru && t.process, n = function() {
      try {
    ...
    var oc = D({ "\xC0": "A", "\xC1": "A", "\xC2": "A", "\xC3": "A", "\xC4": "A", "\xC5": "A", "\xE0": "a", "\xE1": "a", "\xE2": "a", "\xE3": "a", "\xE4": "a", "\xE5": "a", "\xC7": "C", "\xE7": "c", "\xD0": "D", "\xF0": "d", "\xC8": "E", "\xC9": "E", "\xCA": "E", "\xCB": "E", "\xE8": "e", "\xE9": "e", "\xEA": "e", "\xEB": "e", "\xCC": "I", "\xCD": "I", "\xCE": "I", "\xCF": "I", "\xEC": "i", "\xED": "i", "\xEE": "i", "\xEF": "i", "\xD1": "N", "\xF1": "n", "\xD2": "O", "\xD3": "O", "\xD4": "O", "\xD5": "O", "\xD6": "O", "\xD8": "O", "\xF2": "o", "\xF3": "o", "\xF4": "o", "\xF5": "o", "\xF6": "o", "\xF8": "o", "\xD9": "U", "\xDA": "U", "\xDB": "U", "\xDC": "U", "\xF9": "u", "\xFA": "u", "\xFB": "u", "\xFC": "u", "\xDD": "Y", "\xFD": "y", "\xFF": "y", "\xC6": "Ae", "\xE6": "ae", "\xDE": "Th", "\xFE": "th", "\xDF": "ss", "\u0100": "A", "\u0102": "A", "\u0104": "A", "\u0101": "a", "\u0103": "a", "\u0105": "a", "\u0106": "C", "\u0108": "C", "\u010A": "C", "\u010C": "C", "\u0107": "c", "\u0109": "c", "\u010B": "c", "\u010D": "c", "\u010E": "D", "\u0110": "D", "\u010F": "d", "\u0111": "d", "\u0112": "E", "\u0114": "E", "\u0116": "E", "\u0118": "E", "\u011A": "E", "\u0113": "e", "\u0115": "e", "\u0117": "e", "\u0119": "e", "\u011B": "e", "\u011C": "G", "\u011E": "G", "\u0120": "G", "\u0122": "G", "\u011D": "g", "\u011F": "g", "\u0121": "g", "\u0123": "g", "\u0124": "H", "\u0126": "H", "\u0125": "h", "\u0127": "h", "\u0128": "I", "\u012A": "I", "\u012C": "I", "\u012E": "I", "\u0130": "I", "\u0129": "i", "\u012B": "i", "\u012D": "i", "\u012F": "i", "\u0131": "i", "\u0134": "J", "\u0135": "j", "\u0136": "K", "\u0137": "k", "\u0138": "k", "\u0139": "L", "\u013B": "L", "\u013D": "L", "\u013F": "L", "\u0141": "L", "\u013A": "l", "\u013C": "l", "\u013E": "l", "\u0140": "l", "\u0142": "l", "\u0143": "N", "\u0145": "N", "\u0147": "N", "\u014A": "N", "\u0144": "n", "\u0146": "n", "\u0148": "n", "\u014B": "n", "\u014C": "O", "\u014E": "O", "\u0150": "O", "\u014D": "o", "\u014F": "o", "\u0151": "o", "\u0154": "R", "\u0156": "R", "\u0158": "R", "\u0155": "r", "\u0157": "r", "\u0159": "r", "\u015A": "S", "\u015C": "S", "\u015E": "S", "\u0160": "S", "\u015B": "s", "\u015D": "s", "\u015F": "s", "\u0161": "s", "\u0162": "T", "\u0164": "T", "\u0166": "T", "\u0163": "t", "\u0165": "t", "\u0167": "t", "\u0168": "U", "\u016A": "U", "\u016C": "U", "\u016E": "U", "\u0170": "U", "\u0172": "U", "\u0169": "u", "\u016B": "u", "\u016D": "u", "\u016F": "u", "\u0171": "u", "\u0173": "u", "\u0174": "W", "\u0175": "w", "\u0176": "Y", "\u0177": "y", "\u0178": "Y", "\u0179": "Z", "\u017B": "Z", "\u017D": "Z", "\u017A": "z", "\u017C": "z", "\u017E": "z", "\u0132": "IJ", "\u0133": "ij", "\u0152": "Oe", "\u0153": "oe", "\u0149": "'n", "\u017F": "s" }), ic = D({ "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" });
    function ac(t2) {
      return "\\" + B[t2];
    }
    function pa(t2) {
    ...
    var _a = function o2(t2) {
      var b2 = (t2 = null == t2 ? ia : _a.defaults(ia.Object(), t2, _a.pick(ia, Bu))).Array, i2 = t2.Date, k = t2.Error, E = t2.Function, z = t2.Math, v2 = t2.Object, A = t2.RegExp, H = t2.String, y2 = t2.TypeError, F = b2.prototype, U = E.prototype, V = v2.prototype, N = t2["__core-js_shared__"], $ = U.toString, Y = V.hasOwnProperty, q = 0, G = (U = /[^.]+$/.exec(N && N.keys && N.keys.IE_PROTO || "")) ? "Symbol(src)_1." + U : "", K = V.toString, Z = $.call(v2), J = ia._, Q = A("^" + $.call(Y).replace(nu, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), U = Ru ? t2.Buffer : Wi, e2 = t2.Symbol, tt = t2.Uint8Array, et = U ? U.allocUnsafe : Wi, nt = cc(v2.getPrototypeOf, v2), rt = v2.create, ot = V.propertyIsEnumerable, it = F.splice, at = e2 ? e2.isConcatSpreadable : Wi, ut = e2 ? e2.iterator : Wi, ct = e2 ? e2.toStringTag : Wi, ft = function() {
        try {
          var t3 = Jn(v2, "defineProperty");
          return t3({}, "", {}), t3;
        } catch (t4) {
        }
      }(), lt = t2.clearTimeout !== ia.clearTimeout && t2.clearTimeout, st = i2 && i2.now !== ia.Date.now && i2.now, dt = t2.setTimeout !== ia.setTimeout && t2.setTimeout, pt = z.ceil, ht = z.floor, vt = v2.getOwnPropertySymbols, U = U ? U.isBuffer : Wi, gt = t2.isFinite, _t = F.join, yt = cc(v2.keys, v2), w2 = z.max, C2 = z.min, wt = i2.now, mt = t2.parseInt, xt = z.random, bt = F.reverse, i2 = Jn(t2, "DataView"), Ct = Jn(t2, "Map"), It = Jn(t2, "Promise"), Bt = Jn(t2, "Set"), t2 = Jn(t2, "WeakMap"), Tt = Jn(v2, "create"), St = t2 && new t2(), Dt = {}, Rt = Cr(i2), Lt = Cr(Ct), Ot = Cr(It), kt = Cr(Bt), Et = Cr(t2), e2 = e2 ? e2.prototype : Wi, zt = e2 ? e2.valueOf : Wi, At = e2 ? e2.toString : Wi;
      function h2(t3) {
      ...
      function Ft(t3, e3) {
        var n3, r3 = M(t3), o3 = !r3 && yo(t3), i3 = !r3 && !o3 && mo(t3), a3 = !r3 && !o3 && !i3 && Oo(t3), u3 = r3 || o3 || i3 || a3, c3 = u3 ? Ju(t3.length, H) : [], f3 = c3.length;
        for (n3 in t3)
          !e3 && !Y.call(t3, n3) || u3 && ("length" == n3 || i3 && ("offset" == n3 || "parent" == n3) || a3 && ("buffer" == n3 || "byteLength" == n3 || "byteOffset" == n3) || or(n3, f3)) || c3.push(n3);
        return c3;
      }
      function Ut(t3) {
        var e3 = t3.length;
        return e3 ? t3[Pe(0, e3 - 1)] : Wi;
      }
      function Vt(t3, e3) {
      ...
      function qt(t3, e3, n3) {
        var r3 = t3[e3];
        Y.call(t3, e3) && X(r3, n3) && (n3 !== Wi || e3 in t3) || Jt(t3, e3, n3);
      }
      function Gt(t3, e3) {
      ...
      function m2(n3, r3, o3, t3, e3, i3) {
        ...
        }) : Bo(n3) && n3.forEach(function(t4, e4) {
          a3.set(e4, m2(t4, r3, o3, e4, n3, i3));
        });
        var h3 = t3 ? Wi : (f3 ? c3 ? Nn : Vn : c3 ? L2 : R2)(n3);
      ...
      function re(t3, e3, n3, r3) {
        var o3 = -1, i3 = Xu, a3 = true, u3 = t3.length, c3 = [], f3 = e3.length;
        if (!u3)
          return c3;
        n3 && (e3 = fa(e3, da(n3))), r3 ? (i3 = Mu, a3 = false) : 200 <= e3.length && (i3 = ec, a3 = false, e3 = new Ht(e3));
        t:
          for (; ++o3 < u3; ) {
            var l3 = t3[o3], s3 = null == n3 ? l3 : n3(l3), l3 = r3 || 0 !== l3 ? l3 : 0;
            if (a3 && s3 == s3) {
              for (var d3 = f3; d3--; )
                if (e3[d3] === s3)
                  continue t;
      ...
      h2.templateSettings = { escape: Ka, evaluate: Za, interpolate: Ja, variable: "", imports: { _: h2 } }, (h2.prototype = Pt.prototype).constructor = h2, (g2.prototype = Yt(Pt.prototype)).constructor = g2, (_2.prototype = Yt(Pt.prototype)).constructor = _2, Xt.prototype.clear = function() {
        ...
        return Tt ? (e3 = n3[t3]) === ya ? Wi : e3 : Y.call(n3, t3) ? n3[t3] : Wi;
      }, Xt.prototype.has = function(t3) {
        var e3 = this.__data__;
        return Tt ? e3[t3] !== Wi : Y.call(e3, t3);
      }, Xt.prototype.set = function(t3, e3) {
        var n3 = this.__data__;
        return this.size += this.has(t3) ? 0 : 1, n3[t3] = Tt && e3 === Wi ? ya : e3, this;
      ...
      function ue(t3, e3, n3) {
        for (var r3 = -1, o3 = t3.length; ++r3 < o3; ) {
          ...
          null != c3 && (i3 === Wi ? c3 == c3 && !T2(c3) : n3(c3, i3)) && (i3 = c3, a3 = u3);
        }
        return a3;
      }
      function ce(t3, r3) {
      ...
      function we(t3, e3, n3) {
        for (var r3 = n3 ? Mu : Xu, o3 = t3[0].length, i3 = t3.length, a3 = i3, u3 = b2(i3), c3 = 1 / 0, f3 = []; a3--; ) {
          var l3 = t3[a3];
          a3 && e3 && (l3 = fa(l3, da(e3))), c3 = C2(l3.length, c3), u3[a3] = !n3 && (e3 || 120 <= o3 && 120 <= l3.length) ? new Ht(a3 && l3) : Wi;
        }
        var l3 = t3[0], s3 = -1, d3 = u3[0];
        t:
          for (; ++s3 < o3 && f3.length < c3; ) {
            var p3 = l3[s3], h3 = e3 ? e3(p3) : p3, p3 = n3 || 0 !== p3 ? p3 : 0;
      ...
      function be(t3, e3, n3, r3, o3) {
        {
          ...
          if (null == t3 || null == e3 || !W(t3) && !W(e3))
            return t3 != t3 && e3 != e3;
          var i3 = be, a3 = M(t3), u3 = M(e3), c3 = a3 ? Ia : P(t3), u3 = u3 ? Ia : P(e3), f3 = (c3 = c3 == Gi ? ta : c3) == ta, l3 = (u3 = u3 == Gi ? ta : u3) == ta, u3;
          if ((u3 = c3 == u3) && mo(t3)) {
            if (!mo(e3))
              return false;
            f3 = !(a3 = true);
          ...
          if (u3) {
            o3 = o3 || new j();
            var m3 = t3, x3 = e3, b3 = n3, C3 = r3, I3 = i3, B3 = o3, T3 = 1 & b3, S3 = Vn(m3), D3 = S3.length, a3 = Vn(x3).length;
            if (D3 != a3 && !T3)
              return false;
            for (var R3 = D3; R3--; ) {
              var L3 = S3[R3];
            ...
            if (a3 && c3)
              return a3 == x3 && c3 == m3;
            for (var O2 = true, k2 = (B3.set(m3, x3), B3.set(x3, m3), T3); ++R3 < D3; ) {
              L3 = S3[R3];
              var E2, z2 = m3[L3], A2 = x3[L3];
              if (!((E2 = C3 ? T3 ? C3(A2, z2, L3, x3, m3, B3) : C3(z2, A2, L3, m3, x3, B3) : E2) === Wi ? z2 === A2 || I3(z2, A2, b3, C3, B3) : E2)) {
                O2 = false;
                break;
              }
      ...
      function Ie(t3) {
        return !(!B2(t3) || (e3 = t3, G && G in e3)) && (bo(t3) ? Q : vu).test(Cr(t3));
        var e3;
      }
      function Be(t3) {
        return "function" == typeof t3 ? t3 : null == t3 ? O : "object" == typeof t3 ? M(t3) ? Oe(t3[0], t3[1]) : Le(t3) : Di(t3);
      }
      function Te(t3) {
        if (!cr(t3))
          return yt(t3);
      ...
      function Se(t3) {
        ...
        var o3, i3 = cr(t3), a3 = [];
        for (o3 in t3)
          ("constructor" != o3 || !i3 && Y.call(t3, o3)) && a3.push(o3);
        return a3;
      }
      function De(t3, e3) {
        return t3 < e3;
      ...
      function Oe(n3, r3) {
        return ir(n3) && fr(r3) ? lr(br(n3), r3) : function(t3) {
          var e3 = Vo(t3, n3);
          return e3 === Wi && e3 === r3 ? No(t3, n3) : be(r3, e3, 3);
        };
      }
      function ke(v3, g3, _3, y3, w3) {
        v3 !== g3 && fe(g3, function(t3, e3) {
          var n3, r3, o3, i3, a3, u3, c3, f3, l3, s3, d3, p3, h3;
          w3 = w3 || new j(), B2(t3) ? (r3 = g3, i3 = _3, a3 = ke, u3 = y3, c3 = w3, d3 = pr(n3 = v3, o3 = e3), p3 = pr(r3, o3), (h3 = c3.get(p3)) ? $t(n3, o3, h3) : (h3 = u3 ? u3(d3, p3, o3 + "", n3, r3, c3) : Wi, (r3 = h3 === Wi) && (f3 = M(p3), l3 = !f3 && mo(p3), s3 = !f3 && !l3 && Oo(p3), h3 = p3, f3 || l3 || s3 ? h3 = M(d3) ? d3 : x2(d3) ? I2(d3) : l3 ? ln(p3, !(r3 = false)) : s3 ? dn(p3, !(r3 = false)) : [] : So(p3) || yo(p3) ? yo(h3 = d3) ? h3 = jo(d3) : B2(d3) && !bo(d3) || (h3 = nr(p3)) : r3 = false), r3 && (c3.set(p3, h3), a3(h3, p3, i3, u3, c3), c3.delete(p3)), $t(n3, o3, h3))) : (f3 = y3 ? y3(pr(v3, e3), t3, e3 + "", v3, g3, w3) : Wi, $t(v3, e3, f3 = f3 === Wi ? t3 : f3));
        }, L2);
      }
      function Ee(t3, e3) {
        var n3 = t3.length;
      ...
      function ze(t3, r3, l3) {
        r3 = r3.length ? fa(r3, function(e4) {
          return M(e4) ? function(t4) {
            return he(t4, 1 === e4.length ? e4[0] : e4);
          } : e4;
        }) : [O];
        var o3 = -1;
        r3 = fa(r3, da(s2()));
      ...
      function Ae(t3, e3, n3) {
        for (var r3 = -1, o3 = e3.length, i3 = {}; ++r3 < o3; ) {
          ...
          n3(u3, a3) && He(i3, an(a3, t3), u3);
        }
        return i3;
      }
      function Ye(t3, e3, n3, r3) {
        var o3 = r3 ? Nu : sa, i3 = -1, a3 = e3.length, u3 = t3;
      ...
      function He(t3, e3, n3, r3) {
        ...
        for (var o3 = -1, i3 = (e3 = an(e3, t3)).length, a3 = i3 - 1, u3 = t3; null != u3 && ++o3 < i3; ) {
          ...
          if ("__proto__" === f3 || "constructor" === f3 || "prototype" === f3)
            return t3;
          o3 != a3 && (c3 = u3[f3], (l3 = r3 ? r3(c3, f3, u3) : Wi) === Wi && (l3 = B2(c3) ? c3 : or(e3[o3 + 1]) ? [] : {})), qt(u3, f3, l3), u3 = u3[f3];
        }
        return t3;
      }
      var Fe = St ? function(t3, e3) {
      ...
      function Ne(t3, e3, n3) {
        ...
        if ("number" == typeof e3 && e3 == e3 && o3 <= 2147483647) {
          for (; r3 < o3; ) {
            ...
            null !== a3 && !T2(a3) && (n3 ? a3 <= e3 : a3 < e3) ? r3 = 1 + i3 : o3 = i3;
          }
          return o3;
        }
        return $e(t3, e3, O, n3);
      ...
      function $e(t3, e3, n3, r3) {
        ...
        if (0 === i3)
          return 0;
        for (var a3 = (e3 = n3(e3)) != e3, u3 = null === e3, c3 = T2(e3), f3 = e3 === Wi; o3 < i3; ) {
          var l3 = ht((o3 + i3) / 2), s3 = n3(t3[l3]), d3 = s3 !== Wi, p3 = null === s3, h3 = s3 == s3, v3 = T2(s3), h3 = a3 ? r3 || h3 : f3 ? h3 && (r3 || d3) : u3 ? h3 && d3 && (r3 || !p3) : c3 ? h3 && d3 && !p3 && (r3 || !v3) : !p3 && !v3 && (r3 ? s3 <= e3 : s3 < e3);
          h3 ? o3 = l3 + 1 : i3 = l3;
        }
      ...
      function Je(t3, e3, n3, r3) {
        return He(t3, e3, n3(he(t3, e3)), r3);
      }
      ...
      function pn(t3, e3) {
        if (t3 !== e3) {
          var n3 = t3 !== Wi, r3 = null === t3, o3 = t3 == t3, i3 = T2(t3), a3 = e3 !== Wi, u3 = null === e3, c3 = e3 == e3, f3 = T2(e3);
      ...
      function Tn(c3) {
        return Un(function(o3) {
          ...
          for (t3 = u3 ? t3 : i3; ++t3 < i3; )
            var r3 = qn(n3 = o3[t3]), a3 = "wrapper" == r3 ? $n(n3) : Wi, u3 = a3 && ar(a3[0]) && 424 == a3[1] && !a3[4].length && 1 == a3[9] ? u3[qn(a3[0])].apply(u3, a3[3]) : 1 == n3.length && ar(n3) ? u3[r3]() : u3.thru(n3);
          return function() {
      ...
      function Sn(a3, u3, c3, f3, l3, s3, d3, p3, h3, v3) {
        ...
        return function t3() {
          ...
          if (w3 && (o3 = function(t4, e4) {
            ...
            return o3 = ha(e3, r3), An(a3, u3, Sn, t3.placeholder, c3, e3, o3, p3, h3, v3 - i3);
      ...
      function zn(n3) {
        return function(t3, e3) {
          return "string" == typeof t3 && "string" == typeof e3 || (t3 = D2(t3), e3 = D2(e3)), n3(t3, e3);
        };
      }
      function An(t3, e3, n3, r3, o3, i3, a3, u3, c3, f3) {
        var l3 = 8 & e3, o3 = (4 & (e3 = (e3 | (l3 ? Fi : Ui)) & ~(l3 ? Ui : Fi)) || (e3 &= -4), [t3, e3, o3, l3 ? i3 : Wi, l3 ? a3 : Wi, l3 ? Wi : i3, l3 ? Wi : a3, u3, c3, f3]), i3 = n3.apply(Wi, o3);
      ...
      function Yn(t3) {
        ...
        return function(t4, e3) {
          var n3;
          return t4 = D2(t4), (e3 = null == e3 ? 0 : C2(S2(e3), 292)) && gt(t4) ? (n3 = (p2(t4) + "e").split("e"), +((n3 = (p2(r3(n3[0] + "e" + (+n3[1] + e3))) + "e").split("e"))[0] + "e" + (+n3[1] - e3))) : r3(t4);
        };
      }
      var jn = Bt && 1 / fc(new Bt([, -0]))[1] == Ni ? function(t3) {
        return new Bt(t3);
      } : Ii;
      function Pn(i3) {
        return function(t3) {
          var e3, n3, r3, o3 = P(t3);
      ...
      function Xn(t3, e3, n3, r3, o3, i3, a3, u3) {
        ...
        if (!c3 && "function" != typeof t3)
          throw new y2(Hi);
        var f3, l3, s3, d3, p3, h3 = r3 ? r3.length : 0, v3 = (h3 || (e3 &= -97, r3 = o3 = Wi), a3 = a3 === Wi ? a3 : w2(S2(a3), 0), u3 = u3 === Wi ? u3 : S2(u3), h3 -= o3 ? o3.length : 0, e3 & Ui && (g3 = r3, f3 = o3, r3 = o3 = Wi), c3 ? Wi : $n(t3)), g3 = [t3, e3, n3, r3, o3, g3, f3, i3, a3, u3];
        return v3 && function(t4, e4) {
          var n4 = t4[1], r4 = e4[1], o4 = n4 | r4, i4 = o4 < 131, a4 = r4 == Vi && 8 == n4 || r4 == Vi && n4 == xa && t4[7].length <= e4[8] || 384 == r4 && e4[7].length <= e4[8] && 8 == n4;
          if (!i4 && !a4)
            return;
          ...
          (i4 = e4[7]) && (t4[7] = i4);
          r4 & Vi && (t4[8] = null == t4[8] ? e4[8] : C2(t4[8], e4[8]));
          null == t4[9] && (t4[9] = e4[9]);
          t4[0] = e4[0], t4[1] = o4;
        }(g3, v3), t3 = g3[0], e3 = g3[1], n3 = g3[2], r3 = g3[3], o3 = g3[4], !(u3 = g3[9] = g3[9] === Wi ? c3 ? 0 : t3.length : w2(g3[9] - h3, 0)) && 24 & e3 && (e3 &= -25), f3 = e3 && 1 != e3 ? 8 == e3 || e3 == ma ? In(t3, e3, u3) : e3 != Fi && 33 != e3 || o3.length ? Sn.apply(Wi, g3) : kn(t3, e3, n3, r3) : (s3 = n3, d3 = 1 & e3, p3 = Cn(l3 = t3), function t4() {
          return (this && this !== ia && this instanceof t4 ? p3 : l3).apply(d3 ? s3 : this, arguments);
        }), _r((v3 ? Fe : hr)(f3, g3), t3, e3);
      }
      function Mn(t3, e3, n3, r3) {
        return t3 === Wi || X(t3, V[n3]) && !Y.call(r3, n3) ? e3 : t3;
      }
      function Wn(t3, e3, n3, r3, o3, i3) {
        return B2(t3) && B2(e3) && (i3.set(e3, t3), ke(t3, e3, Wi, Wn, i3), i3.delete(e3)), t3;
      }
      function Hn(t3) {
        return So(t3) ? Wi : t3;
      }
      function Fn(t3, e3, n3, r3, o3, i3) {
        ...
        if (c3 && f3)
          return c3 == e3 && f3 == t3;
        var l3 = -1, s3 = true, d3 = 2 & n3 ? new Ht() : Wi;
      ...
      function qn(t3) {
        for (var e3 = t3.name + "", n3 = Dt[e3], r3 = Y.call(Dt, e3) ? n3.length : 0; r3--; ) {
      ...
      function Gn(t3) {
        return (Y.call(h2, "placeholder") ? h2 : t3).placeholder;
      }
      function s2() {
        var t3 = (t3 = h2.iteratee || mi) === mi ? Be : t3;
      ...
      (i2 && P(new i2(new ArrayBuffer(1))) != na || Ct && P(new Ct()) != Ji || It && P(It.resolve()) != Da || Bt && P(new Bt()) != ea || t2 && P(new t2()) != ka) && (P = function(t3) {
      ...
      function cr(t3) {
        ...
        return t3 === ("function" == typeof e3 && e3.prototype || V);
      }
      function fr(t3) {
        return t3 == t3 && !B2(t3);
      }
      ...
      function Tr(t3, e3, n3) {
        ...
        if (!r3)
          return -1;
        var o3 = r3 - 1;
        return n3 !== Wi && (o3 = S2(n3), o3 = n3 < 0 ? w2(r3 + o3, 0) : C2(o3, r3 - 1)), Vu(t3, s2(e3, 3), o3, true);
      }
      function Sr(t3) {
      ...
      var Vr = Un(function(e3) {
        function t3(t4) {
          return Qt(t4, e3);
        }
        var n3 = e3.length, r3 = n3 ? e3[0] : 0, o3 = this.__wrapped__;
        return !(1 < n3 || this.__actions__.length) && o3 instanceof _2 && or(r3) ? ((o3 = o3.slice(r3, +r3 + (n3 ? 1 : 0))).__actions__.push({ func: Ur, args: [t3], thisArg: Wi }), new g2(o3, this.__chain__).thru(function(t4) {
          return n3 && !t4.length && t4.push(Wi), t4;
        })) : this.thru(t3);
      });
      var Nr = _n(function(t3, e3, n3) {
      ...
      function oo(t3, e3, n3) {
        return e3 = n3 ? Wi : e3, e3 = t3 && null == e3 ? t3.length : e3, Xn(t3, Vi, Wi, Wi, Wi, Wi, e3);
      }
      function io(t3, e3) {
        var n3;
      ...
      var ao = a2(function(t3, e3, n3) {
        var r3, o3 = 1;
        return n3.length && (r3 = ha(n3, Gn(ao)), o3 |= Fi), Xn(t3, o3, e3, n3, r3);
      }), uo = a2(function(t3, e3, n3) {
        var r3, o3 = 3;
        return n3.length && (r3 = ha(n3, Gn(uo)), o3 |= Fi), Xn(e3, o3, t3, n3, r3);
      });
      function co(r3, n3, t3) {
        ...
        return n3 = D2(n3) || 0, B2(t3) && (s3 = !!t3.leading, d3 = "maxWait" in t3, a3 = d3 ? w2(D2(t3.maxWait) || 0, n3) : a3, e3 = "trailing" in t3 ? !!t3.trailing : e3), _3.cancel = function() {
      ...
      var un = un(function(r3, o3) {
        var i3 = (o3 = 1 == o3.length && M(o3[0]) ? fa(o3[0], da(s2())) : fa(c2(o3, 1), da(s2()))).length;
        ...
        var n3 = ha(e3, Gn(po));
        return Xn(t3, Fi, Wi, e3, n3);
      }), ho = a2(function(t3, e3) {
        var n3 = ha(e3, Gn(ho));
        return Xn(t3, Ui, Wi, e3, n3);
      }), vo = Un(function(t3, e3) {
      ...
      var go = zn(ge), _o = zn(function(t3, e3) {
        ...
        return W(t3) && Y.call(t3, "callee") && !ot.call(t3, "callee");
      ...
      var mo = U || ki, U = Ou ? da(Ou) : function(t3) {
      ...
      function xo(t3) {
        if (!W(t3))
          return false;
        var e3 = n2(t3);
        return e3 == Ba || "[object DOMException]" == e3 || "string" == typeof t3.message && "string" == typeof t3.name && !So(t3);
      }
      function bo(t3) {
        if (!B2(t3))
          return false;
        t3 = n2(t3);
        return t3 == Ta || t3 == Sa || "[object AsyncFunction]" == t3 || "[object Proxy]" == t3;
      }
      function Co(t3) {
      ...
      function So(t3) {
        ...
        return "function" == typeof t3 && t3 instanceof t3 && $.call(t3) == Z;
      }
      var Do = Eu ? da(Eu) : function(t3) {
        return W(t3) && n2(t3) == Ra;
      };
      var Ro = zu ? da(zu) : function(t3) {
        return W(t3) && P(t3) == ea;
      };
      function Lo(t3) {
      ...
      var ko = zn(De), Eo = zn(function(t3, e3) {
        return t3 <= e3;
      });
      function zo(t3) {
        if (!t3)
      ...
      function Ao(t3) {
        return t3 ? (t3 = D2(t3)) === Ni || t3 === -Ni ? 17976931348623157e292 * (t3 < 0 ? -1 : 1) : t3 == t3 ? t3 : 0 : 0 === t3 ? t3 : 0;
      }
      function S2(t3) {
      ...
      function D2(t3) {
        ...
        t3 = Qu(t3);
        var e3 = hu.test(t3);
        return e3 || gu.test(t3) ? Du(t3.slice(2), e3 ? 2 : 8) : pu.test(t3) ? ba : +t3;
      }
      function jo(t3) {
        return gn(t3, L2(t3));
      }
      ...
      var Fo = a2(function(t3, e3) {
        ...
        for (o3 && d2(e3[0], e3[1], o3) && (r3 = 1); ++n3 < r3; )
          for (var i3 = e3[n3], a3 = L2(i3), u3 = -1, c3 = a3.length; ++u3 < c3; ) {
            ...
            (l3 === Wi || X(l3, V[f3]) && !Y.call(t3, f3)) && (t3[f3] = i3[f3]);
          }
        return t3;
      }), Uo = a2(function(t3) {
      ...
      function Vo(t3, e3, n3) {
        t3 = null == t3 ? Wi : he(t3, e3);
        return t3 === Wi ? n3 : t3;
      }
      function No(t3, e3) {
        return null != t3 && er(t3, e3, ye);
      }
      var $o = Dn(function(t3, e3, n3) {
        t3[e3 = null != e3 && "function" != typeof e3.toString ? K.call(e3) : e3] = n3;
      }, _i(O)), qo = Dn(function(t3, e3, n3) {
        null != e3 && "function" != typeof e3.toString && (e3 = K.call(e3)), Y.call(t3, e3) ? t3[e3].push(n3) : t3[e3] = [n3];
      }, s2), Go = a2(me);
      function R2(t3) {
        return (l2(t3) ? Ft : Te)(t3);
      }
      function L2(t3) {
        return l2(t3) ? Ft(t3, true) : Se(t3);
      }
      var Ko = yn(function(t3, e3, n3) {
        ke(t3, e3, n3);
      }), Zo = yn(function(t3, e3, n3, r3) {
        ke(t3, e3, n3, r3);
      }), Jo = Un(function(e3, t3) {
        var n3 = {};
        if (null == e3)
          return n3;
        for (var r3 = false, o3 = (t3 = fa(t3, function(t4) {
          return t4 = an(t4, e3), r3 = r3 || 1 < t4.length, t4;
        }), gn(e3, Nn(e3), n3), r3 && (n3 = m2(n3, 7, Hn)), t3.length); o3--; )
          Ze(n3, t3[o3]);
        return n3;
      });
      var Qo = Un(function(t3, e3) {
      ...
      function Ci(r3, e3, t3) {
        var n3 = R2(e3), o3 = pe(e3, n3), i3 = (null != t3 || B2(e3) && (o3.length || !n3.length) || (t3 = e3, e3 = r3, r3 = this, o3 = pe(e3, R2(e3))), !(B2(t3) && "chain" in t3 && !t3.chain)), a3 = bo(r3);
      ...
      var Bi = Ln(fa), Ti = Ln(Pu), Si = Ln(Fu);
      function Di(t3) {
      ...
      var Ei = Rn(function(t3, e3) {
        return t3 + e3;
      }, 0), zi = Yn("ceil"), Ai = Rn(function(t3, e3) {
        return t3 / e3;
      }, 1), Yi = Yn("floor");
      var ji, Pi = Rn(function(t3, e3) {
        return t3 * e3;
      }, 1), Xi = Yn("round"), Mi = Rn(function(t3, e3) {
        return t3 - e3;
      }, 0);
      return h2.after = function(t3, e3) {
      ...
      }, h2.ary = oo, h2.assign = Po, h2.assignIn = Xo, h2.assignInWith = Mo, h2.assignWith = Wo, h2.at = Ho, h2.before = io, h2.bind = ao, h2.bindAll = gi, h2.bindKey = uo, h2.castArray = function() {
        if (!arguments.length)
          return [];
        var t3 = arguments[0];
        return M(t3) ? t3 : [t3];
        ...
        var o3 = null == r3 ? 0 : r3.length, e3 = s2();
        ...
        var e3, n3;
      }, h2.constant = _i, h2.countBy = Nr, h2.create = function(t3, e3) {
        return t3 = Yt(t3), null == e3 ? t3 : Zt(t3, e3);
        ...
        return e3.placeholder = t3.placeholder, e3;
      }, h2.debounce = co, h2.defaults = Fo, h2.defaultsDeep = Uo, h2.defer = st, h2.delay = fo, h2.difference = i2, h2.differenceBy = It, h2.differenceWith = t2, h2.drop = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
        ...
        for ((a3 = S2(a3)) < 0 && (a3 = c3 < -a3 ? 0 : c3 + a3), (u3 = u3 === Wi || c3 < u3 ? c3 : S2(u3)) < 0 && (u3 += c3), u3 = u3 < a3 ? 0 : Yo(u3); a3 < u3; )
          o3[a3++] = i3;
        return o3;
        ...
        return c2(to(t3, e3), Ni);
      }, h2.flatMapDepth = function(t3, e3, n3) {
        return n3 = n3 === Wi ? 1 : S2(n3), c2(to(t3, e3), n3);
      }, h2.flatten = Sr, h2.flattenDeep = function(t3) {
        return (null == t3 ? 0 : t3.length) ? c2(t3, Ni) : [];
        ...
        return null == t3 ? [] : pe(t3, R2(t3));
      }, h2.functionsIn = function(t3) {
        return null == t3 ? [] : pe(t3, L2(t3));
      }, h2.groupBy = Zr, h2.initial = function(t3) {
        return (null == t3 ? 0 : t3.length) ? u2(t3, 0, -1) : [];
      }, h2.intersection = N, h2.intersectionBy = dt, h2.intersectionWith = e2, h2.invert = $o, h2.invertBy = qo, h2.invokeMap = Jr, h2.iteratee = mi, h2.keyBy = Qr, h2.keys = R2, h2.keysIn = L2, h2.map = to, h2.mapKeys = function(t3, r3) {
        var o3 = {};
      ...
      }, h2.over = Bi, h2.overArgs = un, h2.overEvery = Ti, h2.overSome = Si, h2.partial = po, h2.partialRight = ho, h2.partition = eo, h2.pick = Qo, h2.pickBy = ti, h2.property = Di, h2.propertyOf = function(e3) {
        return function(t3) {
          return null == e3 ? Wi : he(e3, t3);
        };
        ...
        return t3 && t3.length && e3 && e3.length ? Ye(t3, e3, Wi, n3) : t3;
        ...
        return e3 = (n3 ? d2(t3, e3, n3) : e3 === Wi) ? 1 : S2(e3), (M(t3) ? Vt : We)(t3, e3);
      }, h2.set = function(t3, e3, n3) {
        return null == t3 ? t3 : He(t3, e3, n3);
      }, h2.setWith = function(t3, e3, n3, r3) {
        return r3 = "function" == typeof r3 ? r3 : Wi, null == t3 ? t3 : He(t3, e3, n3, r3);
      }, h2.shuffle = function(t3) {
        return (M(t3) ? Nt : Ue)(t3);
        ...
        return n3 && "number" != typeof n3 && d2(t3, e3, n3) && (e3 = n3 = Wi), (n3 = n3 === Wi ? qi : n3 >>> 0) ? (t3 = p2(t3)) && ("string" == typeof e3 || null != e3 && !Do(e3)) && !(e3 = f2(e3)) && pa(t3) ? cn(ga(t3), 0, n3) : t3.split(e3, n3) : [];
        ...
        if ("function" != typeof t3)
          throw new y2(Hi);
        return B2(n3) && (r3 = "leading" in n3 ? !!n3.leading : r3, o3 = "trailing" in n3 ? !!n3.trailing : o3), co(t3, e3, { leading: r3, maxWait: e3, trailing: o3 });
      }, h2.thru = Ur, h2.toArray = zo, h2.toPairs = ei, h2.toPairsIn = ni, h2.toPath = function(t3) {
        return M(t3) ? fa(t3, br) : T2(t3) ? [t3] : I2(xr(p2(t3)));
      }, h2.toPlainObject = jo, h2.transform = function(t3, r3, o3) {
        var e3, n3 = M(t3), i3 = n3 || mo(t3) || Oo(t3);
        return r3 = s2(r3, 4), null == o3 && (e3 = t3 && t3.constructor, o3 = i3 ? n3 ? new e3() : [] : B2(t3) && bo(e3) ? Yt(nt(t3)) : {}), (i3 ? ua : se)(t3, function(t4, e4, n4) {
          return r3(o3, t4, e4, n4);
        }), o3;
      }, h2.unary = function(t3) {
        return oo(t3, 1);
      }, h2.union = kr, h2.unionBy = Er, h2.unionWith = zr, h2.uniq = function(t3) {
        return t3 && t3.length ? Ke(t3) : [];
      }, h2.uniqBy = function(t3, e3) {
        return t3 && t3.length ? Ke(t3, s2(e3, 2)) : [];
      }, h2.uniqWith = function(t3, e3) {
        return e3 = "function" == typeof e3 ? e3 : Wi, t3 && t3.length ? Ke(t3, Wi, e3) : [];
      }, h2.unset = function(t3, e3) {
        return null == t3 || Ze(t3, e3);
      }, h2.unzip = Ar, h2.unzipWith = Yr, h2.update = function(t3, e3, n3) {
        ...
        return po(on(e3), t3);
      }, h2.xor = Pr, h2.xorBy = Xr, h2.xorWith = Mr, h2.zip = Wr, h2.zipObject = function(t3, e3) {
        return nn(t3 || [], e3 || [], qt);
      }, h2.zipObjectDeep = function(t3, e3) {
        return nn(t3 || [], e3 || [], He);
      }, h2.zipWith = Hr, h2.entries = ei, h2.entriesIn = ni, h2.extend = Xo, h2.extendWith = Mo, Ci(h2, h2), h2.add = Ei, h2.attempt = vi, h2.camelCase = oi, h2.capitalize = ii, h2.ceil = zi, h2.clamp = function(t3, e3, n3) {
        return n3 === Wi && (n3 = e3, e3 = Wi), n3 !== Wi && (n3 = (n3 = D2(n3)) == n3 ? n3 : 0), e3 !== Wi && (e3 = (e3 = D2(e3)) == e3 ? e3 : 0), te(D2(t3), e3, n3);
        ...
        return (M(t3) ? Pu : ae)(t3, s2(e3 = n3 && d2(t3, e3, n3) ? Wi : e3, 3));
      }, h2.find = $r, h2.findIndex = Br, h2.findKey = function(t3, e3) {
        return Uu(t3, s2(e3, 3), se);
      }, h2.findLast = qr, h2.findLastIndex = Tr, h2.findLastKey = function(t3, e3) {
        return Uu(t3, s2(e3, 3), de);
      }, h2.floor = Yi, h2.forEach = Gr, h2.forEachRight = Kr, h2.forIn = function(t3, e3) {
      ...
      }, h2.hasIn = No, h2.head = Dr, h2.identity = O, h2.includes = function(t3, e3, n3, r3) {
        return t3 = l2(t3) ? t3 : ri(t3), n3 = n3 && !r3 ? S2(n3) : 0, r3 = t3.length, n3 < 0 && (n3 = w2(r3 + n3, 0)), Lo(t3) ? n3 <= r3 && -1 < t3.indexOf(e3, n3) : !!r3 && -1 < sa(t3, e3, n3);
      }, h2.indexOf = function(t3, e3, n3) {
        var r3 = null == t3 ? 0 : t3.length;
        return r3 ? (n3 = null == n3 ? 0 : S2(n3), sa(t3, e3, n3 = n3 < 0 ? w2(r3 + n3, 0) : n3)) : -1;
      }, h2.inRange = function(t3, e3, n3) {
        return e3 = Ao(e3), n3 === Wi ? (n3 = e3, e3 = 0) : n3 = Ao(n3), (t3 = t3 = D2(t3)) >= C2(e3 = e3, n3 = n3) && t3 < w2(e3, n3);
        ...
        return true === t3 || false === t3 || W(t3) && n2(t3) == Ki;
      }, h2.isBuffer = mo, h2.isDate = U, h2.isElement = function(t3) {
        return W(t3) && 1 === t3.nodeType && !So(t3);
      }, h2.isEmpty = function(t3) {
        if (null == t3)
          return true;
        if (l2(t3) && (M(t3) || "string" == typeof t3 || "function" == typeof t3.splice || mo(t3) || Oo(t3) || yo(t3)))
          return !t3.length;
        var e3, n3 = P(t3);
        if (n3 == Ji || n3 == ea)
          return !t3.size;
      ...
      }, h2.isFunction = bo, h2.isInteger = Co, h2.isLength = Io, h2.isMap = Bo, h2.isMatch = function(t3, e3) {
        return t3 === e3 || Ce(t3, e3, Zn(e3));
      }, h2.isMatchWith = function(t3, e3, n3) {
        return n3 = "function" == typeof n3 ? n3 : Wi, Ce(t3, e3, Zn(e3), n3);
        ...
        return null === t3;
      }, h2.isNumber = To, h2.isObject = B2, h2.isObjectLike = W, h2.isPlainObject = So, h2.isRegExp = Do, h2.isSafeInteger = function(t3) {
        return Co(t3) && -$i <= t3 && t3 <= $i;
      }, h2.isSet = Ro, h2.isString = Lo, h2.isSymbol = T2, h2.isTypedArray = Oo, h2.isUndefined = function(t3) {
        return t3 === Wi;
        ...
        return t3 && t3.length ? ue(t3, O, De) : Wi;
      }, h2.minBy = function(t3, e3) {
        return t3 && t3.length ? ue(t3, s2(e3, 2), De) : Wi;
        ...
        return true;
      }, h2.multiply = Pi, h2.nth = function(t3, e3) {
        ...
        return e3 = n3 || null == e3 ? 0 : e3 && +e3, mt(p2(t3).replace(ou, ""), e3 || 0);
      }, h2.random = function(t3, e3, n3) {
        var r3;
        return n3 && "boolean" != typeof n3 && d2(t3, e3, n3) && (e3 = n3 = Wi), n3 === Wi && ("boolean" == typeof e3 ? (n3 = e3, e3 = Wi) : "boolean" == typeof t3 && (n3 = t3, t3 = Wi)), t3 === Wi && e3 === Wi ? (t3 = 0, e3 = 1) : (t3 = Ao(t3), e3 === Wi ? (e3 = t3, t3 = 0) : e3 = Ao(e3)), e3 < t3 && (r3 = t3, t3 = e3, e3 = r3), n3 || t3 % 1 || e3 % 1 ? (r3 = xt(), C2(t3 + r3 * (e3 - t3 + Su("1e-" + ((r3 + "").length - 1))), e3)) : Pe(t3, e3);
        ...
        var r3 = M(t3) ? Hu : Ku, o3 = arguments.length < 3;
        return r3(t3, s2(e3, 4), n3, o3, ie);
      }, h2.repeat = function(t3, e3, n3) {
        return e3 = (n3 ? d2(t3, e3, n3) : e3 === Wi) ? 1 : S2(e3), Xe(p2(t3), e3);
      }, h2.replace = function() {
        ...
        return t3;
      }, h2.round = Xi, h2.runInContext = o2, h2.sample = function(t3) {
        return (M(t3) ? Ut : Me)(t3);
      }, h2.size = function(t3) {
        if (null == t3)
          return 0;
        if (l2(t3))
        ...
        var e3 = P(t3);
        return e3 == Ji || e3 == ea ? t3.size : Te(t3).length;
        ...
        if (null == t3 ? 0 : t3.length) {
          var n3 = Ne(t3, e3, true) - 1;
          if (X(t3[n3], e3))
            return n3;
        }
        return -1;
      }, h2.startCase = si, h2.startsWith = function(t3, e3, n3) {
        return t3 = p2(t3), n3 = null == n3 ? 0 : te(S2(n3), 0, t3.length), e3 = f2(e3), t3.slice(n3, n3 + e3.length) == e3;
        ...
        var r3 = R2(e3 = Mo({}, t3.imports, n3.imports, Mn)), o3 = tc(e3, r3), f3 = 0, n3 = t3.interpolate || wu, l3 = "__p += '", e3 = A((t3.escape || wu).source + "|" + n3.source + "|" + (n3 === Ja ? su : wu).source + "|" + (t3.evaluate || wu).source + "|$", "g"), i3 = "//# sourceURL=" + (Y.call(t3, "sourceURL") ? (t3.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Tu + "]") + "\n";
        if (a3.replace(e3, function(t4, e4, n4, r4, o4, i4) {
          ...
          l3 = "with (obj) {\n" + l3 + "\n}\n";
        if (l3 = (c3 ? l3.replace(Fa, "") : l3).replace(Ua, "$1").replace(Va, "$1;"), l3 = "function(" + (n3 || "obj") + ") {\n" + (n3 ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (u3 ? ", __e = _.escape" : "") + (c3 ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + l3 + "return __p\n}", (e3 = vi(function() {
        ...
        for (var n3 = qi, r3 = C2(t3, qi), r3 = (e3 = s2(e3), t3 -= qi, Ju(r3, e3)); ++n3 < t3; )
          e3(n3);
        return r3;
      }, h2.toFinite = Ao, h2.toInteger = S2, h2.toLength = Yo, h2.toLower = function(t3) {
        return p2(t3).toLowerCase();
      }, h2.toNumber = D2, h2.toSafeInteger = function(t3) {
        ...
        var n3, r3 = 30, o3 = "...", e3 = (B2(e3) && (n3 = "separator" in e3 ? e3.separator : n3, r3 = "length" in e3 ? S2(e3.length) : r3, o3 = "omission" in e3 ? f2(e3.omission) : o3), (t3 = p2(t3)).length);
        ...
        return (t3 = p2(t3)) && qa.test(t3) ? t3.replace(Na, sc) : t3;
      }, h2.uniqueId = function(t3) {
        var e3 = ++q;
        return p2(t3) + e3;
      }, h2.upperCase = di, h2.upperFirst = pi, h2.each = Gr, h2.eachRight = Kr, h2.first = Dr, Ci(h2, (ji = {}, se(h2, function(t3, e3) {
        Y.call(h2.prototype, e3) || (ji[e3] = t3);
        ...
        var l3 = /^(?:filter|find|map|reject)|While$/.test(t3), s3 = /^(?:head|last)$/.test(t3), d3 = h2[s3 ? "take" + ("last" == t3 ? "Right" : "") : t3], p3 = s3 || /^find/.test(t3);
        d3 && (h2.prototype[t3] = function() {
          function t4(t5) {
            return t5 = d3.apply(h2, la([t5], r3)), s3 && u3 ? t5[0] : t5;
          }
          var e3, n3 = this.__wrapped__, r3 = s3 ? [1] : arguments, o3 = n3 instanceof _2, i3 = r3[0], a3 = o3 || M(n3), u3 = (a3 && l3 && "function" == typeof i3 && 1 != i3.length && (o3 = a3 = false), this.__chain__), i3 = !!this.__actions__.length, c3 = p3 && !u3, o3 = o3 && !i3;
          return !p3 && a3 ? (n3 = o3 ? n3 : new _2(this), (e3 = f3.apply(n3, r3)).__actions__.push({ func: Ur, args: [t4], thisArg: Wi }), new g2(e3, u3)) : c3 && o3 ? f3.apply(this, r3) : (e3 = this.thru(t4), c3 ? s3 ? e3.value()[0] : e3.value() : e3);
        });
        ...
        var n3, r3 = h2[e3];
        r3 && (n3 = r3.name + "", Y.call(Dt, n3) || (Dt[n3] = []), Dt[n3].push({ name: e3, func: r3 }));
      }), Dt[Sn(Wi, 2).name] = [{ name: "wrapper", func: Wi }], _2.prototype.clone = function() {
        ...
        return t3 instanceof _2 ? (t3 = t3, (t3 = (t3 = this.__actions__.length ? new _2(this) : t3).reverse()).__actions__.push({ func: Ur, args: [Or], thisArg: Wi }), new g2(t3, this.__chain__)) : this.thru(Or);
...
function drawTagRect(t, e, n, r, o, i, a, u, c, f, l, s) {
  ...
  if (s && Object.assign(i, s), t.font = i.fontSize + "px sans-serif", u || c) {
    !c || u && "move" === u.type || (t.fillStyle = i.fillStyle, t.fillRect(e, n, r, o), a && i.showText && (s = parseFloat(t.font.split(" ")[0]), t.fillStyle = i.textFillStyle, t.fillText(l || a + "", e + 4, n + o / 2 + s / 2))), f && (t.strokeStyle = i.highlightStrokeStyle, t.lineWidth = i.highlightLineWidth, t.setLineDash(i.highlightLineDash), t.strokeRect(e, n, r, o));
    if (u && pointIsInRect(u, [e, n, r, o])) {
      if ("click" === u.type)
        return { isShow: c = !c, isCrash: true };
      "move" !== u.type || c || (t.strokeStyle = i.hoverStrokeStyle, t.lineWidth = i.hoverLineWidth, t.setLineDash(i.hoverLineDash), t.strokeRect(e, n, r, o));
    }
  }
}
function drawTagList(r, t, o, i, a = { offsetX: 0, offsetY: 0 }, u) {
  ...
  return t.forEach((t2) => {
    ...
    var n = drawTagRect(r, ...e, i, (t2.index || 0) + 1, u, t2.isShow, t2.showOutLine, t2.labelText, t2.tagConfig);
...
function moveResizeBox(t, e, n, r, o, i, a, u, c, f, l) {
  if (e && void 0 !== e.x && n && void 0 !== n.x) {
    var e = getTwoPointsOffsetInfo(e, n, i);
    if (e.isStartMove)
      return { offsetX: n, offsetY: i } = e.offsetInfo, e = transfromBoxToRect(getResizeBoundingBoxInfo(r, { offsetX: n / o, offsetY: i / o }, c), o, a), drawCropList(t, f, a, l), "crop" == l.mode && drawCropRect(t, ...e, l, true), drawTagList(t, u, a, l), "tag" == l.mode && drawTagRect(t, ...e, l, (r.index || 0) + 1, void 0, r.isShow, r.showOutLine, r.labelText, r.tagConfig), e;
  }
}
...
const _withScopeId = (t) => (pushScopeId("data-v-067c49d4"), t = t(), popScopeId(), t), _hoisted_1 = ["onTouchmove", "onTouchstart", "onTouchend"], _hoisted_2 = { key: 0, class: "mode-panel" }, _hoisted_3 = { class: "status" }, _hoisted_4 = { class: "text" }, _hoisted_5 = { class: "tip" }, _hoisted_6 = _withScopeId(() => createElementVNode("kbd", null, "Ctrl", -1)), _hoisted_7 = createTextVNode(" + "), _hoisted_8 = _withScopeId(() => createElementVNode("kbd", null, "B", -1)), _hoisted_9 = _withScopeId(() => createElementVNode("span", { style: { "font-size": "14px", "margin-left": "10px" } }, "\u5207\u6362\u6A21\u5F0F", -1)), _sfc_main = defineComponent({ props: { cropConfig: { default: () => DEFAULT_CONFIG.cropConfig }, layerConfig: { default: () => DEFAULT_CONFIG.layerConfig }, tagConfig: { default: () => DEFAULT_CONFIG.tagConfig }, drawingText: null, isShowTip: { type: Boolean, default: false }, enableScale: { type: Boolean, default: true }, enableMove: { type: Boolean, default: true }, enableDrawCrop: { type: Boolean, default: true }, enableDrawTag: { type: Boolean, default: true }, initScale: { type: Boolean, default: true }, enableInteractiveTagChangeStatus: { type: Boolean, default: true }, enableCropCross: { type: Boolean, default: false }, handleResizeCropCross: { default: "reset" }, enableInteractiveCropDelete: { type: Boolean, default: true }, enableCropResize: { type: Boolean, default: true }, enableTagResize: { type: Boolean, default: false }, enableDrawCropOutOfImg: { type: Boolean, default: true }, enableDrawTagOutOfCrop: { type: Boolean, default: true }, enableDrawTagOutOfImg: { type: Boolean, default: true }, isImgCrop: { type: Boolean, default: false }, isCropSingle: { type: Boolean, default: false }, cropList: { default: () => Array() }, tagList: { default: () => Array() }, mode: { default: "crop" }, mobileOperation: { default: "move" }, src: null, precision: { default: 0 }, splitClickAndDoubleClickEvent: { type: Boolean, default: false } }, emits: ["update:cropList", "cropListChange", "update:tagList", "tagListChange", "update:mode", "update:mobileOperation", "resizeStart", "resizeEnd", "delCrop", "drawCropStart", "drawTagStart", "mouseOverInfo", "onLoadImage"], setup(n, { expose: t, emit: a }) {
  ...
  let L = ref(), U = ref(), V = ref(), O = { isScaleing: false, isDrawRecting: false, isMoving: false, resizeHovering: void 0, isMouseDown: () => void 0 !== _.x, isMouseUpDownPoints: () => void 0 !== _.x && void 0 !== y.x }, k = { dragCreatRectInterrupt() {
    Q();
  }, dragCreatOrResizeRect(t2) {
    if (p && ("drawCrop" == t2 && (u.isCropSingle && !O.isDrawRecting && (D = []), O.isDrawRecting || a("drawCropStart"), O.isDrawRecting = true, T = moveDrawCropRect(p, _, y, B, m, D, w, R.value), drawTagList(p, S, w, R.value)), "drawTag" == t2 && (O.isDrawRecting || a("drawTagStart"), O.isDrawRecting = true, drawCropList(p, D, w, R.value), T = moveDrawTagRect(p, _, y, B, m, S, w, R.value)), "resize" == t2)) {
      let t3 = { crop() {
        u.enableCropResize && O.resizeHovering && p ? (f = D[O.resizeHovering.index || 0], O.resizeHovering && f && (O.isDrawRecting = true, T = moveResizeBox(p, _, y, f, f.scale || 1, B, w, S, O.resizeHovering, D.filter((t4, e2) => {
          var _a;
          return e2 !== ((_a = O.resizeHovering) == null ? void 0 : _a.index);
        }), R.value))) : k.move();
      }, tag() {
        u.enableTagResize && O.resizeHovering && p ? (f = S[O.resizeHovering.index || 0], O.resizeHovering && f && (O.isDrawRecting = true, T = moveResizeBox(p, _, y, f, f.scale || 1, B, w, S.filter((t4, e2) => {
          var _a;
          return e2 !== ((_a = O.resizeHovering) == null ? void 0 : _a.index);
        }), O.resizeHovering, D, R.value))) : k.move();
      } };
      t3[u.mode]();
    }
  }, changeMode() {
    ...
    O.isScaleing = true, d.translate(m.x, m.y), p.translate(m.x, m.y), m = { x: m.x - (e2.x / (B * t2) - e2.x / B), y: m.y - (e2.y / (B * t2) - e2.y / B) }, d.scale(t2, t2), p.scale(t2, t2), d.translate(-m.x, -m.y), p.translate(-m.x, -m.y), B *= t2, clearCanvas(d), clearCanvas(p), drawImage(d, h, w.x, w.y, g.width * x, g.height * x), A(), X = false, O.isScaleing = false;
  }, move() {
    var t2;
    u.enableMove && d && p && h && !O.isScaleing && (O.isMoving = true, (t2 = moveCanvas(d, p, h, g, x, w, _, y, D, B, S, R.value)) && (C = lodash.exports.cloneDeep(w)) && (C.x += t2.offsetX, C.y += t2.offsetY));
  }, hoverRect(t2) {
    p && (X = moveDrawUnshowTagDashRect(p, u.mode, S, B, w, m, t2, D, O.isScaleing, X, R.value), r || (u.enableCropResize && "crop" === u.mode && moveDetectBoxBorderSetCursor(L.value, t2, D, B, w, m, O.isScaleing), u.enableTagResize && "tag" === u.mode && moveDetectBoxBorderSetCursor(L.value, t2, S, B, w, m, O.isScaleing)));
  } }, E = { onKeyUpCtrlB() {
    k.changeMode();
  }, onKeyUpSpace() {
    O.isMoving || O.resizeHovering || k.dragCreatRectInterrupt(), r = false;
  }, onKeyDownSpace() {
    (u.enableDrawCrop && "crop" === u.mode || u.enableDrawTag && "tag" === u.mode) && (L.value.style.cursor = "crosshair"), O.isMouseDown() || (r = true);
  }, onMouseOverMove(t2) {
    device.mobile() || O.isMouseDown() || device.mobile() ? this.onHoldMouseLeftBtnMove(t2) : k.hoverRect(t2);
  }, onSpaceMove() {
    "crop" === u.mode ? u.enableDrawCrop && k.dragCreatOrResizeRect("drawCrop") : u.enableDrawTag && k.dragCreatOrResizeRect("drawTag");
  }, onHoldMouseLeftBtnMove(t2) {
    y = { x: t2.layerX, y: t2.layerY }, r ? this.onSpaceMove() : O.resizeHovering ? k.dragCreatOrResizeRect("resize") : k.move();
  }, onDoubleClick(e2) {
    if ("crop" === u.mode && u.enableInteractiveCropDelete && dt(pointIsInBoxList(e2, D, x, w).boxList), "tag" === u.mode) {
      let t2 = pointIsInBoxList(e2, S, x, w)["boxList"];
      t2.forEach((t3) => {
        var _a;
    ...
    if ("tag" === u.mode && p) {
      ...
      }), u.enableInteractiveTagChangeStatus && (drawCropList(p, D, w, R.value), { isReDraw: e2, redrawList: n2 } = drawTagList(p, S, w, R.value, void 0, e2), e2 && (A(), et("statusChange", Y(n2))));
    }
  }, onWheel(t2, e2, n2) {
    (u.enableScale || n2) && k.scale(t2, e2);
  }, init() {
    !async function() {
      if (M(), s = false, d = null, p = null, h = void 0, v = lodash.exports.cloneDeep(defaultWH), g = lodash.exports.cloneDeep(defaultWH), _ = lodash.exports.cloneDeep(defaultPoint), y = lodash.exports.cloneDeep(defaultPoint), w = { x: 0, y: 0 }, m = { x: 0, y: 0 }, x = 1, b = void 0, C = void 0, F = 1, I = void 0, B = 1, T = void 0, S = [], D = [], await nextTick(), 1 < u.cropList.length) {
      ...
      return 1 == u.cropList.length && (b = u.cropList[0]), S = lodash.exports.cloneDeep(u.tagList), D = lodash.exports.cloneDeep(u.cropList), z(), device.mobile() || (window.addEventListener("keydown", N), window.addEventListener("keyup", $)), G(), d = U.value.getContext("2d"), p = V.value.getContext("2d"), d && p ? (v = amendDpi(getElementWH(d.canvas))) ? (initCanvasWH(d, v), initCanvasWH(p, v), a("onLoadImage", { status: "loading" }), loadImage(u.src).then((t2) => {
        return a("onLoadImage", { status: "success" }), v && d && p ? (h = t2, g = { width: h.width, height: h.height }, u.initScale && (t2 = initScale(v, h), x = F = t2.scale, b ? (e2 = transfromBoxToRect(b, F, w), n2 = (v.width - 0.05 * v.width) / e2[2], r2 = (v.height - 0.05 * v.height) / e2[3], r2 = v.width / v.height > e2[2] / e2[3] ? r2 : n2, o2 = e2[0] + e2[2], i2 = e2[1] + e2[3], (r2 = r2) == n2 ? (w.x = (v.width - o2 * r2 - 0.05 * v.width / 2) / r2, w.y = ((v.height - e2[3] * r2) / 2 - e2[1] * r2) / r2) : (w.x = ((v.width - e2[2] * r2) / 2 - e2[0] * r2) / r2, w.y = (v.height - i2 * r2 - 0.05 * v.height / 2) / r2), Z({ deltaY: 1, clientX: 0, clientY: 0, preventDefault() {
        }, stopPropagation() {
        }, __zoom: r2 }, true)) : ("width" === t2.fit ? w.x = (v.width - g.width * x) / 2 : w.y = (v.height - g.height * x) / 2, b = { startX: 0, startY: 0, endX: 0 + g.width, endY: 0 + g.height }, u.isImgCrop && tt("add", D = [b]))), drawImage(d, h, w.x, w.y, h.width * x, h.height * x), D = initBoundingArrScale(D, x, u.precision), S = initBoundingArrScale(S, x, u.precision), A(), true) : Promise.reject("canvasWH or canvas var not has valid values.");
        var e2, n2, r2, o2, i2;
      }).catch((t2) => {
    ...
    requestAnimationFrame(() => {
      !async function() {
        if (q(), await nextTick(), z(), d && p && h) {
          if (!(v = amendDpi(getElementWH(d.canvas))))
            return Promise.reject("Error: can't get canvas height and width.");
          initCanvasWH(d, v), initCanvasWH(p, v), d.scale(B, B), p.scale(B, B), d.translate(-m.x, -m.y), p.translate(-m.x, -m.y), drawImage(d, h, w.x, w.y, h.width * x, h.height * x), D = initBoundingArrScale(D, x, u.precision), S = initBoundingArrScale(S, x, u.precision), A(), s = true;
        }
      }();
    });
  } };
  function N(t2) {
    "Space" === t2.code && (t2.target === document.body && t2.preventDefault(), E.onKeyDownSpace());
  }
  function $(t2) {
    "KeyB" === t2.code && t2.ctrlKey && E.onKeyUpCtrlB(), "Space" === t2.code && E.onKeyUpSpace();
  }
  function z() {
  ...
  function q() {
    f = null, s = false, v = lodash.exports.cloneDeep(defaultWH), _ = lodash.exports.cloneDeep(defaultPoint), y = lodash.exports.cloneDeep(defaultPoint), I = void 0;
  }
  function A() {
    p && (drawCropList(p, D, w, R.value), drawTagList(p, S, w, R.value));
  }
  function G() {
    device.mobile() && ("draw" === u.mobileOperation && E.onKeyDownSpace(), "move" === u.mobileOperation && E.onKeyUpSpace());
  }
  function K() {
    E.resize();
  }
  function Z(t2, e2) {
    ...
    !s && !t2.__zoom || O.isDrawRecting || O.isMoving || (r2 = t2.onTouchMove ? 1 : DPI, n2 = e2 ? 0 : (t2.clientX - I.left) * r2, r2 = e2 ? 0 : (t2.clientY - I.top) * r2, o2 = t2.deltaY < 0 ? 1 : -1, t2 = e2 ? t2.__zoom : Math.exp(o2 * P), B * t2 < 0.2 || E.onWheel(t2, { x: n2, y: r2 }, e2));
  }
  function J(e2) {
    if (O.resizeHovering) {
      var n2;
      let t2 = { crop: { boxList: D, trigger: tt, getBoxFunc: j }, tag: { boxList: S, trigger: et, getBoxFunc: Y } }[u.mode];
      t2.boxList[O.resizeHovering.index] = e2, a("resizeEnd", { index: O.resizeHovering.index, box: e2 }), "tag" === u.mode && (n2 = getVertexPositionByTwoPoints(_, y), Object.assign(e2, { __oprateType: "resize", __vertexPosition: n2 })), t2.trigger("resize", t2.getBoxFunc([e2]));
    }
  }
  function Q() {
    if (s) {
      var t2, e2;
      if (O.isMoving = false, C && (w = lodash.exports.cloneDeep(C)), C = void 0, O.isMouseUpDownPoints())
        if ("crop" === u.mode) {
          if (T) {
            let t3 = { ...f, ...transfromRect2Box(T, w, x) };
            f = null, O.resizeHovering ? !u.enableCropCross && getBoxIsIntersectWithBoxList(t3, D.filter((t4, e3) => {
              var _a;
              return e3 !== ((_a = O.resizeHovering) == null ? void 0 : _a.index);
            })) ? ("reset" === u.handleResizeCropCross && A(), "delete" === u.handleResizeCropCross && dt([D[O.resizeHovering.index]])) : J(t3) : (t3 = initBoundingArrScale([t3], x, u.precision)[0], !u.enableCropCross && getBoxIsIntersectWithBoxList(t3, D) ? A() : (D.push(t3), tt("add", j([t3])))), T = void 0;
          }
        } else
          T && (t2 = { ...f, ...transfromRect2Box(T, w, x) }, f = null, O.resizeHovering ? J(t2) : (t2 = getVertexPositionByTwoPoints(_, y), e2 = initBoundingArrScale([e2 = transfromRect2Box(T, w, x)], x, u.precision)[0], Object.assign(e2, { isShow: true, __oprateType: "add", __vertexPosition: t2 }), S.push(e2), et("add", Y([e2]))), T = void 0);
      O.resizeHovering = void 0, O.isDrawRecting = false, _ = lodash.exports.cloneDeep(defaultPoint), y = lodash.exports.cloneDeep(defaultPoint), L.value.style.cursor = "auto";
    }
  }
  function tt(t2, e2) {
    var n2 = j(D);
  ...
  function Y(t2) {
    ...
    return e2.forEach((t3) => {
      ...
      delete e3.__oprateType, Reflect.deleteProperty(e3, "__vertexPosition"), u.enableDrawTagOutOfCrop && !u.enableDrawTagOutOfImg && (t3 = { startX: 0, startY: 0, endX: (n2 = g).width, endY: n2.height }, (n2 = getTwoBoxIntersectPart(e3, t3)) && isBoxValidity(n2) ? Object.assign(e3, n2) : e3.__isValidity = false);
      t3 = fixBoxInfo(e3);
  ...
  function j(t2) {
    let e2 = t2 || D, n2 = e2.map((t3) => {
      let e3 = t3;
      u.enableDrawCropOutOfImg || (n3 = { startX: 0, startY: 0, endX: (n3 = g).width, endY: n3.height }, (n3 = getTwoBoxIntersectPart(e3, n3)) && isBoxValidity(n3) ? e3 = { ...t3, ...n3 } : e3._del = true), Reflect.deleteProperty(e3, "__vertexPosition");
  ...
  function nt(t2) {
    var e2;
    s && d && p && (e2 = new Date().getTime(), o = e2, l.prev.down ? l.last.down = e2 : l.prev.down = e2, e2 = amendDpi(e2 = { layerX: Reflect.get(t2, "layerX"), layerY: Reflect.get(t2, "layerY") }, ["layerX", "layerY"]), _ = { x: e2.layerX, y: e2.layerY }, "crop" === u.mode && !r && u.enableCropResize && (t2 = detectEventIsTriggerOnBoxBorderOrVertex(e2, D, B, w, m)).hasIn && (O.resizeHovering = findOneBorderOrVertex(t2.list), a("resizeStart", { index: O.resizeHovering.index, box: D[O.resizeHovering.index] })), "tag" === u.mode && !r && u.enableTagResize && (t2 = detectEventIsTriggerOnBoxBorderOrVertex(e2, S, B, w, m)).hasIn && (O.resizeHovering = findOneBorderOrVertex(t2.list), a("resizeStart", { index: O.resizeHovering.index, box: S[O.resizeHovering.index] })));
  }
  onBeforeUnmount(() => {
    window.removeEventListener("resize", K), device.mobile() || (window.removeEventListener("keydown", N), window.removeEventListener("keyup", $)), M();
  }), onMounted(() => {
    ...
    s && (S = initBoundingArrScale(t2, x, u.precision), A());
  }, { deep: true }), watch(() => u.cropList, (t2) => {
    s && (D = initBoundingArrScale(t2, x, u.precision), A());
  });
  let rt = lodash.exports.throttle(function(e2) {
    if (e2) {
      e2 = getTouchPoint(e2, B, m, "over");
      let t2 = lodash.exports.cloneDeep(e2);
      t2.x -= w.x, t2.y -= w.y, t2.x /= x, t2.y /= x, a("mouseOverInfo", { canvas: e2, img: t2 });
    } else
      a("mouseOverInfo", { canvas: null, img: null });
  }, 100, { leading: false, trailing: true });
  function ot(t2) {
    s && (t2 = amendDpi(t2 = { layerX: Reflect.get(t2, "layerX"), layerY: Reflect.get(t2, "layerY") }, ["layerX", "layerY"]), i = new Date().getTime(), E.onMouseOverMove(t2), rt(t2));
  }
  function it() {
    var t2;
    s && (t2 = new Date().getTime(), l.prev.up ? l.last.up = t2 : l.prev.up = t2, Q());
  }
  function at() {
  ...
  function ct(e2) {
    if (z(), s) {
      let t2 = getTouchPoint(amendDpi({ layerX: Reflect.get(e2, "layerX"), layerY: Reflect.get(e2, "layerY") }, ["layerX", "layerY"]), B, m, "click");
      var e2 = i && o ? i - o : 0;
      o = void 0, i = void 0, 100 < e2 || (u.splitClickAndDoubleClickEvent ? (ut(), c = setTimeout(() => {
        E.onCick(t2), c = null;
      }, 230)) : E.onCick(t2), e2 = u.splitClickAndDoubleClickEvent ? 320 : 360, l.prev.up && l.prev.down && l.last.up && l.last.down && (l.last.up - l.prev.down < e2 ? (u.splitClickAndDoubleClickEvent && ut(), E.onDoubleClick(t2), l.prev.down = void 0, l.prev.up = void 0) : (l.prev.down = l.last.down, l.prev.up = l.last.up), l.last.down = void 0, l.last.up = void 0));
    }
  }
  function ft(t2) {
    z(), o = new Date().getTime();
    var e2 = t2.touches;
    if (1 === t2.touches.length && nt({ layerX: e2[0].clientX, layerY: e2[0].clientY }), 2 == t2.touches.length) {
      if (!I)
        throw new Error("can't find  containerInfo.");
      e2 = amendMobileTouchEventDpi(t2);
      getTwoFingerTouchListDistence(e2), W = { x: (e2[0].clientX + e2[1].clientX) / 2 - I.left, y: (e2[0].clientY + e2[1].clientY) / 2 - I.top };
    }
  }
  function lt(t2) {
    i = new Date().getTime();
    ...
    if (1 === t2.touches.length && ot({ layerX: e2[0].clientX, layerY: e2[0].clientY }), 2 == t2.touches.length) {
      if (!I)
        throw new Error("can't find  containerInfo.");
      var { width: e2, height: t2 } = getTwoFingerTouchListDistence(amendMobileTouchEventDpi(t2)), e2 = getHypotenuseValue(e2, t2), t2 = -(e2 - H);
      H = e2, Z({ onTouchMove: true, deltaY: t2, preventDefault() {
      }, stopPropagation() {
  ...
  function dt(r2) {
    if (0 !== r2.length) {
      ...
      }), D = initBoundingArrScale(t2, x, u.precision), a("delCrop", n2), A(), tt("delete", j(n2));
    }
  }
  return t({ removeTagItems: function(n2) {
    ...
    S = initBoundingArrScale(r2, x, u.precision), A(), et("delete", o2);
  ...
  }, hooks: E }), (t2, e2) => (openBlock(), createElementBlock("div", { class: "comp-ocr-img", ref_key: "containerRef", ref: L, onMousedown: nt, onMouseenter: z, onClick: ct, onMouseup: it, onMousemove: ot, onMouseout: at, onMousewheel: Z, onTouchmove: withModifiers(lt, ["stop", "prevent"]), onTouchstart: withModifiers(ft, ["stop"]), onTouchend: withModifiers(st, ["stop"]) }, [createElementVNode("canvas", { class: "canvas", ref_key: "canvasRef", ref: U }, null, 512), createElementVNode("canvas", { class: "canvas2", ref_key: "canvas2Ref", ref: V }, null, 512), unref(u).isShowTip ? (openBlock(), createElementBlock("div", _hoisted_2, [createElementVNode("div", _hoisted_3, [createElementVNode("div", { class: normalizeClass(["circle", { crop: "crop" === n.mode, tag: "tag" === n.mode }]) }, null, 2), createElementVNode("div", _hoisted_4, toDisplayString("crop" === n.mode ? "\u88C1\u526A\u6A21\u5F0F" : "\u6807\u8BB0\u9519\u8BEF\u884C"), 1)]), createElementVNode("div", _hoisted_5, [renderSlot(t2.$slots, "tip", {}, () => [_hoisted_6, _hoisted_7, _hoisted_8, _hoisted_9], true)])])) : createCommentVNode("", true)], 40, _hoisted_1));
} });
var ImgMark = _export_sfc(_sfc_main, [["__scopeId", "data-v-067c49d4"]]);
